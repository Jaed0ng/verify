...
module StoreUnit(
  ...
  assign s2_out_af =
    (s2_in_uop_exceptionVec_7 | io_pmp_st
     | (s2_in_isvec | s2_in_isFrmMisAlignBuf | s2_isCbo) & s2_actually_uncache
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_in_mask = {_RANDOM[9'h2F][31:17], _RANDOM[9'h30][0]};
        s1_in_wlineflag = _RANDOM[9'h34][2];
        s1_in_isvec = _RANDOM[9'h39][3];
        s1_in_is128bit = _RANDOM[9'h39][5];
        s1_in_elemIdx = _RANDOM[9'h39][15:8];
        s1_in_alignedType = _RANDOM[9'h39][18:16];
        s1_in_mbIndex = _RANDOM[9'h39][22:19];
        s1_in_vecBaseVaddr = {_RANDOM[9'h3A][31:4], _RANDOM[9'h3B][21:0]};
        s1_in_vecActive = _RANDOM[9'h3D][24];
        s1_in_isFrmMisAlignBuf = _RANDOM[9'h3E][23];
        ...
        s1_isCbo = _RANDOM[9'h3E][30];
        s1_isvec = _RANDOM[9'h3E][31];
        s1_frm_mab_vec = _RANDOM[9'h3F][0];
        s1_mis_align_last_REG = _RANDOM[9'h6D][20];
        s2_valid = _RANDOM[9'h6D][21];
        s2_in_uop_exceptionVec_0 = _RANDOM[9'h70][18];
        s2_in_uop_exceptionVec_1 = _RANDOM[9'h70][19];
        s2_in_uop_exceptionVec_2 = _RANDOM[9'h70][20];
        s2_in_uop_exceptionVec_3 = _RANDOM[9'h70][21];
        s2_in_uop_exceptionVec_4 = _RANDOM[9'h70][22];
        s2_in_uop_exceptionVec_5 = _RANDOM[9'h70][23];
        s2_in_uop_exceptionVec_7 = _RANDOM[9'h70][25];
        s2_in_uop_exceptionVec_8 = _RANDOM[9'h70][26];
        s2_in_uop_exceptionVec_9 = _RANDOM[9'h70][27];
        s2_in_uop_exceptionVec_10 = _RANDOM[9'h70][28];
        s2_in_uop_exceptionVec_11 = _RANDOM[9'h70][29];
        s2_in_uop_exceptionVec_12 = _RANDOM[9'h70][30];
        s2_in_uop_exceptionVec_13 = _RANDOM[9'h70][31];
        s2_in_uop_exceptionVec_14 = _RANDOM[9'h71][0];
        s2_in_uop_exceptionVec_15 = _RANDOM[9'h71][1];
        s2_in_uop_exceptionVec_16 = _RANDOM[9'h71][2];
        s2_in_uop_exceptionVec_17 = _RANDOM[9'h71][3];
        s2_in_uop_exceptionVec_18 = _RANDOM[9'h71][4];
        s2_in_uop_exceptionVec_19 = _RANDOM[9'h71][5];
        s2_in_uop_exceptionVec_20 = _RANDOM[9'h71][6];
        s2_in_uop_exceptionVec_21 = _RANDOM[9'h71][7];
        s2_in_uop_exceptionVec_22 = _RANDOM[9'h71][8];
        s2_in_uop_exceptionVec_23 = _RANDOM[9'h71][9];
        s2_in_uop_trigger = _RANDOM[9'h71][15:12];
        s2_in_uop_fuOpType = _RANDOM[9'h74][8:0];
        s2_in_uop_vpu_vstart = _RANDOM[9'h76][25:18];
        s2_in_uop_vpu_veew = _RANDOM[9'h7B][26:25];
        s2_in_uop_uopIdx = _RANDOM[9'h7C][14:8];
        s2_in_uop_robIdx_flag = _RANDOM[9'h80][2];
        s2_in_uop_robIdx_value = _RANDOM[9'h80][10:3];
        s2_in_uop_sqIdx_flag = _RANDOM[9'h93][21];
        s2_in_uop_sqIdx_value = _RANDOM[9'h93][27:22];
        s2_in_vaddr = {_RANDOM[9'h94][31:3], _RANDOM[9'h95][20:0]};
        s2_in_fullva = {_RANDOM[9'h95][31:21], _RANDOM[9'h96], _RANDOM[9'h97][20:0]};
        s2_in_vaNeedExt = _RANDOM[9'h97][21];
        ...
        s2_in_mask = _RANDOM[9'h9B][21:6];
        s2_in_tlbMiss = _RANDOM[9'h9F][25];
        s2_in_nc = _RANDOM[9'h9F][28];
        s2_in_mmio = _RANDOM[9'h9F][29];
        s2_in_atomic = _RANDOM[9'h9F][31];
        s2_in_isHyper = _RANDOM[9'hA0][1];
        s2_in_isForVSnonLeafPTE = _RANDOM[9'hA0][2];
        s2_in_isvec = _RANDOM[9'hA4][24];
        s2_in_elemIdx = {_RANDOM[9'hA4][31:29], _RANDOM[9'hA5][4:0]};
        s2_in_alignedType = _RANDOM[9'hA5][7:5];
        s2_in_mbIndex = _RANDOM[9'hA5][11:8];
        s2_in_vecVaddrOffset = {_RANDOM[9'hA7][31:11], _RANDOM[9'hA8][28:0]};
        s2_in_vecActive = _RANDOM[9'hA9][13];
        s2_in_isFrmMisAlignBuf = _RANDOM[9'hAA][12];
        s2_in_isMisalign = _RANDOM[9'hAA][13];
        s2_in_isFinalSplit = _RANDOM[9'hAA][14];
        s2_vecActive = _RANDOM[9'hAA][18];
        s2_frm_mab_vec = _RANDOM[9'hAA][19];
        s2_pbmt = _RANDOM[9'hAA][21:20];
        s2_trigger_debug_mode = _RANDOM[9'hAA][22];
        s2_exception_REG = _RANDOM[9'hAA][23];
        s2_un_misalign_exception_REG = _RANDOM[9'hAA][24];
        s2_mmio_REG = _RANDOM[9'hAA][25];
        s2_actually_uncache_REG = _RANDOM[9'hAA][26];
        s2_isCbo = _RANDOM[9'hAA][27];
        s2_out_uop_exceptionVec_7_REG = _RANDOM[9'hAA][28];
        s2_mis_align_r = _RANDOM[9'hAA][29];
        toMisalignBufferValid_last_REG = _RANDOM[9'hAA][30];
        io_feedback_slow_valid_last_REG = _RANDOM[9'hAA][31];
        io_feedback_slow_bits_r_sqIdx_flag = _RANDOM[9'hAB][22];
        io_feedback_slow_bits_r_sqIdx_value = _RANDOM[9'hAB][28:23];
        io_feedback_slow_bits_hit_r = _RANDOM[9'hAC][5];
        s2_vecFeedback_REG = _RANDOM[9'hAC][6];
        s2_misalign_stout_bits_need_rep_r = _RANDOM[9'hAC][7];
        s3_valid = _RANDOM[9'hE9][5];
        s3_in_uop_exceptionVec_3 = _RANDOM[9'hEC][5];
        s3_in_uop_exceptionVec_6 = _RANDOM[9'hEC][8];
        s3_in_uop_exceptionVec_7 = _RANDOM[9'hEC][9];
        s3_in_uop_exceptionVec_15 = _RANDOM[9'hEC][17];
        s3_in_uop_exceptionVec_23 = _RANDOM[9'hEC][25];
        s3_in_uop_trigger = _RANDOM[9'hEC][31:28];
        s3_in_uop_vpu_vstart = _RANDOM[9'hF2][9:2];
        s3_in_uop_robIdx_flag = _RANDOM[9'hFB][18];
        s3_in_uop_robIdx_value = _RANDOM[9'hFB][26:19];
        s3_in_fullva = {_RANDOM[9'h111][31:5], _RANDOM[9'h112], _RANDOM[9'h113][4:0]};
        s3_in_vaNeedExt = _RANDOM[9'h113][5];
        s3_in_gpaddr = {_RANDOM[9'h114][31:22], _RANDOM[9'h115], _RANDOM[9'h116][21:0]};
        s3_in_mask = {_RANDOM[9'h116][31:22], _RANDOM[9'h117][5:0]};
        s3_in_nc = _RANDOM[9'h11B][12];
        s3_in_mmio = _RANDOM[9'h11B][13];
        s3_in_isForVSnonLeafPTE = _RANDOM[9'h11B][18];
        s3_in_isvec = _RANDOM[9'h120][8];
        s3_in_elemIdx = _RANDOM[9'h120][20:13];
        s3_in_mbIndex = _RANDOM[9'h120][27:24];
        s3_vecFeedback = _RANDOM[9'h126][2];
        s3_exception = _RANDOM[9'h126][3];
        sx_valid_1_r = _RANDOM[9'h126][4];
        sx_in_1_r_output_uop_exceptionVec_3 = _RANDOM[9'h129][4];
        sx_in_1_r_output_uop_exceptionVec_6 = _RANDOM[9'h129][7];
        sx_in_1_r_output_uop_exceptionVec_7 = _RANDOM[9'h129][8];
        sx_in_1_r_output_uop_exceptionVec_15 = _RANDOM[9'h129][16];
        sx_in_1_r_output_uop_exceptionVec_23 = _RANDOM[9'h129][24];
        sx_in_1_r_output_uop_trigger = _RANDOM[9'h129][30:27];
        sx_in_1_r_output_uop_vpu_vstart = _RANDOM[9'h12F][8:1];
        sx_in_1_r_output_uop_robIdx_flag = _RANDOM[9'h138][17];
        sx_in_1_r_output_uop_robIdx_value = _RANDOM[9'h138][25:18];
        sx_in_1_r_output_debug_isMMIO = _RANDOM[9'h154][25];
        sx_in_1_r_output_debug_isNC = _RANDOM[9'h154][26];
        sx_in_1_r_vecFeedback = _RANDOM[9'h157][30];
        sx_in_1_r_hasException = _RANDOM[9'h158][2];
        sx_in_1_r_elemIdx = _RANDOM[9'h158][10:3];
        sx_in_1_r_mbIndex = _RANDOM[9'h158][17:14];
        sx_in_1_r_mask = {_RANDOM[9'h158][31:18], _RANDOM[9'h159][1:0]};
        sx_in_1_r_vaddr = {_RANDOM[9'h159][31:2], _RANDOM[9'h15A], _RANDOM[9'h15B][1:0]};
        sx_in_1_r_vaNeedExt = _RANDOM[9'h15B][2];
        sx_in_1_r_gpaddr = {_RANDOM[9'h15B][31:3], _RANDOM[9'h15C][20:0]};
        sx_in_1_r_isForVSnonLeafPTE = _RANDOM[9'h15C][21];
        sx_in_vec_1_r = _RANDOM[9'h15D][6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        s1_valid = 1'h0;
        s1_vecActive = 1'h1;
