  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_gpaddr = {_RANDOM[9'h2B][31:17], _RANDOM[9'h2C], _RANDOM[9'h2D][16:0]};
        req_mask = {_RANDOM[9'h2D][31:17], _RANDOM[9'h2E][0]};
        req_isvec = _RANDOM[9'h37][3];
        req_elemIdx = _RANDOM[9'h37][15:8];
        req_alignedType = _RANDOM[9'h37][18:16];
        req_mbIndex = _RANDOM[9'h37][22:19];
        req_elemIdxInsideVd = {_RANDOM[9'h37][31:27], _RANDOM[9'h38][2:0]};
        req_vecTriggerMask = _RANDOM[9'h3B][23:8];
        bufferState = _RANDOM[9'h50][16:14];
        splitLoadReqs_0_uop_exceptionVec_3 = _RANDOM[9'h53][16];
        splitLoadReqs_0_uop_exceptionVec_4 = _RANDOM[9'h53][17];
        splitLoadReqs_0_uop_exceptionVec_5 = _RANDOM[9'h53][18];
        splitLoadReqs_0_uop_exceptionVec_13 = _RANDOM[9'h53][26];
        splitLoadReqs_0_uop_exceptionVec_19 = _RANDOM[9'h54][0];
        splitLoadReqs_0_uop_exceptionVec_21 = _RANDOM[9'h54][2];
        splitLoadReqs_0_uop_trigger = _RANDOM[9'h54][10:7];
        splitLoadReqs_0_uop_preDecodeInfo_isRVC = _RANDOM[9'h54][12];
        splitLoadReqs_0_uop_ftqPtr_flag = _RANDOM[9'h54][19];
        splitLoadReqs_0_uop_ftqPtr_value = _RANDOM[9'h54][25:20];
        splitLoadReqs_0_uop_ftqOffset = _RANDOM[9'h54][29:26];
        splitLoadReqs_0_uop_fuOpType = {_RANDOM[9'h56][31:27], _RANDOM[9'h57][3:0]};
        splitLoadReqs_0_uop_rfWen = _RANDOM[9'h57][4];
        splitLoadReqs_0_uop_fpWen = _RANDOM[9'h57][5];
        splitLoadReqs_0_uop_vpu_vstart = _RANDOM[9'h59][20:13];
        splitLoadReqs_0_uop_vpu_veew = _RANDOM[9'h5E][21:20];
        splitLoadReqs_0_uop_uopIdx = _RANDOM[9'h5F][9:3];
        splitLoadReqs_0_uop_pdest = _RANDOM[9'h62][16:9];
        splitLoadReqs_0_uop_robIdx_flag = _RANDOM[9'h62][29];
        splitLoadReqs_0_uop_robIdx_value = {_RANDOM[9'h62][31:30], _RANDOM[9'h63][5:0]};
        splitLoadReqs_0_uop_storeSetHit = _RANDOM[9'h75][23];
        splitLoadReqs_0_uop_waitForRobIdx_flag = _RANDOM[9'h75][24];
        splitLoadReqs_0_uop_waitForRobIdx_value =
          {_RANDOM[9'h75][31:25], _RANDOM[9'h76][0]};
        splitLoadReqs_0_uop_loadWaitBit = _RANDOM[9'h76][1];
        splitLoadReqs_0_uop_loadWaitStrict = _RANDOM[9'h76][2];
        splitLoadReqs_0_uop_lqIdx_flag = _RANDOM[9'h76][8];
        splitLoadReqs_0_uop_lqIdx_value = _RANDOM[9'h76][15:9];
        splitLoadReqs_0_uop_sqIdx_flag = _RANDOM[9'h76][16];
        splitLoadReqs_0_uop_sqIdx_value = _RANDOM[9'h76][22:17];
        splitLoadReqs_0_vaddr =
          {_RANDOM[9'h76][31:30], _RANDOM[9'h77], _RANDOM[9'h78][15:0]};
        splitLoadReqs_0_fullva =
          {_RANDOM[9'h78][31:16], _RANDOM[9'h79], _RANDOM[9'h7A][15:0]};
        splitLoadReqs_0_mask = _RANDOM[9'h7E][16:1];
        splitLoadReqs_0_mmio = _RANDOM[9'h82][24];
        splitLoadReqs_0_is128bit = _RANDOM[9'h87][21];
        splitLoadReqs_0_vecActive = _RANDOM[9'h8C][8];
        splitLoadReqs_0_mshrid = _RANDOM[9'h8C][22:19];
        splitLoadReqs_0_schedIndex = {_RANDOM[9'h8C][31], _RANDOM[9'h8D][5:0]};
        splitLoadReqs_1_uop_exceptionVec_3 = _RANDOM[9'h90][12];
        splitLoadReqs_1_uop_exceptionVec_4 = _RANDOM[9'h90][13];
        splitLoadReqs_1_uop_exceptionVec_5 = _RANDOM[9'h90][14];
        splitLoadReqs_1_uop_exceptionVec_13 = _RANDOM[9'h90][22];
        splitLoadReqs_1_uop_exceptionVec_19 = _RANDOM[9'h90][28];
        splitLoadReqs_1_uop_exceptionVec_21 = _RANDOM[9'h90][30];
        splitLoadReqs_1_uop_trigger = _RANDOM[9'h91][6:3];
        splitLoadReqs_1_uop_preDecodeInfo_isRVC = _RANDOM[9'h91][8];
        splitLoadReqs_1_uop_ftqPtr_flag = _RANDOM[9'h91][15];
        splitLoadReqs_1_uop_ftqPtr_value = _RANDOM[9'h91][21:16];
        splitLoadReqs_1_uop_ftqOffset = _RANDOM[9'h91][25:22];
        splitLoadReqs_1_uop_fuOpType = _RANDOM[9'h93][31:23];
        splitLoadReqs_1_uop_rfWen = _RANDOM[9'h94][0];
        splitLoadReqs_1_uop_fpWen = _RANDOM[9'h94][1];
        splitLoadReqs_1_uop_vpu_vstart = _RANDOM[9'h96][16:9];
        splitLoadReqs_1_uop_vpu_veew = _RANDOM[9'h9B][17:16];
        splitLoadReqs_1_uop_uopIdx = {_RANDOM[9'h9B][31], _RANDOM[9'h9C][5:0]};
        splitLoadReqs_1_uop_pdest = _RANDOM[9'h9F][12:5];
        splitLoadReqs_1_uop_robIdx_flag = _RANDOM[9'h9F][25];
        splitLoadReqs_1_uop_robIdx_value = {_RANDOM[9'h9F][31:26], _RANDOM[9'hA0][1:0]};
        splitLoadReqs_1_uop_storeSetHit = _RANDOM[9'hB2][19];
        splitLoadReqs_1_uop_waitForRobIdx_flag = _RANDOM[9'hB2][20];
        splitLoadReqs_1_uop_waitForRobIdx_value = _RANDOM[9'hB2][28:21];
        splitLoadReqs_1_uop_loadWaitBit = _RANDOM[9'hB2][29];
        splitLoadReqs_1_uop_loadWaitStrict = _RANDOM[9'hB2][30];
        splitLoadReqs_1_uop_lqIdx_flag = _RANDOM[9'hB3][4];
        splitLoadReqs_1_uop_lqIdx_value = _RANDOM[9'hB3][11:5];
        splitLoadReqs_1_uop_sqIdx_flag = _RANDOM[9'hB3][12];
        splitLoadReqs_1_uop_sqIdx_value = _RANDOM[9'hB3][18:13];
        splitLoadReqs_1_vaddr =
          {_RANDOM[9'hB3][31:26], _RANDOM[9'hB4], _RANDOM[9'hB5][11:0]};
        splitLoadReqs_1_fullva =
          {_RANDOM[9'hB5][31:12], _RANDOM[9'hB6], _RANDOM[9'hB7][11:0]};
        splitLoadReqs_1_mask = {_RANDOM[9'hBA][31:29], _RANDOM[9'hBB][12:0]};
        splitLoadReqs_1_mmio = _RANDOM[9'hBF][20];
        splitLoadReqs_1_is128bit = _RANDOM[9'hC4][17];
        splitLoadReqs_1_vecActive = _RANDOM[9'hC9][4];
        splitLoadReqs_1_mshrid = _RANDOM[9'hC9][18:15];
        ...
        splitLoadResp_1_data =
          {_RANDOM[9'h148][31:22],
           ...
           _RANDOM[9'h14B],
           _RANDOM[9'h14C][22:0]};
        exceptionVec_3 = _RANDOM[9'h16B][6];
        exceptionVec_4 = _RANDOM[9'h16B][7];
        exceptionVec_5 = _RANDOM[9'h16B][8];
        exceptionVec_13 = _RANDOM[9'h16B][16];
        exceptionVec_19 = _RANDOM[9'h16B][22];
        exceptionVec_21 = _RANDOM[9'h16B][24];
        unSentLoads = _RANDOM[9'h16B][28:27];
        curPtr = _RANDOM[9'h16B][29];
        data_select = {_RANDOM[9'h16B][31], _RANDOM[9'h16C][7:0]};
        globalException = _RANDOM[9'h16C][8];
        globalMMIO = _RANDOM[9'h16C][9];
        lowResultShift = _RANDOM[9'h16C][12:10];
        lowResultWidth = _RANDOM[9'h16C][15:13];
        highResultShift = _RANDOM[9'h16C][18:16];
        highResultWidth = _RANDOM[9'h16C][21:19];
        combinedData = {_RANDOM[9'h16C][31:22], _RANDOM[9'h16D], _RANDOM[9'h16E][21:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        bufferState = 3'h0;
