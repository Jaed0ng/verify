...
module SliceCtrl(
  ...
  output [11:0]  io_s_dir_w_bits_set,
  output [3:0]   io_s_dir_w_bits_way,
  ...
  input  [3:0]   io_dir_result_bits_self_way,
  input  [27:0]  io_dir_result_bits_self_tag,
  ...
  input  [29:0]  io_dir_result_bits_clients_tag,
  input          io_bs_r_addr_ready,
  output         io_bs_r_addr_valid,
  output [3:0]   io_bs_r_addr_bits_way,
  output [11:0]  io_bs_r_addr_bits_set,
  ...
  output [27:0]  io_cmo_req_bits_tag
);
  ...
  always @(posedge clock) begin
    if (_GEN) begin
      ...
      req_reg_set <= {52'h0, io_req_bits_tag[1:0], io_req_bits_set[11:2]};
      req_reg_tag <= {36'h0, io_req_bits_tag[29:2]};
    ...
    if (data_wen & ~w_counter) begin
      ...
      if (io_dir_result_valid) begin
        if (req_reg_cmd == 8'h3)
          ...
          req_reg_data_0 <= {36'h0, io_dir_result_bits_self_tag};
        else if (req_reg_cmd == 8'h1)
          req_reg_data_0 <= {34'h0, io_dir_result_bits_clients_tag};
        else if (_GEN)
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      data_wen_REG_2 <= data_wen_REG_1;
      data_wen_REG_3 <= data_wen_REG_2;
      data_wen <= data_wen_REG_3;
      if (data_wen)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_wen_REG_2 = _RANDOM[5'h18][22];
        data_wen_REG_3 = _RANDOM[5'h18][23];
        data_wen = _RANDOM[5'h18][24];
        w_counter = _RANDOM[5'h18][25];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        done = 1'h0;
  ...
  assign io_s_dir_w_bits_set = req_reg_set[11:0];
  assign io_s_dir_w_bits_way = req_reg_way[3:0];
  ...
  assign io_c_dir_w_bits_set = req_reg_set[9:0];
  ...
  assign io_s_tag_w_bits_set = req_reg_set[11:0];
  assign io_s_tag_w_bits_way = req_reg_way[3:0];
  assign io_s_tag_w_bits_tag = req_reg_tag[27:0];
  assign io_c_tag_w_valid = s_wb_client_tag;
  assign io_c_tag_w_bits_set = req_reg_set[9:0];
  assign io_c_tag_w_bits_way = req_reg_way[3:0];
  assign io_c_tag_w_bits_tag = req_reg_tag[29:0];
  assign io_bs_w_addr_valid = io_bs_w_addr_valid_0;
  assign io_bs_w_addr_bits_way = req_reg_way[3:0];
  assign io_bs_w_addr_bits_set = req_reg_set[11:0];
  ...
  assign io_dir_read_bits_tag = req_reg_tag[27:0];
  assign io_dir_read_bits_set = req_reg_set[11:0];
  assign io_bs_r_addr_valid = io_bs_r_addr_valid_0;
  assign io_bs_r_addr_bits_way = req_reg_way[3:0];
  assign io_bs_r_addr_bits_set = req_reg_set[11:0];
  ...
  assign io_cmo_req_bits_set = io_req_bits_set[11:0];
  assign io_cmo_req_bits_tag = io_req_bits_tag[27:0];
endmodule
