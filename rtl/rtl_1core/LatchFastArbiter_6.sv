  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_set = _RANDOM[2'h0][23:12];
        out_bits_reg_tag = {_RANDOM[2'h0][31:24], _RANDOM[2'h1][19:0]};
        out_bits_reg_way = _RANDOM[2'h1][26:23];
        out_bits_reg_bufIdx = _RANDOM[2'h2][4:1];
        out_bits_reg_opcode = _RANDOM[2'h2][7:5];
        out_bits_reg_param = _RANDOM[2'h2][10:8];
        out_bits_reg_source = _RANDOM[2'h2][14:11];
        out_bits_reg_save = _RANDOM[2'h2][15];
        out_bits_reg_drop = _RANDOM[2'h2][16];
        out_bits_reg_release = _RANDOM[2'h2][17];
        chosen_reg = {_RANDOM[2'h2][31:19], _RANDOM[2'h3][0]};
        pendingMask = _RANDOM[2'h3][14:1];
        rrGrantMask = _RANDOM[2'h3][28:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_set = 12'h0;
