...
module SRAMTemplate_45(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[3'h0][10];
        rdata_last_REG = _RANDOM[3'h5][0];
        rdata_hold_data_0 = _RANDOM[3'h5][12:1];
        rdata_hold_data_1 = _RANDOM[3'h5][24:13];
        rdataReg = {_RANDOM[3'h5][31:25], _RANDOM[3'h6][16:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 9'h0;
  ...
  sram_array_1p512x24m12s1h0l1b_bp_tage array (
    ...
    .RW0_wdata
      (mbistBd_ack
         ? mbistBd_wdata
         : _resetState ? 24'h0 : {io_w_req_bits_data_1, io_w_req_bits_data_0}),
    .RW0_rdata              (_array_RW0_rdata)
  );
  assign io_r_req_ready = io_r_req_ready_0;
  assign io_r_resp_data_0 = rdata_last_REG ? _array_RW0_rdata[11:0] : rdata_hold_data_0;
  assign io_r_resp_data_1 = rdata_last_REG ? _array_RW0_rdata[23:12] : rdata_hold_data_1;
