...
module MbistPipeSms(
  ...
  reg          renReg;
  reg  [5:0]   addrRdReg;
  wire         selectedVec_0 = arrayReg == 6'h34;
  wire         doSpread = selectedVec_0 | allReg;
  wire         activated = mbist_all | mbist_req & mbist_array == 6'h34;
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[3'h0][31:17],
           ...
           _RANDOM[3'h4],
           _RANDOM[3'h5][4:0]};
        renReg = _RANDOM[3'h5][5];
        addrRdReg = _RANDOM[3'h5][11:6];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 6'h0;
        reqReg = 1'h0;
  ...
  assign mbist_outdata = selectedVec_0 ? toSRAM_0_rdata : 148'h0;
