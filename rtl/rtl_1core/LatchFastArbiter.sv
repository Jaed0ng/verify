  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_tag = _RANDOM[3'h0][28:1];
        out_bits_reg_set = {_RANDOM[3'h0][31:29], _RANDOM[3'h1][8:0]};
        out_bits_reg_off = _RANDOM[3'h1][14:9];
        out_bits_reg_opcode = _RANDOM[3'h2][17:15];
        out_bits_reg_param = _RANDOM[3'h2][20:18];
        out_bits_reg_source = _RANDOM[3'h2][24:21];
        out_bits_reg_bufIdx = _RANDOM[3'h2][28:25];
        out_bits_reg_size = _RANDOM[3'h2][31:29];
        out_bits_reg_putData = _RANDOM[3'h3][1];
        chosen_reg = _RANDOM[3'h3][20:7];
        pendingMask = {_RANDOM[3'h3][31:21], _RANDOM[3'h4][2:0]};
        rrGrantMask = _RANDOM[3'h4][16:3];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_tag = 28'h0;
