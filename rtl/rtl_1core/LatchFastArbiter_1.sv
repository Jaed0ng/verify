  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_set = _RANDOM[2'h0][12:1];
        out_bits_reg_tag = {_RANDOM[2'h0][31:13], _RANDOM[2'h1][8:0]};
        out_bits_reg_param = _RANDOM[2'h1][11:9];
        out_bits_reg_clients = _RANDOM[2'h1][12];
        out_bits_reg_needData = _RANDOM[2'h1][13];
        chosen_reg = _RANDOM[2'h1][27:14];
        pendingMask = {_RANDOM[2'h1][31:28], _RANDOM[2'h2][9:0]};
        rrGrantMask = _RANDOM[2'h2][23:10];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_set = 12'h0;
