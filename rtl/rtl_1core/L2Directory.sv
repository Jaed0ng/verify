...
module L2Directory(
  ...
  wire [83:0]  _sramDataOut_3_T;
  wire [83:0]  _sramDataOut_2_T;
  wire [83:0]  _sramDataOut_1_T;
  wire [83:0]  _sramDataOut_0_T;
  reg  [3:0]   arrayReg;
  reg          reqReg;
  reg          allReg;
  reg          wenReg;
  ...
  wire         selectedVec_0 = arrayReg == 4'h4;
  wire         doSpread = selectedVec_0 | allReg;
  assign _sramDataOut_0_T = selectedVec_0 ? toSRAM_0_rdata : 84'h0;
  wire         selectedVec_0_1 = arrayReg == 4'h5;
  wire         doSpread_1 = selectedVec_0_1 | allReg;
  assign _sramDataOut_1_T = selectedVec_0_1 ? toSRAM_1_rdata : 84'h0;
  wire         selectedVec_0_2 = arrayReg == 4'h6;
  wire         doSpread_2 = selectedVec_0_2 | allReg;
  assign _sramDataOut_2_T = selectedVec_0_2 ? toSRAM_2_rdata : 84'h0;
  wire         selectedVec_0_3 = arrayReg == 4'h7;
  wire         doSpread_3 = selectedVec_0_3 | allReg;
  assign _sramDataOut_3_T = selectedVec_0_3 ? toSRAM_3_rdata : 84'h0;
  wire         selectedVec_0_4 = arrayReg == 4'h8;
  wire         doSpread_4 = selectedVec_0_4 | allReg;
  assign sramDataOut_4 = selectedVec_0_4 ? toSRAM_4_rdata : 104'h0;
  wire         selectedVec_0_5 = arrayReg == 4'h9;
  wire         doSpread_5 = selectedVec_0_5 | allReg;
  assign _sramDataOut_5_T = selectedVec_0_5 ? toSRAM_5_rdata : 16'h0;
  wire         selectedVec_0_6 = arrayReg == 4'hA;
  wire         doSpread_6 = selectedVec_0_6 | allReg;
  assign _sramDataOut_6_T = selectedVec_0_6 ? toSRAM_6_rdata : 8'h0;
  wire         activated =
    mbist_all | mbist_req
    & (mbist_array == 4'h4 | mbist_array == 4'h5 | mbist_array == 4'h6
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[3'h0][31:25],
           ...
           _RANDOM[3'h3],
           _RANDOM[3'h4][0]};
        renReg = _RANDOM[3'h4][1];
        addrRdReg = _RANDOM[3'h4][11:2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 4'h0;
        reqReg = 1'h0;
  ...
  assign mbist_outdata =
    sramDataOut_4 | {20'h0, _GEN[83:16], _GEN_0[15:8], _GEN_0[7:0] | _sramDataOut_6_T};
  assign toSRAM_0_addr = doSpread ? addrReg : 10'h0;
  assign toSRAM_0_addr_rd = doSpread ? addrRdReg : 10'h0;
  assign toSRAM_0_wdata = dataInReg[83:0];
  ...
  assign toSRAM_1_wdata = dataInReg[83:0];
  ...
  assign toSRAM_3_wdata = dataInReg[83:0];
