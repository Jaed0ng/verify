  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_tag = _RANDOM[2'h0][31:4];
        out_bits_reg_set = _RANDOM[2'h1][11:0];
        out_bits_reg_param = _RANDOM[2'h1][14:12];
        out_bits_reg_source = _RANDOM[2'h1][18:15];
        out_bits_reg_way = _RANDOM[2'h1][22:19];
        chosen_reg = {_RANDOM[2'h1][31:24], _RANDOM[2'h2][5:0]};
        pendingMask = _RANDOM[2'h2][19:6];
        rrGrantMask = {_RANDOM[2'h2][31:20], _RANDOM[2'h3][1:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_opcode = 3'h0;
