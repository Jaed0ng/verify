...
module MbistPipeFrontend(
  ...
  input  [159:0] mbist_indata,
  input          mbist_readen,
  input  [9:0]   mbist_addr_rd,
  output [159:0] mbist_outdata,
  ...
  output [8:0]   toNextPipeline_10_addr,
  output [23:0]  toNextPipeline_10_indata,
  output         toNextPipeline_10_readen,
  output [8:0]   toNextPipeline_10_addr_rd,
  ...
  output [6:0]   toNextPipeline_16_array,
  output         toNextPipeline_16_all,
  output         toNextPipeline_16_req,
  input          toNextPipeline_16_ack,
  output         toNextPipeline_16_writeen,
  output         toNextPipeline_16_be,
  output [6:0]   toNextPipeline_16_addr,
  output [159:0] toNextPipeline_16_indata,
  output         toNextPipeline_16_readen,
  output [6:0]   toNextPipeline_16_addr_rd,
  input  [159:0] toNextPipeline_16_outdata
);
  ...
  wire         activated =
    ...
    & (mbist_array == 7'h0 | mbist_array == 7'h1 | mbist_array == 7'h2
       ...
       | mbist_array == 7'h4E | mbist_array == 7'h4F);
  reg  [6:0]   arrayReg;
  reg          reqReg;
  reg          allReg;
  reg          wenReg;
  ...
  wire         selected_6 =
    ...
    | arrayReg == 7'h40 | arrayReg == 7'h41;
  wire         doSpread_6 = selected_6 | allReg;
  wire         selected_7 = arrayReg == 7'h42;
  wire         doSpread_7 = selected_7 | allReg;
  wire         selected_8 = arrayReg == 7'h43;
  wire         doSpread_8 = selected_8 | allReg;
  wire         selected_9 = arrayReg == 7'h44;
  wire         doSpread_9 = selected_9 | allReg;
  wire         selected_10 = arrayReg == 7'h45;
  wire         doSpread_10 = selected_10 | allReg;
  wire         selected_11 = arrayReg == 7'h46;
  wire         doSpread_11 = selected_11 | allReg;
  wire [75:0]  _pipelineDataOut_11_T = selected_11 ? toNextPipeline_11_outdata : 76'h0;
  wire         selected_12 = arrayReg == 7'h47;
  wire         doSpread_12 = selected_12 | allReg;
  wire [75:0]  _pipelineDataOut_12_T = selected_12 ? toNextPipeline_12_outdata : 76'h0;
  wire         selected_13 = arrayReg == 7'h48 | arrayReg == 7'h49;
  wire         doSpread_13 = selected_13 | allReg;
  wire [75:0]  _pipelineDataOut_13_T = selected_13 ? toNextPipeline_13_outdata : 76'h0;
  wire         selected_14 = arrayReg == 7'h4A | arrayReg == 7'h4B;
  wire         doSpread_14 = selected_14 | allReg;
  wire [75:0]  _pipelineDataOut_14_T = selected_14 ? toNextPipeline_14_outdata : 76'h0;
  wire         selected_15 = arrayReg == 7'h4C | arrayReg == 7'h4D;
  wire         doSpread_15 = selected_15 | allReg;
  wire [75:0]  _pipelineDataOut_15_T = selected_15 ? toNextPipeline_15_outdata : 76'h0;
  wire         selected_16 = arrayReg == 7'h4E | arrayReg == 7'h4F;
  wire         doSpread_16 = selected_16 | allReg;
  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        {84'h0,
         _pipelineDataOut_11_T[75:74] | _pipelineDataOut_12_T[75:74]
           | _pipelineDataOut_13_T[75:74] | _pipelineDataOut_14_T[75:74]
           | _pipelineDataOut_15_T[75:74],
         _pipelineDataOut_0_T[73:66] | _pipelineDataOut_11_T[73:66]
           | _pipelineDataOut_12_T[73:66] | _pipelineDataOut_13_T[73:66]
           | _pipelineDataOut_14_T[73:66] | _pipelineDataOut_15_T[73:66],
         _GEN[65:40] | _pipelineDataOut_11_T[65:40] | _pipelineDataOut_12_T[65:40]
           | _pipelineDataOut_13_T[65:40] | _pipelineDataOut_14_T[65:40]
           | _pipelineDataOut_15_T[65:40],
         _GEN_0[39:24] | _pipelineDataOut_11_T[39:24] | _pipelineDataOut_12_T[39:24]
           | _pipelineDataOut_13_T[39:24] | _pipelineDataOut_14_T[39:24]
           | _pipelineDataOut_15_T[39:24],
         _GEN_0[23:0] | (selected_6 ? toNextPipeline_6_outdata : 24'h0)
           ...
           | _pipelineDataOut_11_T[23:0] | _pipelineDataOut_12_T[23:0]
           | _pipelineDataOut_13_T[23:0] | _pipelineDataOut_14_T[23:0]
           | _pipelineDataOut_15_T[23:0]}
        | (selected_16 ? toNextPipeline_16_outdata : 160'h0);
  end // always @(posedge)
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[4'h3], _RANDOM[4'h4], _RANDOM[4'h5], _RANDOM[4'h6], _RANDOM[4'h7]};
        renReg = _RANDOM[4'h8][0];
        addrRdReg = _RANDOM[4'h8][10:1];
        pipelineDataOutReg =
          {_RANDOM[4'h8][31:11],
           _RANDOM[4'h9],
           _RANDOM[4'hA],
  ...
  assign mbist_ack =
    ...
    & (toNextPipeline_0_ack | toNextPipeline_1_ack | toNextPipeline_2_ack
       ...
       | toNextPipeline_15_ack | toNextPipeline_16_ack);
  ...
  assign toNextPipeline_7_addr = doSpread_7 ? addrReg[8:0] : 9'h0;
  assign toNextPipeline_7_indata = dataInReg[23:0];
  assign toNextPipeline_7_readen = doSpread_7 & renReg;
  assign toNextPipeline_7_addr_rd = doSpread_7 ? addrRdReg[8:0] : 9'h0;
  ...
  assign toNextPipeline_8_addr = doSpread_8 ? addrReg[8:0] : 9'h0;
  assign toNextPipeline_8_indata = dataInReg[23:0];
  assign toNextPipeline_8_readen = doSpread_8 & renReg;
  assign toNextPipeline_8_addr_rd = doSpread_8 ? addrRdReg[8:0] : 9'h0;
  ...
  assign toNextPipeline_9_addr = doSpread_9 ? addrReg[8:0] : 9'h0;
  assign toNextPipeline_9_indata = dataInReg[23:0];
  assign toNextPipeline_9_readen = doSpread_9 & renReg;
  assign toNextPipeline_9_addr_rd = doSpread_9 ? addrRdReg[8:0] : 9'h0;
  ...
  assign toNextPipeline_10_addr = doSpread_10 ? addrReg[8:0] : 9'h0;
  assign toNextPipeline_10_indata = dataInReg[23:0];
  assign toNextPipeline_10_readen = doSpread_10 & renReg;
  assign toNextPipeline_10_addr_rd = doSpread_10 ? addrRdReg[8:0] : 9'h0;
  ...
  assign toNextPipeline_11_indata = dataInReg[75:0];
  ...
  assign toNextPipeline_15_indata = dataInReg[75:0];
  assign toNextPipeline_15_readen = doSpread_15 & renReg;
  assign toNextPipeline_15_addr_rd = doSpread_15 ? addrRdReg[7:0] : 8'h0;
  assign toNextPipeline_16_array = doSpread_16 ? arrayReg : 7'h0;
  assign toNextPipeline_16_all = doSpread_16 & allReg;
  assign toNextPipeline_16_req = reqReg;
  assign toNextPipeline_16_writeen = doSpread_16 & wenReg;
  assign toNextPipeline_16_be = beReg[0];
  assign toNextPipeline_16_addr = doSpread_16 ? addrReg[6:0] : 7'h0;
  assign toNextPipeline_16_indata = dataInReg;
  assign toNextPipeline_16_readen = doSpread_16 & renReg;
  assign toNextPipeline_16_addr_rd = doSpread_16 ? addrRdReg[6:0] : 7'h0;
endmodule
