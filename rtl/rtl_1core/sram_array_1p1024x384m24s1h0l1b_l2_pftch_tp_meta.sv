...
module sram_array_1p1024x384m24s1h0l1b_l2_pftch_tp_meta(
  input          mbist_dft_ram_bypass,
  input          mbist_dft_ram_bp_clken,
  input  [1:0]   sramCtl_MCR,
  input  [1:0]   sramCtl_MCW,
  input  [1:0]   sramCtl_RTSEL,
  input  [1:0]   sramCtl_WTSEL,
  input  [1:0]   sramCtl_RCT,
  input  [1:0]   sramCtl_WCT,
  input  [2:0]   sramCtl_KP,
  input          RW0_clk,
  input  [9:0]   RW0_addr,
  input          RW0_en,
  input          RW0_wmode,
