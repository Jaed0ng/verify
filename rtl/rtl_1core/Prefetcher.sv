...
module Prefetcher(
  ...
  input  [191:0] boreChildrenBd_bore_indata,
  input          boreChildrenBd_bore_readen,
  input  [10:0]  boreChildrenBd_bore_addr_rd,
  output [191:0] boreChildrenBd_bore_outdata
);

  wire [191:0] bd_outdata;
  wire         bd_ack;
  wire [191:0] childBd_2_rdata;
  ...
  wire [191:0] bd_indata = boreChildrenBd_bore_indata;
  ...
  wire [191:0] childBd_2_wdata;
  wire [7:0]   childBd_2_wmask;
  wire         childBd_2_re;
  wire         childBd_2_we;
  wire         childBd_2_ack;
  wire [1:0]   childBd_2_selectedOH;
  ...
  PrefetchQueue pftQueue (
    ...
    .io_enq_bits_pfSource
      (_pftQueue_io_enq_bits_T
         ? (_pfRcv_io_req_valid ? _pfRcv_io_req_bits_pfSource : 5'h8)
         : {2'h1, ~_pbop_io_req_valid, 2'h1}),
