...
module SRAMTemplate_120(
  ...
  wire [3:0]   mbistBd_addr = boreChildrenBd_bore_addr;
  wire [3:0]   mbistBd_addr_rd = boreChildrenBd_bore_addr_rd;
  wire [199:0] mbistBd_wdata = boreChildrenBd_bore_wdata;
  ...
  reg          respReg;
  reg  [199:0] rdataReg;
  wire [199:0] mbistBd_rdata = rdataReg;
  ...
  sram_array_1p8x200m100s1h0l1b_ptw_l1 array (
