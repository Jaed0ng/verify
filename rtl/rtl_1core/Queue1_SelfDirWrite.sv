...
module Queue1_SelfDirWrite(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = _RANDOM[/*Zero width*/ 1'b0][22:1];
  ...
  assign io_deq_bits_set = ram[11:0];
  assign io_deq_bits_way = ram[15:12];
  assign io_deq_bits_data_dirty = ram[16];
  assign io_deq_bits_data_state = ram[18:17];
  assign io_deq_bits_data_clientStates_0 = ram[20:19];
  assign io_deq_bits_data_prefetch = ram[21];
endmodule
