...
module MSHR_64(
  ...
  output [27:0] io_tasks_sink_a_bits_tag,
  ...
  output [27:0] io_tasks_source_b_bits_tag,
  ...
  output [27:0] io_tasks_sink_c_bits_tag,
  ...
  output [27:0] io_tasks_source_d_bits_tag,
  ...
  output [27:0] io_tasks_source_a_bits_tag,
  ...
  output [27:0] io_tasks_source_c_bits_tag,
  ...
  output [29:0] io_tasks_prefetch_train_bits_tag,
  ...
  output [29:0] io_tasks_prefetch_resp_bits_tag,
  ...
  output [27:0] io_tasks_tag_write_bits_tag,
  input         io_tasks_client_dir_write_ready,
  output        io_tasks_client_dir_write_valid,
  output [9:0]  io_tasks_client_dir_write_bits_set,
  ...
  output [9:0]  io_tasks_client_tag_write_bits_set,
  output [3:0]  io_tasks_client_tag_write_bits_way,
  output [29:0] io_tasks_client_tag_write_bits_tag,
  ...
  input  [27:0] io_dirResult_bits_self_tag,
  ...
  wire [29:0]     io_tasks_prefetch_resp_bits_tag_0 = {2'h0, req_tag};
  ...
  wire            _GEN_7 =
    ...
    & {io_nestedwb_tag,
       io_nestedwb_set[11:10]} == (io_dirResult_valid
                                     ? io_dirResult_bits_clients_tag
                                     : meta_reg_clients_tag)
    & io_nestedwb_set[9:0] == req_set[9:0] & io_nestedwb_clients_0_isToN;
    ...
    if (reset) begin
      ...
      probe_helper_finish <=
        ...
        & (req_valid & io_b_status_probeHelperFinish
           & req_set[9:0] == io_b_status_set[9:0] | probe_helper_finish);
      no_schedule_REG <=
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_set = {_RANDOM[4'h0][31:23], _RANDOM[4'h1][2:0]};
        req_tag = _RANDOM[4'h1][30:3];
        req_off = {_RANDOM[4'h1][31], _RANDOM[4'h2][4:0]};
        req_mask = {_RANDOM[4'h2][31:5], _RANDOM[4'h3][4:0]};
        req_bufIdx = _RANDOM[4'h3][8:5];
        req_needHint = _RANDOM[4'h3][9];
        req_isPrefetch = _RANDOM[4'h3][10];
        req_isBop = _RANDOM[4'h3][11];
        req_preferCache = _RANDOM[4'h3][12];
        req_dirty = _RANDOM[4'h3][13];
        req_fromProbeHelper = _RANDOM[4'h3][15];
        req_fromCmoHelper = _RANDOM[4'h3][16];
        req_needProbeAckData = _RANDOM[4'h3][17];
        req_reqSource = _RANDOM[4'h3][22:18];
        req_valid = _RANDOM[4'h3][23];
        iam = _RANDOM[4'h3][25:24];
        meta_reg_self_dirty = _RANDOM[4'h4][10];
        meta_reg_self_state = _RANDOM[4'h4][12:11];
        meta_reg_self_clientStates_0 = _RANDOM[4'h4][14:13];
        meta_reg_self_prefetch = _RANDOM[4'h4][15];
        meta_reg_self_hit = _RANDOM[4'h4][16];
        meta_reg_self_way = _RANDOM[4'h4][20:17];
        meta_reg_self_tag = {_RANDOM[4'h4][31:21], _RANDOM[4'h5][16:0]};
        meta_reg_self_error = _RANDOM[4'h5][17];
        meta_reg_clients_states_0_state = _RANDOM[4'h5][19:18];
        meta_reg_clients_states_0_hit = _RANDOM[4'h5][20];
        meta_reg_clients_tag = {_RANDOM[4'h5][31:22], _RANDOM[4'h6][19:0]};
        meta_reg_clients_way = _RANDOM[4'h6][23:20];
        meta_reg_clients_error = _RANDOM[4'h6][24];
        meta_valid = _RANDOM[4'h7][27];
        promoteT_safe = _RANDOM[4'h7][29];
        gotT = _RANDOM[4'h7][30];
        a_do_release = _RANDOM[4'h8][0];
        a_do_probe = _RANDOM[4'h8][1];
        probe_dirty = _RANDOM[4'h8][2];
        highest_perm_reg_reg = _RANDOM[4'h8][5:4];
        inv_self_dir = _RANDOM[4'h8][7];
        client_probeack_param_vec_reg_0 = _RANDOM[4'h8][10:8];
        transmit_from_other_client_reg = _RANDOM[4'h8][11];
        releaseThrough = _RANDOM[4'h8][12];
        releaseDrop = _RANDOM[4'h8][13];
        probeAckDataThrough = _RANDOM[4'h8][14];
        probeAckDataDrop = _RANDOM[4'h8][15];
        probeAckDataSave = _RANDOM[4'h8][16];
        someClientHasProbeAckData = _RANDOM[4'h8][17];
        nested_c_hit_reg = _RANDOM[4'h8][18];
        sink = _RANDOM[4'h8][21:19];
        bad_grant = _RANDOM[4'h8][22];
        s_acquire = _RANDOM[4'h8][24];
        s_probe = _RANDOM[4'h8][25];
        s_release = _RANDOM[4'h8][26];
        s_probeack = _RANDOM[4'h8][27];
        s_execute = _RANDOM[4'h8][28];
        s_grantack = _RANDOM[4'h8][29];
        s_wbselfdir = _RANDOM[4'h8][30];
        s_wbselftag = _RANDOM[4'h8][31];
        s_wbclientsdir = _RANDOM[4'h9][0];
        s_wbclientstag = _RANDOM[4'h9][1];
        s_transferput = _RANDOM[4'h9][2];
        s_writerelease = _RANDOM[4'h9][3];
        s_writeprobe = _RANDOM[4'h9][4];
        s_triggerprefetch = _RANDOM[4'h9][5];
        s_prefetchack = _RANDOM[4'h9][6];
        w_probeackfirst = _RANDOM[4'h9][7];
        w_probeacklast = _RANDOM[4'h9][8];
        w_probeack = _RANDOM[4'h9][9];
        w_grantfirst = _RANDOM[4'h9][10];
        w_grantlast = _RANDOM[4'h9][11];
        w_grant = _RANDOM[4'h9][12];
        w_releaseack = _RANDOM[4'h9][13];
        w_grantack = _RANDOM[4'h9][14];
        w_putwritten = _RANDOM[4'h9][15];
        w_sinkcack = _RANDOM[4'h9][16];
        acquire_flag = _RANDOM[4'h9][17];
        nestC_save_flag = _RANDOM[4'h9][18];
        nestC_saveDirty_flag = _RANDOM[4'h9][19];
        bypassPut_latch_reg = _RANDOM[4'h9][20];
        client_dir_conflict = _RANDOM[4'h9][21];
        probe_helper_finish = _RANDOM[4'h9][22];
        probe_clients = _RANDOM[4'h9][24];
        io_tasks_sink_c_bits_bufIdx_r = _RANDOM[4'h9][28:25];
        no_schedule_REG = _RANDOM[4'h9][29];
        preferCache_latch = _RANDOM[4'hA][0];
        transmit_from_other_client_latch = _RANDOM[4'hA][1];
        a_c_through_reg = _RANDOM[4'hA][2];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        meta_valid = 1'h0;
  ...
  assign io_ecc_bits_addr = {18'h0, req_tag, req_set, req_off};
  ...
  assign io_tasks_source_a_bits_reqSource = _probe_clients_T_1 ? 5'h11 : req_reqSource;
  ...
  assign io_tasks_client_dir_write_bits_set = req_set[9:0];
  ...
  assign io_tasks_client_tag_write_bits_set = req_set[9:0];
  assign io_tasks_client_tag_write_bits_way = meta_reg_clients_way;
  assign io_tasks_client_tag_write_bits_tag = {req_tag, req_set[11:10]};
