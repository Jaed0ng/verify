...
module SRAMTemplate_66(
  ...
  wire [23:0] mbistBd_wdata = boreChildrenBd_bore_wdata;
  ...
  reg  [23:0] rdataReg;
  wire [23:0] mbistBd_rdata = rdataReg;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[2'h0][9];
        bypass_wdata_r_0 = _RANDOM[2'h0][15:10];
        bypass_wdata_r_1 = _RANDOM[2'h0][21:16];
        bypass_wdata_r_2 = _RANDOM[2'h0][27:22];
        bypass_wdata_r_3 = {_RANDOM[2'h0][31:28], _RANDOM[2'h1][1:0]};
        bypass_mask_need_check_reg_last_REG = _RANDOM[2'h1][2];
        bypass_mask_waddr_reg = _RANDOM[2'h1][10:3];
        bypass_mask_raddr_reg = _RANDOM[2'h1][18:11];
        bypass_mask_wmask_reg = _RANDOM[2'h1][22:19];
        rdata_last_REG = _RANDOM[2'h1][23];
        rdata_hold_data_0 = _RANDOM[2'h1][29:24];
        rdata_hold_data_1 = {_RANDOM[2'h1][31:30], _RANDOM[2'h2][3:0]};
        rdata_hold_data_2 = _RANDOM[2'h2][9:4];
        rdata_hold_data_3 = _RANDOM[2'h2][15:10];
        rdataReg = {_RANDOM[2'h2][31:16], _RANDOM[2'h3][7:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 8'h0;
  ...
  sram_array_2p256x24m6s1h0l1b_bp_sc array (
    ...
    .W0_addr
      (mbistBd_ack ? mbistBd_addr[7:0] : _resetState ? _resetSet : io_w_req_bits_setIdx),
