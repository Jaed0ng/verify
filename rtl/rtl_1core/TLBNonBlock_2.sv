...
module TLBNonBlock_2(
  ...
  wire             _modeCheck_T_26 =
    _csr_delay_io_out_priv_dmode == 2'h0 & ~readResult_1_4_0_u
  ...
  wire             io_requestor_1_resp_bits_excp_0_gpf_ld_0 =
    ((~((readResult_p_hit_last_REG_1
        ...
        & readResult_1_5_0_x) | readResult_1_5_0_pf) & isLd_2 | ~readResult_1_5_0_a
     & isLd_2) & s2_valid_2 & ~af_4 & ~hasPf_2;
  assign hasGpf_1 =
    hit_read_1
          ...
          : ~_pres2xlateEnable_T & _GEN_14
              ...
              : _pres2xlateEnable_T & _GEN_14
                  ...
                  : io_requestor_0_req_bits_hyperinst
                    & _csr_delay_io_out_priv_imode == 2'h0
    ...
    if (io_ptw_resp_valid) begin
      ...
      readResult_p_ppn_1 <=
        readResult_onlyS2_1 | (&req_in_s2xlate_1)
          ? _GEN_13[io_ptw_resp_bits_s2_entry_level][35:0]
          : _GEN_11[io_ptw_resp_bits_s1_entry_level][35:0];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_p_g_perm_x = _RANDOM[7'h1B][3];
        readResult_p_g_perm_w = _RANDOM[7'h1B][4];
        readResult_p_g_perm_r = _RANDOM[7'h1B][5];
        ...
        readResult_p_g_perm_1_x = _RANDOM[7'h30][17];
        readResult_p_g_perm_1_w = _RANDOM[7'h30][18];
        readResult_p_g_perm_1_r = _RANDOM[7'h30][19];
        ...
        noTranslateReg = _RANDOM[7'h42][25];
        REG = _RANDOM[7'h42][26];
        io_requestor_0_resp_bits_excp_0_pf_ld_REG = _RANDOM[7'h42][27];
        io_requestor_0_resp_bits_excp_0_gpf_ld_REG = _RANDOM[7'h42][29];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h42][30];
        io_requestor_0_resp_bits_excp_0_af_ld_REG = _RANDOM[7'h42][31];
        REG_1 = _RANDOM[7'h43][1];
        noTranslateReg_1 = _RANDOM[7'h43][8];
        ptw_resp_bits_reg_s2xlate = _RANDOM[7'h43][24:23];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[7'h43][31:25], _RANDOM[7'h44][27:0]};
        ptw_resp_bits_reg_s1_entry_asid = {_RANDOM[7'h44][31:28], _RANDOM[7'h45][11:0]};
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[7'h45][25:12];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h46][5:4];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h47][19:17];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h48][12];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h48][13];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h48][14];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h48][15];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h48][16];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h48][17];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h48][18];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h48][19];
        ptw_resp_bits_reg_s2_entry_tag =
          {_RANDOM[7'h48][31:30], _RANDOM[7'h49], _RANDOM[7'h4A][3:0]};
        ptw_resp_bits_reg_s2_entry_vmid = {_RANDOM[7'h4A][31:20], _RANDOM[7'h4B][1:0]};
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h4C][19:18];
        ptw_already_back_last_REG = _RANDOM[7'h4D][2];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h4D][5:4];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[7'h4D][31:6], _RANDOM[7'h4E][8:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = _RANDOM[7'h4E][24:9];
        ptw_resp_bits_reg_1_s1_entry_vmid = {_RANDOM[7'h4E][31:25], _RANDOM[7'h4F][6:0]};
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h4F][18:17];
        ptw_resp_bits_reg_1_s1_addr_low = {_RANDOM[7'h50][31:30], _RANDOM[7'h51][0]};
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h51][25];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h51][26];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h51][27];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h51][28];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h51][29];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h51][30];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h51][31];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h52][0];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[7'h52][31:11], _RANDOM[7'h53][16:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = _RANDOM[7'h54][14:1];
        ptw_resp_bits_reg_1_s2_entry_level = {_RANDOM[7'h55][31], _RANDOM[7'h56][0]};
        ptw_already_back_last_REG_1 = _RANDOM[7'h56][15];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
