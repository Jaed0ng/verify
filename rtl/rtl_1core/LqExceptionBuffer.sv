...
module LqExceptionBuffer(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:652];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [9:0] i = 10'h0; i < 10'h28D; i += 10'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        req_gpaddr = {_RANDOM[10'h2B][31:17], _RANDOM[10'h2C], _RANDOM[10'h2D][16:0]};
        req_isHyper = _RANDOM[10'h32][12];
        req_isForVSnonLeafPTE = _RANDOM[10'h32][13];
        s2_req_0_uop_exceptionVec_3 = _RANDOM[10'h53][13];
        s2_req_0_uop_exceptionVec_4 = _RANDOM[10'h53][14];
        s2_req_0_uop_exceptionVec_5 = _RANDOM[10'h53][15];
        s2_req_0_uop_exceptionVec_13 = _RANDOM[10'h53][23];
        s2_req_0_uop_exceptionVec_19 = _RANDOM[10'h53][29];
        s2_req_0_uop_exceptionVec_21 = _RANDOM[10'h53][31];
        s2_req_0_uop_uopIdx = _RANDOM[10'h5F][6:0];
        s2_req_0_uop_robIdx_flag = _RANDOM[10'h62][26];
        s2_req_0_uop_robIdx_value = {_RANDOM[10'h62][31:27], _RANDOM[10'h63][2:0]};
        s2_req_0_fullva =
          {_RANDOM[10'h78][31:13], _RANDOM[10'h79], _RANDOM[10'h7A][12:0]};
        s2_req_0_vaNeedExt = _RANDOM[10'h7A][13];
        s2_req_0_gpaddr =
          {_RANDOM[10'h7B][31:30], _RANDOM[10'h7C], _RANDOM[10'h7D][29:0]};
        s2_req_0_isHyper = _RANDOM[10'h82][25];
        s2_req_0_isForVSnonLeafPTE = _RANDOM[10'h82][26];
        s2_req_1_uop_exceptionVec_3 = _RANDOM[10'hA3][26];
        s2_req_1_uop_exceptionVec_4 = _RANDOM[10'hA3][27];
        s2_req_1_uop_exceptionVec_5 = _RANDOM[10'hA3][28];
        s2_req_1_uop_exceptionVec_13 = _RANDOM[10'hA4][4];
        s2_req_1_uop_exceptionVec_19 = _RANDOM[10'hA4][10];
        s2_req_1_uop_exceptionVec_21 = _RANDOM[10'hA4][12];
        s2_req_1_uop_uopIdx = _RANDOM[10'hAF][19:13];
        s2_req_1_uop_robIdx_flag = _RANDOM[10'hB3][7];
        s2_req_1_uop_robIdx_value = _RANDOM[10'hB3][15:8];
        s2_req_1_fullva =
          {_RANDOM[10'hC8][31:26], _RANDOM[10'hC9], _RANDOM[10'hCA][25:0]};
        s2_req_1_vaNeedExt = _RANDOM[10'hCA][26];
        s2_req_1_gpaddr =
          {_RANDOM[10'hCC][31:11], _RANDOM[10'hCD], _RANDOM[10'hCE][10:0]};
        s2_req_1_isHyper = _RANDOM[10'hD3][6];
        s2_req_1_isForVSnonLeafPTE = _RANDOM[10'hD3][7];
        s2_req_2_uop_exceptionVec_3 = _RANDOM[10'hF4][7];
        s2_req_2_uop_exceptionVec_4 = _RANDOM[10'hF4][8];
        s2_req_2_uop_exceptionVec_5 = _RANDOM[10'hF4][9];
        s2_req_2_uop_exceptionVec_13 = _RANDOM[10'hF4][17];
        s2_req_2_uop_exceptionVec_19 = _RANDOM[10'hF4][23];
        s2_req_2_uop_exceptionVec_21 = _RANDOM[10'hF4][25];
        s2_req_2_uop_uopIdx = {_RANDOM[10'hFF][31:26], _RANDOM[10'h100][0]};
        s2_req_2_uop_robIdx_flag = _RANDOM[10'h103][20];
        s2_req_2_uop_robIdx_value = _RANDOM[10'h103][28:21];
        s2_req_2_fullva =
          {_RANDOM[10'h119][31:7], _RANDOM[10'h11A], _RANDOM[10'h11B][6:0]};
        s2_req_2_vaNeedExt = _RANDOM[10'h11B][7];
        s2_req_2_gpaddr =
          {_RANDOM[10'h11C][31:24], _RANDOM[10'h11D], _RANDOM[10'h11E][23:0]};
        s2_req_2_isHyper = _RANDOM[10'h123][19];
        s2_req_2_isForVSnonLeafPTE = _RANDOM[10'h123][20];
        s2_req_3_uop_exceptionVec_3 = _RANDOM[10'h144][20];
        s2_req_3_uop_exceptionVec_4 = _RANDOM[10'h144][21];
        s2_req_3_uop_exceptionVec_5 = _RANDOM[10'h144][22];
        s2_req_3_uop_exceptionVec_13 = _RANDOM[10'h144][30];
        s2_req_3_uop_exceptionVec_21 = _RANDOM[10'h145][6];
        s2_req_3_uop_uopIdx = _RANDOM[10'h150][13:7];
        s2_req_3_uop_robIdx_flag = _RANDOM[10'h154][1];
        s2_req_3_uop_robIdx_value = _RANDOM[10'h154][9:2];
        s2_req_3_fullva =
          {_RANDOM[10'h169][31:20], _RANDOM[10'h16A], _RANDOM[10'h16B][19:0]};
        s2_req_3_vaNeedExt = _RANDOM[10'h16B][20];
        s2_req_3_gpaddr =
          {_RANDOM[10'h16D][31:5], _RANDOM[10'h16E], _RANDOM[10'h16F][4:0]};
        s2_req_4_uop_exceptionVec_3 = _RANDOM[10'h195][1];
        s2_req_4_uop_exceptionVec_4 = _RANDOM[10'h195][2];
        s2_req_4_uop_exceptionVec_5 = _RANDOM[10'h195][3];
        s2_req_4_uop_exceptionVec_13 = _RANDOM[10'h195][11];
        s2_req_4_uop_exceptionVec_21 = _RANDOM[10'h195][19];
        s2_req_4_uop_uopIdx = _RANDOM[10'h1A0][26:20];
        s2_req_4_uop_robIdx_flag = _RANDOM[10'h1A4][14];
        s2_req_4_uop_robIdx_value = _RANDOM[10'h1A4][22:15];
        s2_req_4_fullva = {_RANDOM[10'h1BA][31:1], _RANDOM[10'h1BB], _RANDOM[10'h1BC][0]};
        s2_req_4_vaNeedExt = _RANDOM[10'h1BC][1];
        s2_req_4_gpaddr =
          {_RANDOM[10'h1BD][31:18], _RANDOM[10'h1BE], _RANDOM[10'h1BF][17:0]};
        s2_req_5_uop_exceptionVec_3 = _RANDOM[10'h1E5][14];
        s2_req_5_uop_exceptionVec_4 = _RANDOM[10'h1E5][15];
        s2_req_5_uop_exceptionVec_5 = _RANDOM[10'h1E5][16];
        s2_req_5_uop_exceptionVec_13 = _RANDOM[10'h1E5][24];
        s2_req_5_uop_exceptionVec_19 = _RANDOM[10'h1E5][30];
        s2_req_5_uop_exceptionVec_21 = _RANDOM[10'h1E6][0];
        s2_req_5_uop_uopIdx = _RANDOM[10'h1F1][7:1];
        s2_req_5_uop_robIdx_flag = _RANDOM[10'h1F4][27];
        s2_req_5_uop_robIdx_value = {_RANDOM[10'h1F4][31:28], _RANDOM[10'h1F5][3:0]};
        s2_req_5_fullva =
          {_RANDOM[10'h20A][31:14], _RANDOM[10'h20B], _RANDOM[10'h20C][13:0]};
        s2_req_5_gpaddr =
          {_RANDOM[10'h20D][31], _RANDOM[10'h20E], _RANDOM[10'h20F][30:0]};
        s2_req_5_isHyper = _RANDOM[10'h214][26];
        s2_req_5_isForVSnonLeafPTE = _RANDOM[10'h214][27];
        s2_valid_REG = _RANDOM[10'h232][28];
        s2_valid_REG_1_valid = _RANDOM[10'h232][29];
        s2_valid_REG_1_bits_robIdx_flag = _RANDOM[10'h232][31];
        s2_valid_REG_1_bits_robIdx_value = _RANDOM[10'h233][7:0];
        s2_valid_REG_1_bits_level = _RANDOM[10'h233][19];
        s2_valid_REG_2 = _RANDOM[10'h244][19];
        s2_valid_REG_3_valid = _RANDOM[10'h244][20];
        s2_valid_REG_3_bits_robIdx_flag = _RANDOM[10'h244][22];
        s2_valid_REG_3_bits_robIdx_value = _RANDOM[10'h244][30:23];
        s2_valid_REG_3_bits_level = _RANDOM[10'h245][10];
        s2_valid_REG_4 = _RANDOM[10'h256][10];
        s2_valid_REG_5_valid = _RANDOM[10'h256][11];
        s2_valid_REG_5_bits_robIdx_flag = _RANDOM[10'h256][13];
        s2_valid_REG_5_bits_robIdx_value = _RANDOM[10'h256][21:14];
        s2_valid_REG_5_bits_level = _RANDOM[10'h257][1];
        s2_valid_REG_6 = _RANDOM[10'h268][1];
        s2_valid_REG_7_valid = _RANDOM[10'h268][2];
        s2_valid_REG_7_bits_robIdx_flag = _RANDOM[10'h268][4];
        s2_valid_REG_7_bits_robIdx_value = _RANDOM[10'h268][12:5];
        s2_valid_REG_7_bits_level = _RANDOM[10'h268][24];
        s2_valid_REG_8 = _RANDOM[10'h279][24];
        s2_valid_REG_9_valid = _RANDOM[10'h279][25];
        s2_valid_REG_9_bits_robIdx_flag = _RANDOM[10'h279][27];
        s2_valid_REG_9_bits_robIdx_value =
          {_RANDOM[10'h279][31:28], _RANDOM[10'h27A][3:0]};
        s2_valid_REG_9_bits_level = _RANDOM[10'h27A][15];
        s2_valid_REG_10 = _RANDOM[10'h28B][15];
        s2_valid_REG_11_valid = _RANDOM[10'h28B][16];
        s2_valid_REG_11_bits_robIdx_flag = _RANDOM[10'h28B][18];
        s2_valid_REG_11_bits_robIdx_value = _RANDOM[10'h28B][26:19];
        s2_valid_REG_11_bits_level = _RANDOM[10'h28C][6];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        req_valid = 1'h0;
    end // initial
