...
module SourceD(
  ...
  output [3:0]   io_sourceD_r_hazard_bits_way,
  output [11:0]  io_sourceD_r_hazard_bits_set,
  ...
  wire [11:0]  s1_req_set = busy ? s1_req_reg_set : io_task_bits_set;
  ...
  wire [3:0]   s1_req_way = busy ? s1_req_reg_way : io_task_bits_way;
  ...
  reg          s3_queue_io_enq_valid_REG_3;
  reg          s3_queue_io_enq_valid_REG_4;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      s3_queue_io_enq_valid_REG_3 <= 1'h0;
      s3_queue_io_enq_valid_REG_4 <= 1'h0;
      s4_full <= 1'h0;
      beatsLeft <= 1'h0;
      state_0 <= 1'h0;
      state_1 <= 1'h0;
      ...
      s3_queue_io_enq_valid_REG_3 <= s3_queue_io_enq_valid_REG_2;
      s3_queue_io_enq_valid_REG_4 <= s3_queue_io_enq_valid_REG_3;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_req_reg_set = _RANDOM[5'h0][24:13];
        s1_req_reg_tag = {_RANDOM[5'h0][31:25], _RANDOM[5'h1][20:0]};
        s1_req_reg_channel = _RANDOM[5'h1][23:21];
        s1_req_reg_opcode = _RANDOM[5'h1][26:24];
        s1_req_reg_param = _RANDOM[5'h1][29:27];
        s1_req_reg_size = {_RANDOM[5'h1][31:30], _RANDOM[5'h2][0]};
        s1_req_reg_way = _RANDOM[5'h2][4:1];
        s1_req_reg_off = _RANDOM[5'h2][10:5];
        s1_req_reg_useBypass = _RANDOM[5'h2][11];
        s1_req_reg_bufIdx = _RANDOM[5'h2][15:12];
        s1_req_reg_denied = _RANDOM[5'h2][16];
        s1_req_reg_sinkId = _RANDOM[5'h2][20:17];
        s1_req_reg_bypassPut = _RANDOM[5'h2][21];
        s1_req_reg_dirty = _RANDOM[5'h2][22];
        s1_req_reg_isHit = _RANDOM[5'h2][23];
        s1_counter = _RANDOM[5'h2][24];
        s2_req_sourceId = {_RANDOM[5'h2][31:25], _RANDOM[5'h3][3:0]};
        s2_req_set = _RANDOM[5'h3][15:4];
        s2_req_tag = {_RANDOM[5'h3][31:16], _RANDOM[5'h4][11:0]};
        s2_req_channel = _RANDOM[5'h4][14:12];
        s2_req_opcode = _RANDOM[5'h4][17:15];
        s2_req_param = _RANDOM[5'h4][20:18];
        s2_req_size = _RANDOM[5'h4][23:21];
        s2_req_way = _RANDOM[5'h4][27:24];
        s2_req_off = {_RANDOM[5'h4][31:28], _RANDOM[5'h5][1:0]};
        s2_req_useBypass = _RANDOM[5'h5][2];
        s2_req_bufIdx = _RANDOM[5'h5][6:3];
        s2_req_denied = _RANDOM[5'h5][7];
        s2_req_sinkId = _RANDOM[5'h5][11:8];
        s2_req_bypassPut = _RANDOM[5'h5][12];
        s2_req_dirty = _RANDOM[5'h5][13];
        s2_req_isHit = _RANDOM[5'h5][14];
        s2_needData = _RANDOM[5'h5][15];
        s2_beat = _RANDOM[5'h5][16];
        s2_last = _RANDOM[5'h5][17];
        s2_counter = _RANDOM[5'h5][18];
        s2_full = _RANDOM[5'h5][19];
        s2_need_pb = _RANDOM[5'h5][20];
        s2_need_d = _RANDOM[5'h5][21];
        s2_valid_pb = _RANDOM[5'h5][22];
        pbQueue_io_enq_valid_REG = _RANDOM[5'h5][23];
        s3_queue_io_enq_valid_REG = _RANDOM[5'h5][24];
        s3_queue_io_enq_valid_REG_1 = _RANDOM[5'h5][25];
        s3_queue_io_enq_valid_REG_2 = _RANDOM[5'h5][26];
        s3_queue_io_enq_valid_REG_3 = _RANDOM[5'h5][27];
        s3_queue_io_enq_valid_REG_4 = _RANDOM[5'h5][28];
        s4_req_set = _RANDOM[5'h6][19:8];
        s4_req_way = _RANDOM[5'h7][31:28];
        s4_req_sinkId = _RANDOM[5'h8][15:12];
        s4_rdata =
          {_RANDOM[5'h8][31:19],
           _RANDOM[5'h9],
           _RANDOM[5'hA],
        ...
        s4_pbdata_data =
          {_RANDOM[5'h10][31:19],
           ...
           _RANDOM[5'h17],
           _RANDOM[5'h18][18:0]};
        s4_pbdata_mask = {_RANDOM[5'h18][31:19], _RANDOM[5'h19][18:0]};
        s4_need_pb = _RANDOM[5'h19][20];
        s4_beat = _RANDOM[5'h19][21];
        s4_last = _RANDOM[5'h19][22];
        s4_full = _RANDOM[5'h19][23];
        beatsLeft = _RANDOM[5'h19][24];
        state_0 = _RANDOM[5'h19][25];
        state_1 = _RANDOM[5'h19][26];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        s1_block_r = 1'h0;
  ...
  Queue10_PutBufferBeatEntry pbQueue (
    .clock               (clock),
    .reset               (reset),
  ...
  Queue6_DSData s3_queue (
    .clock               (clock),
    .reset               (reset),
    .io_enq_valid        (s3_queue_io_enq_valid_REG_4),
