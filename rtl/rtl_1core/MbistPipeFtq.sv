...
module MbistPipeFtq(
  ...
  reg          renReg;
  reg  [6:0]   addrRdReg;
  wire         selectedVec_0 = arrayReg == 7'h4E;
  wire         doSpread = selectedVec_0 | allReg;
  assign sramDataOut_0 = selectedVec_0 ? toSRAM_0_rdata : 160'h0;
  wire         selectedVec_0_1 = arrayReg == 7'h4F;
  wire         doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = selectedVec_0_1 ? toSRAM_1_rdata : 160'h0;
  wire         activated =
    mbist_all | mbist_req & (mbist_array == 7'h4E | mbist_array == 7'h4F);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beReg = _RANDOM[3'h0][10];
        addrReg = _RANDOM[3'h0][17:11];
        dataInReg =
          {_RANDOM[3'h0][31:18],
           _RANDOM[3'h1],
           _RANDOM[3'h2],
           ...
           _RANDOM[3'h4],
           _RANDOM[3'h5][17:0]};
        renReg = _RANDOM[3'h5][18];
        addrRdReg = _RANDOM[3'h5][25:19];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 7'h0;
        reqReg = 1'h0;
