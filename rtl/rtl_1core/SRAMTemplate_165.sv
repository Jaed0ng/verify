...
module SRAMTemplate_165(
  ...
  wire [12:0]  mbistBd_addr = boreChildrenBd_bore_addr;
  wire [12:0]  mbistBd_addr_rd = boreChildrenBd_bore_addr_rd;
  ...
  wire         _GEN = ramWen & ~io_broadcast_mbist_ram_hold;
  reg  [1:0]   respReg;
  reg  [136:0] rdataReg;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        rckEnReg = _RANDOM[3'h0][0];
        wckEnReg = _RANDOM[3'h0][1];
        respReg = _RANDOM[3'h0][3:2];
        rdataReg =
          {_RANDOM[3'h2][31:30],
           _RANDOM[3'h3],
           _RANDOM[3'h4],
  ...
  sram_array_1p4096x137m137s1h1l2b_l2_dat array (
