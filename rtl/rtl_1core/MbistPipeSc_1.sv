...
module MbistPipeSc_1(
  ...
  reg         renReg;
  reg  [8:0]  addrRdReg;
  wire        selectedVec_0 = arrayReg == 7'h43;
  wire        doSpread = selectedVec_0 | allReg;
  wire        activated = mbist_all | mbist_req & mbist_array == 7'h43;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        addrReg = _RANDOM[1'h0][22:14];
        dataInReg = {_RANDOM[1'h0][31:23], _RANDOM[1'h1][14:0]};
        renReg = _RANDOM[1'h1][15];
        addrRdReg = _RANDOM[1'h1][24:16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 7'h0;
        reqReg = 1'h0;
  ...
  assign mbist_outdata = selectedVec_0 ? toSRAM_0_rdata : 24'h0;
