...
module MbistPipeTage(
  ...
  output [15:0] toSRAM_20_wdata,
  output [7:0]  toSRAM_20_wmask,
  output        toSRAM_20_re,
  output        toSRAM_20_we,
  input  [15:0] toSRAM_20_rdata,
  ...
  output [15:0] toSRAM_21_wdata,
  output [7:0]  toSRAM_21_wmask,
  output        toSRAM_21_re,
  output        toSRAM_21_we,
  input  [15:0] toSRAM_21_rdata,
  output        toSRAM_21_ack,
  output        toSRAM_21_selectedOH,
  output [6:0]  toSRAM_21_array
);

  wire [15:0] _sramDataOut_21_T;
  wire [15:0] _sramDataOut_20_T;
  ...
  assign _sramDataOut_20_T = selectedVec_0_20 ? toSRAM_20_rdata : 16'h0;
  wire        selectedVec_0_21 = arrayReg == 7'h41;
  wire        doSpread_21 = selectedVec_0_21 | allReg;
  assign _sramDataOut_21_T = selectedVec_0_21 ? toSRAM_21_rdata : 16'h0;
  wire        activated =
    mbist_all | mbist_req
  ...
  assign mbist_outdata =
    ...
    | {8'h0,
       _sramDataOut_0_T | _sramDataOut_5_T | _sramDataOut_10_T | _sramDataOut_15_T
         | _sramDataOut_20_T | _sramDataOut_21_T};
  ...
  assign toSRAM_20_wdata = dataInReg[15:0];
  assign toSRAM_20_wmask = beReg[7:0];
  ...
  assign toSRAM_21_wdata = dataInReg[15:0];
  assign toSRAM_21_wmask = beReg[7:0];
