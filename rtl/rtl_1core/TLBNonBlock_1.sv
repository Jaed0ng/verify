...
module TLBNonBlock_1(
  ...
  wire             _req_s2xlate_T_17 = _csr_delay_io_out_vsatp_mode == 4'h0;
  wire             _req_s2xlate_T_18 = _csr_delay_io_out_hgatp_mode == 4'h0;
  ...
  wire             _stPf_T =
    ~(~(mode_0 == 2'h0 & ~readResult_0_4_0_u | mode_0 == 2'h1 & readResult_0_4_0_u
        & ~(_req_out_s2xlate_T
              ...
              : _csr_delay_io_out_priv_sum)) & readResult_0_4_0_w) | readResult_0_4_0_pf;
  wire             isFakePte =
  ...
  wire             _stPf_T_1 =
    ~(~(mode_1 == 2'h0 & ~readResult_1_4_0_u | mode_1 == 2'h1 & readResult_1_4_0_u
        & ~(_req_out_s2xlate_T_10
              ? _csr_delay_io_out_priv_vsum
              : _csr_delay_io_out_priv_sum)) & readResult_1_4_0_w) | readResult_1_4_0_pf;
  wire             isFakePte_1 =
  ...
  wire             _GEN_20 = _csr_delay_io_out_priv_imode == 2'h0;
  wire [1:0]       pmm =
    (&premode_0)
    ...
    if (io_ptw_resp_valid) begin
      readResult_p_ppn <=
        readResult_onlyS2 | (&req_in_s2xlate_0)
          ? _GEN_40[io_ptw_resp_bits_s2_entry_level][35:0]
          : _GEN_37[io_ptw_resp_bits_s1_entry_level][35:0];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_p_ppn = {_RANDOM[7'h17][31:30], _RANDOM[7'h18], _RANDOM[7'h19][1:0]};
        readResult_p_pbmt = _RANDOM[7'h19][3:2];
        readResult_p_perm_pf = _RANDOM[7'h19][4];
        readResult_p_perm_af = _RANDOM[7'h19][5];
        readResult_p_perm_v = _RANDOM[7'h19][6];
        readResult_p_perm_d = _RANDOM[7'h19][7];
        readResult_p_perm_a = _RANDOM[7'h19][8];
        readResult_p_perm_u = _RANDOM[7'h19][10];
        readResult_p_perm_x = _RANDOM[7'h19][11];
        readResult_p_perm_w = _RANDOM[7'h19][12];
        readResult_p_perm_r = _RANDOM[7'h19][13];
        readResult_p_gvpn = {_RANDOM[7'h19][31:14], _RANDOM[7'h1A][25:0]};
        readResult_p_g_pbmt = _RANDOM[7'h1A][27:26];
        readResult_p_g_perm_pf = _RANDOM[7'h1A][28];
        readResult_p_g_perm_af = _RANDOM[7'h1A][29];
        readResult_p_g_perm_d = _RANDOM[7'h1A][31];
        readResult_p_g_perm_a = _RANDOM[7'h1B][0];
        readResult_p_g_perm_w = _RANDOM[7'h1B][4];
        readResult_p_s2xlate = _RANDOM[7'h1B][7:6];
        readResult_p_s1_level = _RANDOM[7'h1B][9:8];
        readResult_p_s1_isLeaf = _RANDOM[7'h1B][10];
        readResult_p_s1_isFakePte = _RANDOM[7'h1B][11];
        readResult_lastCycleRedirect_REG_valid = _RANDOM[7'h1B][12];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[7'h1B][14];
        readResult_lastCycleRedirect_REG_bits_robIdx_value = _RANDOM[7'h1B][22:15];
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[7'h1C][2];
        readResult_p_hit_last_REG_1 = _RANDOM[7'h2D][11];
        readResult_p_ppn_1 = {_RANDOM[7'h2D][31:12], _RANDOM[7'h2E][15:0]};
        readResult_p_pbmt_1 = _RANDOM[7'h2E][17:16];
        readResult_p_perm_1_pf = _RANDOM[7'h2E][18];
        readResult_p_perm_1_af = _RANDOM[7'h2E][19];
        readResult_p_perm_1_v = _RANDOM[7'h2E][20];
        readResult_p_perm_1_d = _RANDOM[7'h2E][21];
        readResult_p_perm_1_a = _RANDOM[7'h2E][22];
        readResult_p_perm_1_u = _RANDOM[7'h2E][24];
        readResult_p_perm_1_x = _RANDOM[7'h2E][25];
        readResult_p_perm_1_w = _RANDOM[7'h2E][26];
        readResult_p_perm_1_r = _RANDOM[7'h2E][27];
        readResult_p_gvpn_1 =
          {_RANDOM[7'h2E][31:28], _RANDOM[7'h2F], _RANDOM[7'h30][7:0]};
        readResult_p_g_pbmt_1 = _RANDOM[7'h30][9:8];
        readResult_p_g_perm_1_pf = _RANDOM[7'h30][10];
        readResult_p_g_perm_1_af = _RANDOM[7'h30][11];
        readResult_p_g_perm_1_d = _RANDOM[7'h30][13];
        readResult_p_g_perm_1_a = _RANDOM[7'h30][14];
        readResult_p_g_perm_1_w = _RANDOM[7'h30][18];
        readResult_p_s2xlate_1 = _RANDOM[7'h30][21:20];
        readResult_p_s1_level_1 = _RANDOM[7'h30][23:22];
        readResult_p_s1_isLeaf_1 = _RANDOM[7'h30][24];
        readResult_p_s1_isFakePte_1 = _RANDOM[7'h30][25];
        readResult_lastCycleRedirect_REG_1_valid = _RANDOM[7'h30][26];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_flag = _RANDOM[7'h30][28];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_value =
          {_RANDOM[7'h30][31:29], _RANDOM[7'h31][4:0]};
        readResult_lastCycleRedirect_REG_1_bits_level = _RANDOM[7'h31][16];
        REG = _RANDOM[7'h42][26];
        io_requestor_0_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h42][28];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h42][30];
        io_requestor_0_resp_bits_excp_0_af_st_REG = _RANDOM[7'h43][0];
        REG_1 = _RANDOM[7'h43][2];
        io_requestor_1_resp_bits_excp_0_pf_st_REG = _RANDOM[7'h43][4];
        io_requestor_1_resp_bits_excp_0_gpf_st_REG = _RANDOM[7'h43][6];
        io_requestor_1_resp_bits_excp_0_af_st_REG = _RANDOM[7'h43][8];
        ptw_resp_bits_reg_s2xlate = _RANDOM[7'h43][10:9];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[7'h43][31:11], _RANDOM[7'h44][13:0]};
        ptw_resp_bits_reg_s1_entry_asid = _RANDOM[7'h44][29:14];
        ptw_resp_bits_reg_s1_entry_vmid = {_RANDOM[7'h44][31:30], _RANDOM[7'h45][11:0]};
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[7'h45][23:22];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[7'h47][5:3];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[7'h47][30];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[7'h47][31];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[7'h48][0];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[7'h48][1];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[7'h48][2];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[7'h48][3];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[7'h48][4];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[7'h48][5];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[7'h48][31:16], _RANDOM[7'h49][21:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[7'h4A][19:6];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[7'h4C][5:4];
        ptw_already_back_last_REG = _RANDOM[7'h4C][20];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[7'h4C][23:22];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[7'h4C][31:24], _RANDOM[7'h4D][26:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = {_RANDOM[7'h4D][31:27], _RANDOM[7'h4E][10:0]};
        ptw_resp_bits_reg_1_s1_entry_vmid = _RANDOM[7'h4E][24:11];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[7'h4F][4:3];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[7'h50][18:16];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[7'h51][11];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[7'h51][12];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[7'h51][13];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[7'h51][14];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[7'h51][15];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[7'h51][16];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[7'h51][17];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[7'h51][18];
        ptw_resp_bits_reg_1_s2_entry_tag =
          {_RANDOM[7'h51][31:29], _RANDOM[7'h52], _RANDOM[7'h53][2:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = {_RANDOM[7'h53][31:19], _RANDOM[7'h54][0]};
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[7'h55][18:17];
        ptw_already_back_last_REG_1 = _RANDOM[7'h56][1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
