...
module TLBNonBlock(
  ...
  wire             _req_s2xlate_T_41 = _csr_delay_io_out_vsatp_mode == 4'h0;
  wire             _req_s2xlate_T_42 = _csr_delay_io_out_hgatp_mode == 4'h0;
  ...
  wire             _s2xlateEnable_T_18 = isHyperInst_3 | virt_out_3;
  ...
  wire [3:0][1:0]  _GEN_25 =
    {{(|readResult_3_6_0) ? readResult_3_6_0 : readResult_3_7_0},
     ...
     {readResult_3_6_0},
     {readResult_3_6_0}};
  wire             _s2_valid_T_6 = onlyS2_6 | (&req_out_s2xlate_3);
  wire             af_10 =
    ~onlyS2_6 & readResult_3_4_0_af | _s2_valid_T_6
    & (readResult_p_hit_last_REG_3
  ...
  wire             _modeCheck_T_62 =
    ...
    & ~(_req_out_s2xlate_T_30 ? _csr_delay_io_out_priv_vsum : _csr_delay_io_out_priv_sum);
  wire             isFakePte_6 =
  ...
  wire             _io_requestor_3_resp_bits_excp_0_pf_ld_T_1 =
    (~(~_modeCheck_T_62
       & (req_out_3_hlvx
            ? readResult_3_4_0_x
            : readResult_3_4_0_r
              | (_req_out_s2xlate_T_30 & _csr_delay_io_out_priv_vmxr
  ...
  wire             ptw_already_back_vmid_hit_3 =
  ...
  wire             _GEN_43 =
    ...
    & (ptw_resp_bits_reg_3_s2xlate == 2'h0
         ? ptw_resp_bits_reg_3_s1_entry_asid == ((|ptw_resp_bits_reg_3_s2xlate)
                                                   ? _csr_delay_io_out_vsatp_asid
                                                   : _csr_delay_io_out_satp_asid)
           & (~(|ptw_resp_bits_reg_3_s2xlate) | ptw_already_back_vmid_hit_3)
             ...
             : (ptw_already_back_level_3 == 2'h0
                  ...
                  : ptw_already_back_level_3 == 2'h1
                      ...
                      : (ptw_already_back_level_3 != 2'h2
                        ...
                        & ptw_already_back_tag_match_3_3) & ptw_already_back_vmid_hit_3
  ...
  wire             _GEN_46 = _csr_delay_io_out_priv_imode == 2'h0;
  wire [1:0]       pmm =
  ...
  wire [1:0]       pmm_2 =
    io_requestor_2_req_bits_hlvx
      ...
      : (&premode_2)
          ? _csr_delay_io_out_pmm_mseccfg
          : ~_pres2xlateEnable_T_12 & _GEN_56
              ? _csr_delay_io_out_pmm_menvcfg
              : _pres2xlateEnable_T_12 & _GEN_56
                  ? _csr_delay_io_out_pmm_henvcfg
  ...
  wire [1:0]       pmm_3 =
    io_requestor_3_req_bits_hlvx
      ...
      : (&premode_3)
          ? _csr_delay_io_out_pmm_mseccfg
          : ~_pres2xlateEnable_T_18 & _GEN_61
              ? _csr_delay_io_out_pmm_menvcfg
              : _pres2xlateEnable_T_18 & _GEN_61
                  ? _csr_delay_io_out_pmm_henvcfg
    ...
    if (io_ptw_resp_valid) begin
      readResult_p_ppn <=
        readResult_onlyS2 | (&req_in_s2xlate_0)
          ? _GEN_87[io_ptw_resp_bits_s2_entry_level][35:0]
          : _GEN_81[io_ptw_resp_bits_s1_entry_level][35:0];
      ...
      readResult_p_ppn_1 <=
        readResult_onlyS2_1 | (&req_in_s2xlate_1)
          ...
          : _GEN_83[io_ptw_resp_bits_s1_entry_level][35:0];
      ...
      readResult_p_ppn_2 <=
        readResult_onlyS2_2 | (&req_in_s2xlate_2)
          ...
          : _GEN_85[io_ptw_resp_bits_s1_entry_level][35:0];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        readResult_p_ppn = {_RANDOM[8'h2C][31:26], _RANDOM[8'h2D][29:0]};
        readResult_p_pbmt = _RANDOM[8'h2D][31:30];
        readResult_p_perm_pf = _RANDOM[8'h2E][0];
        readResult_p_perm_af = _RANDOM[8'h2E][1];
        readResult_p_perm_v = _RANDOM[8'h2E][2];
        readResult_p_perm_d = _RANDOM[8'h2E][3];
        readResult_p_perm_a = _RANDOM[8'h2E][4];
        readResult_p_perm_u = _RANDOM[8'h2E][6];
        readResult_p_perm_x = _RANDOM[8'h2E][7];
        readResult_p_perm_w = _RANDOM[8'h2E][8];
        readResult_p_perm_r = _RANDOM[8'h2E][9];
        readResult_p_gvpn = {_RANDOM[8'h2E][31:10], _RANDOM[8'h2F][21:0]};
        readResult_p_g_pbmt = _RANDOM[8'h2F][23:22];
        readResult_p_g_perm_pf = _RANDOM[8'h2F][24];
        readResult_p_g_perm_af = _RANDOM[8'h2F][25];
        readResult_p_g_perm_d = _RANDOM[8'h2F][27];
        readResult_p_g_perm_a = _RANDOM[8'h2F][28];
        readResult_p_g_perm_x = _RANDOM[8'h2F][31];
        readResult_p_g_perm_w = _RANDOM[8'h30][0];
        readResult_p_g_perm_r = _RANDOM[8'h30][1];
        readResult_p_s2xlate = _RANDOM[8'h30][3:2];
        readResult_p_s1_level = _RANDOM[8'h30][5:4];
        readResult_p_s1_isLeaf = _RANDOM[8'h30][6];
        readResult_p_s1_isFakePte = _RANDOM[8'h30][7];
        readResult_lastCycleRedirect_REG_valid = _RANDOM[8'h30][8];
        readResult_lastCycleRedirect_REG_bits_robIdx_flag = _RANDOM[8'h30][10];
        readResult_lastCycleRedirect_REG_bits_robIdx_value = _RANDOM[8'h30][18:11];
        readResult_lastCycleRedirect_REG_bits_level = _RANDOM[8'h30][30];
        readResult_p_hit_last_REG_1 = _RANDOM[8'h42][7];
        readResult_p_ppn_1 = {_RANDOM[8'h42][31:8], _RANDOM[8'h43][11:0]};
        readResult_p_pbmt_1 = _RANDOM[8'h43][13:12];
        readResult_p_perm_1_pf = _RANDOM[8'h43][14];
        readResult_p_perm_1_af = _RANDOM[8'h43][15];
        readResult_p_perm_1_v = _RANDOM[8'h43][16];
        readResult_p_perm_1_d = _RANDOM[8'h43][17];
        readResult_p_perm_1_a = _RANDOM[8'h43][18];
        readResult_p_perm_1_u = _RANDOM[8'h43][20];
        readResult_p_perm_1_x = _RANDOM[8'h43][21];
        readResult_p_perm_1_w = _RANDOM[8'h43][22];
        readResult_p_perm_1_r = _RANDOM[8'h43][23];
        readResult_p_gvpn_1 =
          {_RANDOM[8'h43][31:24], _RANDOM[8'h44], _RANDOM[8'h45][3:0]};
        readResult_p_g_pbmt_1 = _RANDOM[8'h45][5:4];
        readResult_p_g_perm_1_pf = _RANDOM[8'h45][6];
        readResult_p_g_perm_1_af = _RANDOM[8'h45][7];
        readResult_p_g_perm_1_d = _RANDOM[8'h45][9];
        readResult_p_g_perm_1_a = _RANDOM[8'h45][10];
        readResult_p_g_perm_1_x = _RANDOM[8'h45][13];
        readResult_p_g_perm_1_w = _RANDOM[8'h45][14];
        readResult_p_g_perm_1_r = _RANDOM[8'h45][15];
        readResult_p_s2xlate_1 = _RANDOM[8'h45][17:16];
        readResult_p_s1_level_1 = _RANDOM[8'h45][19:18];
        readResult_p_s1_isLeaf_1 = _RANDOM[8'h45][20];
        readResult_p_s1_isFakePte_1 = _RANDOM[8'h45][21];
        readResult_lastCycleRedirect_REG_1_valid = _RANDOM[8'h45][22];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_flag = _RANDOM[8'h45][24];
        readResult_lastCycleRedirect_REG_1_bits_robIdx_value =
          {_RANDOM[8'h45][31:25], _RANDOM[8'h46][0]};
        readResult_lastCycleRedirect_REG_1_bits_level = _RANDOM[8'h46][12];
        readResult_p_hit_last_REG_2 = _RANDOM[8'h57][21];
        readResult_p_ppn_2 = {_RANDOM[8'h57][31:22], _RANDOM[8'h58][25:0]};
        readResult_p_pbmt_2 = _RANDOM[8'h58][27:26];
        readResult_p_perm_2_pf = _RANDOM[8'h58][28];
        readResult_p_perm_2_af = _RANDOM[8'h58][29];
        readResult_p_perm_2_v = _RANDOM[8'h58][30];
        readResult_p_perm_2_d = _RANDOM[8'h58][31];
        readResult_p_perm_2_a = _RANDOM[8'h59][0];
        readResult_p_perm_2_u = _RANDOM[8'h59][2];
        readResult_p_perm_2_x = _RANDOM[8'h59][3];
        readResult_p_perm_2_w = _RANDOM[8'h59][4];
        readResult_p_perm_2_r = _RANDOM[8'h59][5];
        readResult_p_gvpn_2 = {_RANDOM[8'h59][31:6], _RANDOM[8'h5A][17:0]};
        readResult_p_g_pbmt_2 = _RANDOM[8'h5A][19:18];
        readResult_p_g_perm_2_pf = _RANDOM[8'h5A][20];
        readResult_p_g_perm_2_af = _RANDOM[8'h5A][21];
        readResult_p_g_perm_2_d = _RANDOM[8'h5A][23];
        readResult_p_g_perm_2_a = _RANDOM[8'h5A][24];
        readResult_p_g_perm_2_x = _RANDOM[8'h5A][27];
        readResult_p_g_perm_2_w = _RANDOM[8'h5A][28];
        readResult_p_g_perm_2_r = _RANDOM[8'h5A][29];
        readResult_p_s2xlate_2 = _RANDOM[8'h5A][31:30];
        readResult_p_s1_level_2 = _RANDOM[8'h5B][1:0];
        readResult_p_s1_isLeaf_2 = _RANDOM[8'h5B][2];
        readResult_p_s1_isFakePte_2 = _RANDOM[8'h5B][3];
        readResult_lastCycleRedirect_REG_2_valid = _RANDOM[8'h5B][4];
        readResult_lastCycleRedirect_REG_2_bits_robIdx_flag = _RANDOM[8'h5B][6];
        readResult_lastCycleRedirect_REG_2_bits_robIdx_value = _RANDOM[8'h5B][14:7];
        readResult_lastCycleRedirect_REG_2_bits_level = _RANDOM[8'h5B][26];
        readResult_p_hit_last_REG_3 = _RANDOM[8'h6D][3];
        readResult_p_ppn_3 = {_RANDOM[8'h6D][31:4], _RANDOM[8'h6E][7:0]};
        readResult_p_pbmt_3 = _RANDOM[8'h6E][9:8];
        readResult_p_perm_3_pf = _RANDOM[8'h6E][10];
        readResult_p_perm_3_af = _RANDOM[8'h6E][11];
        readResult_p_perm_3_v = _RANDOM[8'h6E][12];
        readResult_p_perm_3_d = _RANDOM[8'h6E][13];
        readResult_p_perm_3_a = _RANDOM[8'h6E][14];
        readResult_p_perm_3_u = _RANDOM[8'h6E][16];
        readResult_p_perm_3_x = _RANDOM[8'h6E][17];
        readResult_p_perm_3_w = _RANDOM[8'h6E][18];
        readResult_p_perm_3_r = _RANDOM[8'h6E][19];
        readResult_p_g_pbmt_3 = _RANDOM[8'h70][1:0];
        readResult_p_g_perm_3_pf = _RANDOM[8'h70][2];
        readResult_p_g_perm_3_af = _RANDOM[8'h70][3];
        readResult_p_g_perm_3_d = _RANDOM[8'h70][5];
        readResult_p_g_perm_3_a = _RANDOM[8'h70][6];
        readResult_p_g_perm_3_x = _RANDOM[8'h70][9];
        readResult_p_g_perm_3_w = _RANDOM[8'h70][10];
        readResult_p_g_perm_3_r = _RANDOM[8'h70][11];
        readResult_lastCycleRedirect_REG_3_valid = _RANDOM[8'h70][18];
        readResult_lastCycleRedirect_REG_3_bits_robIdx_flag = _RANDOM[8'h70][20];
        readResult_lastCycleRedirect_REG_3_bits_robIdx_value = _RANDOM[8'h70][28:21];
        readResult_lastCycleRedirect_REG_3_bits_level = _RANDOM[8'h71][8];
        noTranslateReg = _RANDOM[8'h82][17];
        REG = _RANDOM[8'h82][18];
        io_requestor_0_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h82][19];
        io_requestor_0_resp_bits_excp_0_pf_st_REG = _RANDOM[8'h82][20];
        io_requestor_0_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h82][21];
        io_requestor_0_resp_bits_excp_0_gpf_st_REG = _RANDOM[8'h82][22];
        io_requestor_0_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h82][23];
        io_requestor_0_resp_bits_excp_0_af_st_REG = _RANDOM[8'h82][24];
        REG_1 = _RANDOM[8'h82][25];
        noTranslateReg_1 = _RANDOM[8'h83][0];
        REG_2 = _RANDOM[8'h83][1];
        io_requestor_1_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h83][2];
        io_requestor_1_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h83][4];
        io_requestor_1_resp_bits_excp_0_gpf_st_REG = _RANDOM[8'h83][5];
        io_requestor_1_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h83][6];
        REG_3 = _RANDOM[8'h83][8];
        noTranslateReg_2 = _RANDOM[8'h83][15];
        REG_4 = _RANDOM[8'h83][16];
        io_requestor_2_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h83][17];
        io_requestor_2_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h83][19];
        io_requestor_2_resp_bits_excp_0_gpf_st_REG = _RANDOM[8'h83][20];
        io_requestor_2_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h83][21];
        REG_5 = _RANDOM[8'h83][23];
        noTranslateReg_3 = _RANDOM[8'h83][30];
        REG_6 = _RANDOM[8'h83][31];
        io_requestor_3_resp_bits_excp_0_pf_ld_REG = _RANDOM[8'h84][0];
        io_requestor_3_resp_bits_excp_0_gpf_ld_REG = _RANDOM[8'h84][2];
        io_requestor_3_resp_bits_excp_0_gpf_st_REG = _RANDOM[8'h84][3];
        io_requestor_3_resp_bits_excp_0_af_ld_REG = _RANDOM[8'h84][4];
        REG_7 = _RANDOM[8'h84][6];
        ptw_resp_bits_reg_s2xlate = _RANDOM[8'h84][14:13];
        ptw_resp_bits_reg_s1_entry_tag = {_RANDOM[8'h84][31:15], _RANDOM[8'h85][17:0]};
        ptw_resp_bits_reg_s1_entry_asid = {_RANDOM[8'h85][31:18], _RANDOM[8'h86][1:0]};
        ptw_resp_bits_reg_s1_entry_vmid = _RANDOM[8'h86][15:2];
        ptw_resp_bits_reg_s1_entry_level = _RANDOM[8'h86][27:26];
        ptw_resp_bits_reg_s1_addr_low = _RANDOM[8'h88][9:7];
        ptw_resp_bits_reg_s1_valididx_0 = _RANDOM[8'h89][2];
        ptw_resp_bits_reg_s1_valididx_1 = _RANDOM[8'h89][3];
        ptw_resp_bits_reg_s1_valididx_2 = _RANDOM[8'h89][4];
        ptw_resp_bits_reg_s1_valididx_3 = _RANDOM[8'h89][5];
        ptw_resp_bits_reg_s1_valididx_4 = _RANDOM[8'h89][6];
        ptw_resp_bits_reg_s1_valididx_5 = _RANDOM[8'h89][7];
        ptw_resp_bits_reg_s1_valididx_6 = _RANDOM[8'h89][8];
        ptw_resp_bits_reg_s1_valididx_7 = _RANDOM[8'h89][9];
        ptw_resp_bits_reg_s2_entry_tag = {_RANDOM[8'h89][31:20], _RANDOM[8'h8A][25:0]};
        ptw_resp_bits_reg_s2_entry_vmid = _RANDOM[8'h8B][23:10];
        ptw_resp_bits_reg_s2_entry_level = _RANDOM[8'h8D][9:8];
        ptw_already_back_last_REG = _RANDOM[8'h8D][24];
        last_REG = _RANDOM[8'h8D][25];
        ptw_resp_bits_reg_1_s2xlate = _RANDOM[8'h8D][27:26];
        ptw_resp_bits_reg_1_s1_entry_tag = {_RANDOM[8'h8D][31:28], _RANDOM[8'h8E][30:0]};
        ptw_resp_bits_reg_1_s1_entry_asid = {_RANDOM[8'h8E][31], _RANDOM[8'h8F][14:0]};
        ptw_resp_bits_reg_1_s1_entry_vmid = _RANDOM[8'h8F][28:15];
        ptw_resp_bits_reg_1_s1_entry_level = _RANDOM[8'h90][8:7];
        ptw_resp_bits_reg_1_s1_addr_low = _RANDOM[8'h91][22:20];
        ptw_resp_bits_reg_1_s1_valididx_0 = _RANDOM[8'h92][15];
        ptw_resp_bits_reg_1_s1_valididx_1 = _RANDOM[8'h92][16];
        ptw_resp_bits_reg_1_s1_valididx_2 = _RANDOM[8'h92][17];
        ptw_resp_bits_reg_1_s1_valididx_3 = _RANDOM[8'h92][18];
        ptw_resp_bits_reg_1_s1_valididx_4 = _RANDOM[8'h92][19];
        ptw_resp_bits_reg_1_s1_valididx_5 = _RANDOM[8'h92][20];
        ptw_resp_bits_reg_1_s1_valididx_6 = _RANDOM[8'h92][21];
        ptw_resp_bits_reg_1_s1_valididx_7 = _RANDOM[8'h92][22];
        ptw_resp_bits_reg_1_s2_entry_tag = {_RANDOM[8'h93][31:1], _RANDOM[8'h94][6:0]};
        ptw_resp_bits_reg_1_s2_entry_vmid = {_RANDOM[8'h94][31:23], _RANDOM[8'h95][4:0]};
        ptw_resp_bits_reg_1_s2_entry_level = _RANDOM[8'h96][22:21];
        ptw_already_back_last_REG_1 = _RANDOM[8'h97][5];
        last_REG_1 = _RANDOM[8'h97][6];
        ptw_resp_bits_reg_2_s2xlate = _RANDOM[8'h97][8:7];
        ptw_resp_bits_reg_2_s1_entry_tag = {_RANDOM[8'h97][31:9], _RANDOM[8'h98][11:0]};
        ptw_resp_bits_reg_2_s1_entry_asid = _RANDOM[8'h98][27:12];
        ptw_resp_bits_reg_2_s1_entry_vmid = {_RANDOM[8'h98][31:28], _RANDOM[8'h99][9:0]};
        ptw_resp_bits_reg_2_s1_entry_level = _RANDOM[8'h99][21:20];
        ptw_resp_bits_reg_2_s1_addr_low = _RANDOM[8'h9B][3:1];
        ptw_resp_bits_reg_2_s1_valididx_0 = _RANDOM[8'h9B][28];
        ptw_resp_bits_reg_2_s1_valididx_1 = _RANDOM[8'h9B][29];
        ptw_resp_bits_reg_2_s1_valididx_2 = _RANDOM[8'h9B][30];
        ptw_resp_bits_reg_2_s1_valididx_3 = _RANDOM[8'h9B][31];
        ptw_resp_bits_reg_2_s1_valididx_4 = _RANDOM[8'h9C][0];
        ptw_resp_bits_reg_2_s1_valididx_5 = _RANDOM[8'h9C][1];
        ptw_resp_bits_reg_2_s1_valididx_6 = _RANDOM[8'h9C][2];
        ptw_resp_bits_reg_2_s1_valididx_7 = _RANDOM[8'h9C][3];
        ptw_resp_bits_reg_2_s2_entry_tag = {_RANDOM[8'h9C][31:14], _RANDOM[8'h9D][19:0]};
        ptw_resp_bits_reg_2_s2_entry_vmid = _RANDOM[8'h9E][17:4];
        ptw_resp_bits_reg_2_s2_entry_level = _RANDOM[8'hA0][3:2];
        ptw_already_back_last_REG_2 = _RANDOM[8'hA0][18];
        last_REG_2 = _RANDOM[8'hA0][19];
        ptw_resp_bits_reg_3_s2xlate = _RANDOM[8'hA0][21:20];
        ptw_resp_bits_reg_3_s1_entry_tag = {_RANDOM[8'hA0][31:22], _RANDOM[8'hA1][24:0]};
        ptw_resp_bits_reg_3_s1_entry_asid = {_RANDOM[8'hA1][31:25], _RANDOM[8'hA2][8:0]};
        ptw_resp_bits_reg_3_s1_entry_vmid = _RANDOM[8'hA2][22:9];
        ptw_resp_bits_reg_3_s1_entry_level = _RANDOM[8'hA3][2:1];
        ptw_resp_bits_reg_3_s1_addr_low = _RANDOM[8'hA4][16:14];
        ptw_resp_bits_reg_3_s1_valididx_0 = _RANDOM[8'hA5][9];
        ptw_resp_bits_reg_3_s1_valididx_1 = _RANDOM[8'hA5][10];
        ptw_resp_bits_reg_3_s1_valididx_2 = _RANDOM[8'hA5][11];
        ptw_resp_bits_reg_3_s1_valididx_3 = _RANDOM[8'hA5][12];
        ptw_resp_bits_reg_3_s1_valididx_4 = _RANDOM[8'hA5][13];
        ptw_resp_bits_reg_3_s1_valididx_5 = _RANDOM[8'hA5][14];
        ptw_resp_bits_reg_3_s1_valididx_6 = _RANDOM[8'hA5][15];
        ptw_resp_bits_reg_3_s1_valididx_7 = _RANDOM[8'hA5][16];
        ptw_resp_bits_reg_3_s2_entry_tag =
          {_RANDOM[8'hA5][31:27], _RANDOM[8'hA6], _RANDOM[8'hA7][0]};
        ptw_resp_bits_reg_3_s2_entry_vmid = _RANDOM[8'hA7][30:17];
        ptw_resp_bits_reg_3_s2_entry_level = _RANDOM[8'hA9][16:15];
        ptw_already_back_last_REG_3 = _RANDOM[8'hA9][31];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_out_v_0 = 1'h0;
        req_out_v_1 = 1'h0;
      ...
      : (readResult_p_hit_last_REG_1
          ...
          : {8'h0,
             ...
             (readResult_p_hit_last_REG_1 ? readResult_p_s1_isLeaf_1 : resp_s1_isLeaf)
               ...
               : {_GEN_14[{readResult_isFakePte_1_0 & Sv39vsEnable, 1'h0}
      ...
      : (readResult_p_hit_last_REG_2
          ...
          : {8'h0,
             ...
             (readResult_p_hit_last_REG_2 ? readResult_p_s1_isLeaf_2 : resp_s1_isLeaf)
               ...
               : {_GEN_18[{readResult_isFakePte_2_0 & Sv39vsEnable, 1'h0}
