...
module SRAMTemplate_72(
  ...
  wire        _GEN = wckEn & ~io_broadcast_mbist_ram_hold;
  reg         respReg;
  reg         rdata_last_REG;
  reg  [18:0] rdata_hold_data_0;
  reg  [18:0] rdata_hold_data_1;
  reg  [18:0] rdata_hold_data_2;
  reg  [18:0] rdata_hold_data_3;
  reg  [75:0] rdataReg;
  ...
  always @(posedge clock) begin
    if (rdata_last_REG) begin
      rdata_hold_data_0 <= _array_RW0_rdata[18:0];
      rdata_hold_data_1 <= _array_RW0_rdata[37:19];
      rdata_hold_data_2 <= _array_RW0_rdata[56:38];
      rdata_hold_data_3 <= _array_RW0_rdata[75:57];
    end
    if (respReg)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        respReg = _RANDOM[4'h0][8];
        rdata_last_REG = _RANDOM[4'h8][28];
        rdata_hold_data_0 = {_RANDOM[4'h8][31:29], _RANDOM[4'h9][15:0]};
        rdata_hold_data_1 = {_RANDOM[4'h9][31:16], _RANDOM[4'hA][2:0]};
        rdata_hold_data_2 = _RANDOM[4'hA][21:3];
        rdata_hold_data_3 = {_RANDOM[4'hA][31:22], _RANDOM[4'hB][8:0]};
        rdataReg = {_RANDOM[4'hB][31:9], _RANDOM[4'hC], _RANDOM[4'hD][20:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 7'h0;
  ...
  assign io_r_resp_data_0 = rdata_last_REG ? _array_RW0_rdata[18:0] : rdata_hold_data_0;
  assign io_r_resp_data_1 = rdata_last_REG ? _array_RW0_rdata[37:19] : rdata_hold_data_1;
  assign io_r_resp_data_2 = rdata_last_REG ? _array_RW0_rdata[56:38] : rdata_hold_data_2;
  assign io_r_resp_data_3 = rdata_last_REG ? _array_RW0_rdata[75:57] : rdata_hold_data_3;
