...
module SourceB(
  ...
  wire [30:0] _issueArb_io_out_bits_tag;
  wire [8:0]  _issueArb_io_out_bits_set;
  wire [1:0]  _issueArb_io_out_bits_alias;
  reg         probes_0_valid;
  reg         probes_0_rdy;
  reg  [6:0]  probes_0_waitG;
  reg  [30:0] probes_0_task_tag;
  reg  [8:0]  probes_0_task_set;
  ...
  reg  [30:0] probes_1_task_tag;
  reg  [8:0]  probes_1_task_set;
  ...
  reg  [30:0] probes_2_task_tag;
  reg  [8:0]  probes_2_task_set;
  ...
  reg  [30:0] probes_3_task_tag;
  reg  [8:0]  probes_3_task_set;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      probes_0_rdy <= 1'h0;
      probes_0_waitG <= 7'h0;
      probes_0_task_tag <= 31'h0;
      probes_0_task_set <= 9'h0;
      ...
      probes_1_rdy <= 1'h0;
      probes_1_waitG <= 7'h0;
      probes_1_task_tag <= 31'h0;
      probes_1_task_set <= 9'h0;
      ...
      probes_2_rdy <= 1'h0;
      probes_2_waitG <= 7'h0;
      probes_2_task_tag <= 31'h0;
      probes_2_task_set <= 9'h0;
      ...
      probes_3_rdy <= 1'h0;
      probes_3_waitG <= 7'h0;
      probes_3_task_tag <= 31'h0;
      probes_3_task_set <= 9'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        probes_0_task_tag = {_RANDOM[3'h0][31:9], _RANDOM[3'h1][7:0]};
        probes_0_task_set = _RANDOM[3'h1][16:8];
        ...
        probes_1_task_tag = {_RANDOM[3'h2][31:7], _RANDOM[3'h3][5:0]};
        probes_1_task_set = _RANDOM[3'h3][14:6];
        ...
        probes_2_task_tag = {_RANDOM[3'h4][31:5], _RANDOM[3'h5][3:0]};
        probes_2_task_set = _RANDOM[3'h5][12:4];
        ...
        probes_3_task_tag = {_RANDOM[3'h6][31:3], _RANDOM[3'h7][1:0]};
        probes_3_task_set = _RANDOM[3'h7][10:2];
