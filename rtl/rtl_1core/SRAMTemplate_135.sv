...
module SRAMTemplate_135(
  ...
  wire [1:0]   mbistBd_selectedOH = boreChildrenBd_bore_selectedOH;
  ...
  reg  [383:0] rdataReg;
  reg  [1:0]   selectOHReg;
  wire [191:0] mbistBd_rdata =
    (selectOHReg[0] ? rdataReg[191:0] : 192'h0)
    | (selectOHReg[1] ? rdataReg[383:192] : 192'h0);
  ...
  sram_array_1p1024x384m24s1h0l1b_l2_pftch_tp_meta array (
    ...
    .RW0_wmask
      (mbistBd_ack
         ? {{8{mbistBd_selectedOH[1]}}, {8{mbistBd_selectedOH[0]}}} & {2{mbistBd_wmask}}
