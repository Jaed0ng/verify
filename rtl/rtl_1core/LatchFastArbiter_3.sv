  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (latch_result) begin
        ...
        out_bits_reg_set <=
          (chosenOH[0] ? io_in_0_bits_set : 12'h0)
          | (chosenOH[1] ? io_in_1_bits_set : 12'h0)
          | (chosenOH[2] ? io_in_2_bits_set : 12'h0)
          | (chosenOH[3] ? io_in_3_bits_set : 12'h0)
          | (chosenOH[4] ? io_in_4_bits_set : 12'h0)
          | (chosenOH[5] ? io_in_5_bits_set : 12'h0)
          | (chosenOH[6] ? io_in_6_bits_set : 12'h0)
          | (chosenOH[7] ? io_in_7_bits_set : 12'h0)
          | (chosenOH[8] ? io_in_8_bits_set : 12'h0)
          | (chosenOH[9] ? io_in_9_bits_set : 12'h0)
        ...
        out_bits_reg_tag <=
          (chosenOH[0] ? io_in_0_bits_tag : 28'h0)
          | (chosenOH[1] ? io_in_1_bits_tag : 28'h0)
          | (chosenOH[2] ? io_in_2_bits_tag : 28'h0)
          | (chosenOH[3] ? io_in_3_bits_tag : 28'h0)
          | (chosenOH[4] ? io_in_4_bits_tag : 28'h0)
          | (chosenOH[5] ? io_in_5_bits_tag : 28'h0)
          | (chosenOH[6] ? io_in_6_bits_tag : 28'h0)
          | (chosenOH[7] ? io_in_7_bits_tag : 28'h0)
          | (chosenOH[8] ? io_in_8_bits_tag : 28'h0)
          | (chosenOH[9] ? io_in_9_bits_tag : 28'h0)
        ...
        out_bits_reg_way <=
          (chosenOH[0] ? io_in_0_bits_way : 4'h0)
          | (chosenOH[1] ? io_in_1_bits_way : 4'h0)
          | (chosenOH[2] ? io_in_2_bits_way : 4'h0)
          | (chosenOH[3] ? io_in_3_bits_way : 4'h0)
          | (chosenOH[4] ? io_in_4_bits_way : 4'h0)
          | (chosenOH[5] ? io_in_5_bits_way : 4'h0)
          | (chosenOH[6] ? io_in_6_bits_way : 4'h0)
          | (chosenOH[7] ? io_in_7_bits_way : 4'h0)
          | (chosenOH[8] ? io_in_8_bits_way : 4'h0)
          | (chosenOH[9] ? io_in_9_bits_way : 4'h0)
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        out_bits_reg_set = _RANDOM[3'h0][23:12];
        out_bits_reg_tag = {_RANDOM[3'h0][31:24], _RANDOM[3'h1][19:0]};
        out_bits_reg_channel = _RANDOM[3'h1][22:20];
        out_bits_reg_opcode = _RANDOM[3'h1][25:23];
        out_bits_reg_param = _RANDOM[3'h1][28:26];
        out_bits_reg_size = _RANDOM[3'h1][31:29];
        out_bits_reg_way = _RANDOM[3'h2][3:0];
        out_bits_reg_off = _RANDOM[3'h2][9:4];
        out_bits_reg_useBypass = _RANDOM[3'h2][10];
        out_bits_reg_bufIdx = _RANDOM[3'h2][14:11];
        out_bits_reg_denied = _RANDOM[3'h2][15];
        out_bits_reg_sinkId = _RANDOM[3'h2][19:16];
        out_bits_reg_bypassPut = _RANDOM[3'h2][20];
        out_bits_reg_dirty = _RANDOM[3'h2][21];
        out_bits_reg_isHit = _RANDOM[3'h2][22];
        chosen_reg = {_RANDOM[3'h2][31:23], _RANDOM[3'h3][4:0]};
        pendingMask = _RANDOM[3'h3][18:5];
        rrGrantMask = {_RANDOM[3'h3][31:19], _RANDOM[3'h4][0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        out_valid_reg = 1'h0;
        out_bits_reg_sourceId = 11'h0;
