...
module SRAMTemplate_152(
  ...
  reg  [8:0]  _resetSet;
  wire        rckEn =
    mbistBd_ack ? mbistBd_re : _io_w_req_ready_T & _io_r_req_ready_T_1 & io_r_req_valid;
  wire        _GEN =
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        _resetSet = _RANDOM[2'h0][9:1];
        respReg = _RANDOM[2'h0][10];
        rdataReg = {_RANDOM[2'h2][31], _RANDOM[2'h3][14:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 9'h0;
  ...
  sram_array_1p512x16m16s1h0l1b_l2_repl array (
