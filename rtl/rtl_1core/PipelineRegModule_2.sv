  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        io_out_bits_r_paddr = {_RANDOM[6'h2A][31:1], _RANDOM[6'h2B][16:0]};
        io_out_bits_r_data =
          {_RANDOM[6'h2E][31:1],
           _RANDOM[6'h2F],
           _RANDOM[6'h30],
           _RANDOM[6'h31],
           _RANDOM[6'h32][1:0]};
        io_out_bits_r_isvec = _RANDOM[6'h37][3];
        io_out_bits_r_is128bit = _RANDOM[6'h37][5];
        io_out_bits_r_vecActive = _RANDOM[6'h3B][24];
        io_out_bits_r_schedIndex = _RANDOM[6'h3C][21:15];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        pipeline_reg_valid = 1'h0;
    end // initial
