...
module Uncache(
  ...
  wire [7:0]       _canMerge1_T_34 = io_lsq_req_bits_mask | entries_1_mask;
  ...
  wire             canMerge1_1 =
    ...
    & ~entries_1_atomic
    & (4'({1'h0,
           3'({1'h0, 2'({1'h0, _canMerge1_T_34[0]} + {1'h0, _canMerge1_T_34[1]})}
              + {1'h0, 2'({1'h0, _canMerge1_T_34[2]} + {1'h0, _canMerge1_T_34[3]})})}
          + {1'h0,
             3'({1'h0, 2'({1'h0, _canMerge1_T_34[4]} + {1'h0, _canMerge1_T_34[5]})}
                + {1'h0,
                   2'({1'h0, _canMerge1_T_34[6]} + {1'h0, _canMerge1_T_34[7]})})}) == 4'h1
       | _canMerge1_T_34 == 8'h3 | _canMerge1_T_34 == 8'hC | _canMerge1_T_34 == 8'h30
       | _canMerge1_T_34 == 8'hC0 | _canMerge1_T_34 == 8'hF | _canMerge1_T_34 == 8'hF0
       | (&_canMerge1_T_34))
  ...
  wire [7:0]       _canMerge1_T_55 = io_lsq_req_bits_mask | entries_2_mask;
  ...
  wire [7:0]       _canMerge1_T_76 = io_lsq_req_bits_mask | entries_3_mask;
  ...
  wire             canMerge1_3 =
    ...
    & ~entries_3_atomic
    & (4'({1'h0,
           3'({1'h0, 2'({1'h0, _canMerge1_T_76[0]} + {1'h0, _canMerge1_T_76[1]})}
              + {1'h0, 2'({1'h0, _canMerge1_T_76[2]} + {1'h0, _canMerge1_T_76[3]})})}
          + {1'h0,
             3'({1'h0, 2'({1'h0, _canMerge1_T_76[4]} + {1'h0, _canMerge1_T_76[5]})}
                + {1'h0,
                   2'({1'h0, _canMerge1_T_76[6]} + {1'h0, _canMerge1_T_76[7]})})}) == 4'h1
       | _canMerge1_T_76 == 8'h3 | _canMerge1_T_76 == 8'hC | _canMerge1_T_76 == 8'h30
       | _canMerge1_T_76 == 8'hC0 | _canMerge1_T_76 == 8'hF | _canMerge1_T_76 == 8'hF0
       | (&_canMerge1_T_76))
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uState = _RANDOM[6'h16][29:28];
        do_uarch_drain = _RANDOM[6'h16][30];
        io_lsq_idResp_valid_REG = _RANDOM[6'h16][31];
        io_lsq_idResp_bits_mid_r = _RANDOM[6'h17][6:0];
        io_lsq_idResp_bits_sid_r = _RANDOM[6'h17][8:7];
        io_lsq_idResp_bits_is2lq_r = _RANDOM[6'h17][9];
        io_lsq_idResp_bits_nc_r = _RANDOM[6'h17][10];
        f1_fwdMaskCandidates_r = _RANDOM[6'h17][21:14];
        f1_fwdMaskCandidates_r_1 = _RANDOM[6'h17][29:22];
        f1_fwdMaskCandidates_r_2 = {_RANDOM[6'h17][31:30], _RANDOM[6'h18][5:0]};
        f1_fwdMaskCandidates_r_3 = _RANDOM[6'h18][13:6];
        f1_fwdDataCandidates_r =
          {_RANDOM[6'h18][31:14], _RANDOM[6'h19], _RANDOM[6'h1A][13:0]};
        f1_fwdDataCandidates_r_1 =
          {_RANDOM[6'h1A][31:14], _RANDOM[6'h1B], _RANDOM[6'h1C][13:0]};
        ...
        f1_fwdValid = _RANDOM[6'h20][14];
        f1_flyTagMatches_0 = _RANDOM[6'h20][15];
        f1_flyTagMatches_1 = _RANDOM[6'h20][16];
        f1_flyTagMatches_2 = _RANDOM[6'h20][17];
        f1_flyTagMatches_3 = _RANDOM[6'h20][18];
        f1_idleTagMatches_0 = _RANDOM[6'h20][19];
        f1_idleTagMatches_1 = _RANDOM[6'h20][20];
        f1_idleTagMatches_2 = _RANDOM[6'h20][21];
        f1_idleTagMatches_3 = _RANDOM[6'h20][22];
        f1_fwdPAddr = {_RANDOM[6'h20][31:23], _RANDOM[6'h21], _RANDOM[6'h22][6:0]};
        f1_ptagMatches_r = {_RANDOM[6'h22][31:7], _RANDOM[6'h23][22:0]};
        f1_ptagMatches_r_1 = {_RANDOM[6'h23][31:23], _RANDOM[6'h24], _RANDOM[6'h25][6:0]};
        f1_ptagMatches_r_2 = {_RANDOM[6'h25][31:7], _RANDOM[6'h26][22:0]};
        f1_ptagMatches_r_3 = {_RANDOM[6'h26][31:23], _RANDOM[6'h27], _RANDOM[6'h28][6:0]};
        f1_tagMismatchVec_0_r = _RANDOM[6'h28][7];
        f1_tagMismatchVec_0_r_1 = _RANDOM[6'h28][8];
        f1_tagMismatchVec_0_r_2 = _RANDOM[6'h28][9];
        f1_tagMismatchVec_0_r_3 = _RANDOM[6'h28][10];
        f1_tagMismatchVec_0_r_4 = _RANDOM[6'h28][11];
        f1_tagMismatchVec_0_r_5 = _RANDOM[6'h28][12];
        f1_tagMismatchVec_0_r_6 = _RANDOM[6'h28][13];
        f1_tagMismatchVec_0_r_7 = _RANDOM[6'h28][14];
        f1_fwdValid_1 = _RANDOM[6'h2B][21];
        f1_flyTagMatches_1_0 = _RANDOM[6'h2B][22];
        f1_flyTagMatches_1_1 = _RANDOM[6'h2B][23];
        f1_flyTagMatches_1_2 = _RANDOM[6'h2B][24];
        f1_flyTagMatches_1_3 = _RANDOM[6'h2B][25];
        f1_idleTagMatches_1_0 = _RANDOM[6'h2B][26];
        f1_idleTagMatches_1_1 = _RANDOM[6'h2B][27];
        f1_idleTagMatches_1_2 = _RANDOM[6'h2B][28];
        f1_idleTagMatches_1_3 = _RANDOM[6'h2B][29];
        f1_fwdPAddr_1 = {_RANDOM[6'h2B][31:30], _RANDOM[6'h2C], _RANDOM[6'h2D][13:0]};
        f1_ptagMatches_r_4 = {_RANDOM[6'h2D][31:14], _RANDOM[6'h2E][29:0]};
        f1_ptagMatches_r_5 =
          {_RANDOM[6'h2E][31:30], _RANDOM[6'h2F], _RANDOM[6'h30][13:0]};
        f1_ptagMatches_r_6 = {_RANDOM[6'h30][31:14], _RANDOM[6'h31][29:0]};
        f1_ptagMatches_r_7 =
          {_RANDOM[6'h31][31:30], _RANDOM[6'h32], _RANDOM[6'h33][13:0]};
        f1_tagMismatchVec_1_r = _RANDOM[6'h33][14];
        f1_tagMismatchVec_1_r_1 = _RANDOM[6'h33][15];
        f1_tagMismatchVec_1_r_2 = _RANDOM[6'h33][16];
        f1_tagMismatchVec_1_r_3 = _RANDOM[6'h33][17];
        f1_tagMismatchVec_1_r_4 = _RANDOM[6'h33][18];
        f1_tagMismatchVec_1_r_5 = _RANDOM[6'h33][19];
        f1_tagMismatchVec_1_r_6 = _RANDOM[6'h33][20];
        f1_tagMismatchVec_1_r_7 = _RANDOM[6'h33][21];
        f1_fwdValid_2 = _RANDOM[6'h36][28];
        f1_flyTagMatches_2_0 = _RANDOM[6'h36][29];
        f1_flyTagMatches_2_1 = _RANDOM[6'h36][30];
        f1_flyTagMatches_2_2 = _RANDOM[6'h36][31];
        f1_flyTagMatches_2_3 = _RANDOM[6'h37][0];
        f1_idleTagMatches_2_0 = _RANDOM[6'h37][1];
        f1_idleTagMatches_2_1 = _RANDOM[6'h37][2];
        f1_idleTagMatches_2_2 = _RANDOM[6'h37][3];
        f1_idleTagMatches_2_3 = _RANDOM[6'h37][4];
        f1_fwdPAddr_2 = {_RANDOM[6'h37][31:5], _RANDOM[6'h38][20:0]};
        f1_ptagMatches_r_8 = {_RANDOM[6'h38][31:21], _RANDOM[6'h39], _RANDOM[6'h3A][4:0]};
        f1_ptagMatches_r_9 = {_RANDOM[6'h3A][31:5], _RANDOM[6'h3B][20:0]};
        f1_ptagMatches_r_10 =
          {_RANDOM[6'h3B][31:21], _RANDOM[6'h3C], _RANDOM[6'h3D][4:0]};
        f1_ptagMatches_r_11 = {_RANDOM[6'h3D][31:5], _RANDOM[6'h3E][20:0]};
        f1_tagMismatchVec_2_r = _RANDOM[6'h3E][21];
        f1_tagMismatchVec_2_r_1 = _RANDOM[6'h3E][22];
        f1_tagMismatchVec_2_r_2 = _RANDOM[6'h3E][23];
        f1_tagMismatchVec_2_r_3 = _RANDOM[6'h3E][24];
        f1_tagMismatchVec_2_r_4 = _RANDOM[6'h3E][25];
        f1_tagMismatchVec_2_r_5 = _RANDOM[6'h3E][26];
        f1_tagMismatchVec_2_r_6 = _RANDOM[6'h3E][27];
        f1_tagMismatchVec_2_r_7 = _RANDOM[6'h3E][28];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        states_0_valid = 1'h0;
        states_0_inflight = 1'h0;
