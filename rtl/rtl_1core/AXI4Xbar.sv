...
module AXI4Xbar(
  ...
  wire        requestARIO_0_4 =
    ...
    | {auto_in_ar_bits_addr[30], _GEN[11:7], _GEN[5:0]} == 12'h0
    | {auto_in_ar_bits_addr[30], _GEN_0[10:6], _GEN_0[4:0]} == 11'h0
    | {auto_in_ar_bits_addr[30], _GEN_1[9:5], _GEN_1[3:0]} == 10'h0
    | {auto_in_ar_bits_addr[30], _GEN_2[8:4], _GEN_2[2:0]} == 9'h0
    | {auto_in_ar_bits_addr[30], _GEN_3[7:3], _GEN_3[1:0]} == 8'h0
    | {auto_in_ar_bits_addr[30], _GEN_4[6:2], _GEN_4[0]} == 7'h0
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:16] ^ 14'h3901} == 15'h0
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:17] ^ 13'h1C81} == 14'h0
    ...
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:18] ^ 12'hE81} == 13'h0
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:19] ^ 11'h741} == 12'h0
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:20] ^ 10'h3A1} == 11'h0
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:21] ^ 9'h1D1} == 10'h0
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:22] ^ 8'hE9} == 9'h0
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:23] ^ 7'h75} == 8'h0
    | {auto_in_ar_bits_addr[30], auto_in_ar_bits_addr[29:24] ^ 6'h3B} == 7'h0
  ...
  wire [11:0] _GEN_5 = auto_in_aw_bits_addr[29:18] ^ 12'hE01;
  wire [10:0] _GEN_6 = auto_in_aw_bits_addr[29:19] ^ 11'h701;
  wire [9:0]  _GEN_7 = auto_in_aw_bits_addr[29:20] ^ 10'h381;
  wire [8:0]  _GEN_8 = auto_in_aw_bits_addr[29:21] ^ 9'h1C1;
  wire [7:0]  _GEN_9 = auto_in_aw_bits_addr[29:22] ^ 8'hE1;
  wire [6:0]  _GEN_10 = auto_in_aw_bits_addr[29:23] ^ 7'h71;
  wire        requestAWIO_0_4 =
    ...
    | {auto_in_aw_bits_addr[30], _GEN_5[11:7], _GEN_5[5:0]} == 12'h0
    | {auto_in_aw_bits_addr[30], _GEN_6[10:6], _GEN_6[4:0]} == 11'h0
    | {auto_in_aw_bits_addr[30], _GEN_7[9:5], _GEN_7[3:0]} == 10'h0
    | {auto_in_aw_bits_addr[30], _GEN_8[8:4], _GEN_8[2:0]} == 9'h0
    | {auto_in_aw_bits_addr[30], _GEN_9[7:3], _GEN_9[1:0]} == 8'h0
    | {auto_in_aw_bits_addr[30], _GEN_10[6:2], _GEN_10[0]} == 7'h0
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:16] ^ 14'h3901} == 15'h0
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:17] ^ 13'h1C81} == 14'h0
    ...
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:18] ^ 12'hE81} == 13'h0
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:19] ^ 11'h741} == 12'h0
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:20] ^ 10'h3A1} == 11'h0
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:21] ^ 9'h1D1} == 10'h0
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:22] ^ 8'hE9} == 9'h0
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:23] ^ 7'h75} == 8'h0
    | {auto_in_aw_bits_addr[30], auto_in_aw_bits_addr[29:24] ^ 6'h3B} == 7'h0
  ...
  wire        in_0_ar_valid = auto_in_ar_valid & _GEN_11[auto_in_ar_bits_id];
  wire        nodeIn_ar_ready =
    _portsAROI_in_0_ar_ready_T_8 & _GEN_11[auto_in_ar_bits_id];
  reg         latched;
  wire        _nodeIn_aw_ready_T = latched | _awIn_0_io_enq_ready;
  wire [3:0]  _GEN_12 =
    {{1'h1}, {1'h1}, {1'h1}, {awFIFOMap_0_count == 2'h0 | awFIFOMap_0_last == awTag}};
  wire        in_0_aw_valid =
    auto_in_aw_valid & _nodeIn_aw_ready_T & _GEN_12[auto_in_aw_bits_id];
  wire        nodeIn_aw_ready =
    _portsAWOI_in_0_aw_ready_T_8 & _nodeIn_aw_ready_T & _GEN_12[auto_in_aw_bits_id];
  ...
  wire [6:0]  _GEN_14 = _GEN_13[6:0] | {_readys_filter_T_1[4], _GEN_13[7:2]};
  wire [4:0]  readys_readys =
    ~({readys_mask[4],
       _readys_filter_T_1[4] | readys_mask[3],
       _GEN_13[7] | readys_mask[2],
       _GEN_14[6:5] | readys_mask[1:0]}
      & (_GEN_14[4:0] | {_readys_filter_T_1[4], _GEN_13[7], _GEN_14[6:4]}));
  ...
  wire [6:0]  _GEN_16 = _GEN_15[6:0] | {_readys_filter_T_3[4], _GEN_15[7:2]};
  wire [4:0]  readys_readys_1 =
    ~({readys_mask_1[4],
       _readys_filter_T_3[4] | readys_mask_1[3],
       _GEN_15[7] | readys_mask_1[2],
       _GEN_16[6:5] | readys_mask_1[1:0]}
      & (_GEN_16[4:0] | {_readys_filter_T_3[4], _GEN_15[7], _GEN_16[6:4]}));
