...
module RequestBuffer_4(
  ...
  wire [11:0]  _output_pipe_q_io_deq_bits_set;
  wire [27:0]  _output_pipe_q_io_deq_bits_tag;
  ...
  wire [4:0]   _output_pipe_q_io_deq_bits_reqSource;
  ...
  wire [11:0]  _issue_arb_io_out_bits_set;
  wire [27:0]  _issue_arb_io_out_bits_tag;
  ...
  wire [4:0]   _issue_arb_io_out_bits_reqSource;
  wire [1:0]   _issue_arb_io_chosen;
  wire [118:0] _buffer_ext_R0_data;
  wire [118:0] _buffer_ext_R1_data;
  wire [118:0] _buffer_ext_R2_data;
  wire [118:0] _buffer_ext_R3_data;
  reg          valids_0;
  reg          valids_1;
  reg          valids_2;
  reg          valids_3;
  ...
  wire         conflict_mask_0 =
    io_mshr_status_0_valid & io_mshr_status_0_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_0_bits_will_free;
  wire         conflict_mask_1 =
    io_mshr_status_1_valid & io_mshr_status_1_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_1_bits_will_free;
  wire         conflict_mask_2 =
    io_mshr_status_2_valid & io_mshr_status_2_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_2_bits_will_free;
  wire         conflict_mask_3 =
    io_mshr_status_3_valid & io_mshr_status_3_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_3_bits_will_free;
  wire         conflict_mask_4 =
    io_mshr_status_4_valid & io_mshr_status_4_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_4_bits_will_free;
  wire         conflict_mask_5 =
    io_mshr_status_5_valid & io_mshr_status_5_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_5_bits_will_free;
  wire         conflict_mask_6 =
    io_mshr_status_6_valid & io_mshr_status_6_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_6_bits_will_free;
  wire         conflict_mask_7 =
    io_mshr_status_7_valid & io_mshr_status_7_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_7_bits_will_free;
  wire         conflict_mask_8 =
    io_mshr_status_8_valid & io_mshr_status_8_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_8_bits_will_free;
  wire         conflict_mask_9 =
    io_mshr_status_9_valid & io_mshr_status_9_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_9_bits_will_free;
  wire         conflict_mask_10 =
    io_mshr_status_10_valid & io_mshr_status_10_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_10_bits_will_free;
  wire         conflict_mask_11 =
    io_mshr_status_11_valid & io_mshr_status_11_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_11_bits_will_free;
  wire         conflict_mask_12 =
    io_mshr_status_12_valid & io_mshr_status_12_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_12_bits_will_free;
  wire         conflict_mask_13 =
    io_mshr_status_13_valid & io_mshr_status_13_bits_set[8:0] == io_in_bits_set[8:0]
    & ~io_mshr_status_13_bits_will_free;
  wire [39:0]  _dup_mask_T_10 = {io_in_bits_tag, io_in_bits_set};
  wire         req_deps_0 = valids_0 & _buffer_ext_R3_data[31:23] == io_in_bits_set[8:0];
  wire         req_deps_1 = valids_1 & _buffer_ext_R2_data[31:23] == io_in_bits_set[8:0];
  wire         req_deps_2 = valids_2 & _buffer_ext_R1_data[31:23] == io_in_bits_set[8:0];
  wire         req_deps_3 = valids_3 & _buffer_ext_R0_data[31:23] == io_in_bits_set[8:0];
  ...
  wire         alloc =
    ...
    & ~(io_in_valid & io_in_bits_isPrefetch
        & (|{valids_0 & _buffer_ext_R3_data[62:23] == _dup_mask_T_10,
             valids_1 & _buffer_ext_R2_data[62:23] == _dup_mask_T_10,
             valids_2 & _buffer_ext_R1_data[62:23] == _dup_mask_T_10,
             valids_3 & _buffer_ext_R0_data[62:23] == _dup_mask_T_10}));
  ...
  FastArbiter_26 issue_arb (
    ...
    .io_in_0_bits_set              (_buffer_ext_R3_data[34:23]),
    .io_in_0_bits_tag              (_buffer_ext_R3_data[62:35]),
    .io_in_0_bits_off              (_buffer_ext_R3_data[68:63]),
    .io_in_0_bits_mask             (_buffer_ext_R3_data[100:69]),
    .io_in_0_bits_bufIdx           (_buffer_ext_R3_data[104:101]),
    .io_in_0_bits_needHint         (_buffer_ext_R3_data[105]),
    .io_in_0_bits_isPrefetch       (_buffer_ext_R3_data[106]),
    .io_in_0_bits_isBop            (_buffer_ext_R3_data[107]),
    .io_in_0_bits_preferCache      (_buffer_ext_R3_data[108]),
    .io_in_0_bits_dirty            (_buffer_ext_R3_data[109]),
    .io_in_0_bits_isHit            (_buffer_ext_R3_data[110]),
    .io_in_0_bits_fromProbeHelper  (_buffer_ext_R3_data[111]),
    .io_in_0_bits_fromCmoHelper    (_buffer_ext_R3_data[112]),
    .io_in_0_bits_needProbeAckData (_buffer_ext_R3_data[113]),
    .io_in_0_bits_reqSource        (_buffer_ext_R3_data[118:114]),
    ...
    .io_in_1_bits_set              (_buffer_ext_R2_data[34:23]),
    .io_in_1_bits_tag              (_buffer_ext_R2_data[62:35]),
    .io_in_1_bits_off              (_buffer_ext_R2_data[68:63]),
    .io_in_1_bits_mask             (_buffer_ext_R2_data[100:69]),
    .io_in_1_bits_bufIdx           (_buffer_ext_R2_data[104:101]),
    .io_in_1_bits_needHint         (_buffer_ext_R2_data[105]),
    .io_in_1_bits_isPrefetch       (_buffer_ext_R2_data[106]),
    .io_in_1_bits_isBop            (_buffer_ext_R2_data[107]),
    .io_in_1_bits_preferCache      (_buffer_ext_R2_data[108]),
    .io_in_1_bits_dirty            (_buffer_ext_R2_data[109]),
    .io_in_1_bits_isHit            (_buffer_ext_R2_data[110]),
    .io_in_1_bits_fromProbeHelper  (_buffer_ext_R2_data[111]),
    .io_in_1_bits_fromCmoHelper    (_buffer_ext_R2_data[112]),
    .io_in_1_bits_needProbeAckData (_buffer_ext_R2_data[113]),
    .io_in_1_bits_reqSource        (_buffer_ext_R2_data[118:114]),
    ...
    .io_in_2_bits_set              (_buffer_ext_R1_data[34:23]),
    .io_in_2_bits_tag              (_buffer_ext_R1_data[62:35]),
    .io_in_2_bits_off              (_buffer_ext_R1_data[68:63]),
    .io_in_2_bits_mask             (_buffer_ext_R1_data[100:69]),
    .io_in_2_bits_bufIdx           (_buffer_ext_R1_data[104:101]),
    .io_in_2_bits_needHint         (_buffer_ext_R1_data[105]),
    .io_in_2_bits_isPrefetch       (_buffer_ext_R1_data[106]),
    .io_in_2_bits_isBop            (_buffer_ext_R1_data[107]),
    .io_in_2_bits_preferCache      (_buffer_ext_R1_data[108]),
    .io_in_2_bits_dirty            (_buffer_ext_R1_data[109]),
    .io_in_2_bits_isHit            (_buffer_ext_R1_data[110]),
    .io_in_2_bits_fromProbeHelper  (_buffer_ext_R1_data[111]),
    .io_in_2_bits_fromCmoHelper    (_buffer_ext_R1_data[112]),
    .io_in_2_bits_needProbeAckData (_buffer_ext_R1_data[113]),
    .io_in_2_bits_reqSource        (_buffer_ext_R1_data[118:114]),
    ...
    .io_in_3_bits_set              (_buffer_ext_R0_data[34:23]),
    .io_in_3_bits_tag              (_buffer_ext_R0_data[62:35]),
    .io_in_3_bits_off              (_buffer_ext_R0_data[68:63]),
    .io_in_3_bits_mask             (_buffer_ext_R0_data[100:69]),
    .io_in_3_bits_bufIdx           (_buffer_ext_R0_data[104:101]),
    .io_in_3_bits_needHint         (_buffer_ext_R0_data[105]),
    .io_in_3_bits_isPrefetch       (_buffer_ext_R0_data[106]),
    .io_in_3_bits_isBop            (_buffer_ext_R0_data[107]),
    .io_in_3_bits_preferCache      (_buffer_ext_R0_data[108]),
    .io_in_3_bits_dirty            (_buffer_ext_R0_data[109]),
    .io_in_3_bits_isHit            (_buffer_ext_R0_data[110]),
    .io_in_3_bits_fromProbeHelper  (_buffer_ext_R0_data[111]),
    .io_in_3_bits_fromCmoHelper    (_buffer_ext_R0_data[112]),
    .io_in_3_bits_needProbeAckData (_buffer_ext_R0_data[113]),
    .io_in_3_bits_reqSource        (_buffer_ext_R0_data[118:114]),
