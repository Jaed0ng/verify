...
module VLSplitBufferImp(
  ...
  always @(posedge clock) begin
    if (doEnqueue) begin
      ...
      uopq_uop_exceptionVec_5 <= io_in_bits_uop_exceptionVec_5;
      uopq_uop_exceptionVec_13 <= io_in_bits_uop_exceptionVec_13;
      uopq_uop_exceptionVec_21 <= io_in_bits_uop_exceptionVec_21;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        uopq_uop_exceptionVec_5 = _RANDOM[6'h12][5];
        uopq_uop_exceptionVec_13 = _RANDOM[6'h12][13];
        uopq_uop_exceptionVec_21 = _RANDOM[6'h12][21];
