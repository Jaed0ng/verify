...
module L2Cache(
  ...
  output [191:0] toNextPipeline_0_indata,
  output         toNextPipeline_0_readen,
  output [10:0]  toNextPipeline_0_addr_rd,
  input  [191:0] toNextPipeline_0_outdata,
  ...
  output [3:0]   toNextPipeline_2_array,
  ...
  wire         selected_1 =
    ...
    | arrayReg == 6'h8 | arrayReg == 6'h9 | arrayReg == 6'hA;
  ...
  wire [136:0] _pipelineDataOut_2_T = selected_2 ? toNextPipeline_2_outdata : 137'h0;
  wire         selected_3 =
    arrayReg == 6'hF | arrayReg == 6'h10 | arrayReg == 6'h11 | arrayReg == 6'h12
    | arrayReg == 6'h13 | arrayReg == 6'h14 | arrayReg == 6'h15;
  wire         doSpread_3 = selected_3 | allReg;
  wire         selected_4 =
    arrayReg == 6'h16 | arrayReg == 6'h17 | arrayReg == 6'h18 | arrayReg == 6'h19;
  wire         doSpread_4 = selected_4 | allReg;
  wire [136:0] _pipelineDataOut_4_T = selected_4 ? toNextPipeline_4_outdata : 137'h0;
  wire         selected_5 =
    arrayReg == 6'h1A | arrayReg == 6'h1B | arrayReg == 6'h1C | arrayReg == 6'h1D
    | arrayReg == 6'h1E | arrayReg == 6'h1F | arrayReg == 6'h20;
  ...
  wire [136:0] _pipelineDataOut_6_T = selected_6 ? toNextPipeline_6_outdata : 137'h0;
  wire         selected_7 =
    arrayReg == 6'h25 | arrayReg == 6'h26 | arrayReg == 6'h27 | arrayReg == 6'h28
    | arrayReg == 6'h29 | arrayReg == 6'h2A | arrayReg == 6'h2B;
  ...
  wire [136:0] _pipelineDataOut_8_T = selected_8 ? toNextPipeline_8_outdata : 137'h0;
  ...
  always @(posedge clock) begin
    if (activated)
      pipelineDataOutReg <=
        (selected ? toNextPipeline_0_outdata : 192'h0)
        | {55'h0,
           _pipelineDataOut_2_T[136:104] | _pipelineDataOut_4_T[136:104]
             | _pipelineDataOut_6_T[136:104] | _pipelineDataOut_8_T[136:104],
           (selected_1 ? toNextPipeline_1_outdata : 104'h0) | _pipelineDataOut_2_T[103:0]
             | (selected_3 ? toNextPipeline_3_outdata : 104'h0)
             | _pipelineDataOut_4_T[103:0]
             | (selected_5 ? toNextPipeline_5_outdata : 104'h0)
             | _pipelineDataOut_6_T[103:0]
             | (selected_7 ? toNextPipeline_7_outdata : 104'h0)
             | _pipelineDataOut_8_T[103:0]};
  end // always @(posedge)
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[4'h0][31:30],
           ...
           _RANDOM[4'h5],
           _RANDOM[4'h6][29:0]};
        renReg = _RANDOM[4'h6][30];
        addrRdReg = {_RANDOM[4'h6][31], _RANDOM[4'h7][11:0]};
        pipelineDataOutReg =
          {_RANDOM[4'h7][31:12],
           _RANDOM[4'h8],
           _RANDOM[4'h9],
  ...
  assign toNextPipeline_2_array = doSpread_2 ? arrayReg[3:0] : 4'h0;
  ...
  assign toNextPipeline_2_indata = dataInReg[136:0];
  ...
  assign toNextPipeline_4_indata = dataInReg[136:0];
  ...
  assign toNextPipeline_6_indata = dataInReg[136:0];
  ...
  assign toNextPipeline_8_indata = dataInReg[136:0];
