...
module SourceC_4(
  ...
  reg  [27:0] pipeOut_pipe_b_task_tag;
  ...
  reg  [27:0] pipeOut_pipe_pipe_b_task_tag;
  ...
  reg  [27:0] pipeOut_pipe_pipe_pipe_b_task_tag;
  ...
  reg  [27:0] pipeOut_pipe_pipe_pipe_pipe_b_task_tag;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        task_latch_tag = {_RANDOM[4'h0][31:6], _RANDOM[4'h1][1:0]};
        task_latch_set = _RANDOM[4'h1][13:2];
        task_latch_param = _RANDOM[4'h1][16:14];
        task_latch_source = _RANDOM[4'h1][20:17];
        task_latch_way = _RANDOM[4'h1][24:21];
        s1_task_opcode = _RANDOM[4'h1][28:26];
        s1_task_tag = {_RANDOM[4'h1][31:29], _RANDOM[4'h2][24:0]};
        s1_task_set = {_RANDOM[4'h2][31:25], _RANDOM[4'h3][4:0]};
        s1_task_param = _RANDOM[4'h3][7:5];
        s1_task_source = _RANDOM[4'h3][11:8];
        s1_valid = _RANDOM[4'h3][18];
        pipeOut_pipe_v = _RANDOM[4'h3][19];
        pipeOut_pipe_b_task_opcode = _RANDOM[4'h3][22:20];
        pipeOut_pipe_b_task_tag = {_RANDOM[4'h3][31:23], _RANDOM[4'h4][18:0]};
        pipeOut_pipe_b_task_set = _RANDOM[4'h4][30:19];
        pipeOut_pipe_b_task_param = {_RANDOM[4'h4][31], _RANDOM[4'h5][1:0]};
        pipeOut_pipe_b_task_source = _RANDOM[4'h5][5:2];
        pipeOut_pipe_pipe_v = _RANDOM[4'h5][12];
        pipeOut_pipe_pipe_b_task_opcode = _RANDOM[4'h5][15:13];
        pipeOut_pipe_pipe_b_task_tag = {_RANDOM[4'h5][31:16], _RANDOM[4'h6][11:0]};
        pipeOut_pipe_pipe_b_task_set = _RANDOM[4'h6][23:12];
        pipeOut_pipe_pipe_b_task_param = _RANDOM[4'h6][26:24];
        pipeOut_pipe_pipe_b_task_source = _RANDOM[4'h6][30:27];
        pipeOut_pipe_pipe_pipe_v = _RANDOM[4'h7][5];
        pipeOut_pipe_pipe_pipe_b_task_opcode = _RANDOM[4'h7][8:6];
        pipeOut_pipe_pipe_pipe_b_task_tag = {_RANDOM[4'h7][31:9], _RANDOM[4'h8][4:0]};
        pipeOut_pipe_pipe_pipe_b_task_set = _RANDOM[4'h8][16:5];
        pipeOut_pipe_pipe_pipe_b_task_param = _RANDOM[4'h8][19:17];
        pipeOut_pipe_pipe_pipe_b_task_source = _RANDOM[4'h8][23:20];
        pipeOut_pipe_pipe_pipe_pipe_v = _RANDOM[4'h8][30];
        pipeOut_pipe_pipe_pipe_pipe_b_task_opcode =
          {_RANDOM[4'h8][31], _RANDOM[4'h9][1:0]};
        pipeOut_pipe_pipe_pipe_pipe_b_task_tag = _RANDOM[4'h9][29:2];
        pipeOut_pipe_pipe_pipe_pipe_b_task_set =
          {_RANDOM[4'h9][31:30], _RANDOM[4'hA][9:0]};
        pipeOut_pipe_pipe_pipe_pipe_b_task_param = _RANDOM[4'hA][12:10];
        pipeOut_pipe_pipe_pipe_pipe_b_task_source = _RANDOM[4'hA][16:13];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        bs_busy = 1'h0;
        back_pressure = 1'h0;
