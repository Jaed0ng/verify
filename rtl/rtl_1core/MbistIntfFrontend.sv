...
module MbistIntfFrontend(
  output [6:0]   toPipeline_0_array,
  output         toPipeline_0_all,
  output         toPipeline_0_req,
  input          toPipeline_0_ack,
  output         toPipeline_0_writeen,
  output [75:0]  toPipeline_0_be,
  output [9:0]   toPipeline_0_addr,
  output [159:0] toPipeline_0_indata,
  output         toPipeline_0_readen,
  output [9:0]   toPipeline_0_addr_rd,
  input  [159:0] toPipeline_0_outdata,
