...
module TLCacheCork(
  ...
  wire [5:0]   _q_1_io_deq_bits_source;
  ...
  wire [5:0]   _q_io_deq_bits_source;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        d_first_counter = _RANDOM[2'h0][0];
        nodeIn_d_bits_sink_r = _RANDOM[2'h0][3:1];
        beatsLeft = _RANDOM[2'h2][5];
        state_0 = _RANDOM[2'h2][6];
        state_1 = _RANDOM[2'h2][7];
        beatsLeft_1 = _RANDOM[2'h2][8];
        state_1_0 = _RANDOM[2'h2][9];
        state_1_1 = _RANDOM[2'h2][10];
        state_1_2 = _RANDOM[2'h2][11];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        d_first_counter = 1'h0;
        beatsLeft = 1'h0;
  ...
  assign auto_in_d_bits_source =
    (muxState_1_0 ? auto_out_d_bits_source[6:1] : 6'h0)
    | (muxState_1_1 ? _q_io_deq_bits_source : 6'h0)
    | (muxState_1_2 ? _q_1_io_deq_bits_source : 6'h0);
  ...
  assign auto_out_a_bits_source =
    (muxState_0 ? {auto_in_c_bits_source, 1'h0} : 7'h0)
    | (muxState_1
