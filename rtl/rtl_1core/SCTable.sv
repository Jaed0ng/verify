...
module SCTable(
  ...
  SRAMTemplate_66 table_0 (
    ...
    .io_w_req_bits_setIdx
      (can_write ? conflict_buffer_idx : io_update_pc[8:1]),
    .io_w_req_bits_data_0
      (can_write ? conflict_buffer_data_0 : update_wdata_0),
    .io_w_req_bits_data_1
      (can_write ? conflict_buffer_data_1 : update_wdata_0),
    .io_w_req_bits_data_2
      (can_write ? conflict_buffer_data_2 : update_wdata_1),
    .io_w_req_bits_data_3
      (can_write ? conflict_buffer_data_3 : update_wdata_1),
