  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        rdata_last_REG = _RANDOM[4'h4][26];
        rdata_hold_data_0 = {_RANDOM[4'h4][31:27], _RANDOM[4'h5], _RANDOM[4'h6][0]};
        rdata_hold_data_1 = {_RANDOM[4'h6][31:1], _RANDOM[4'h7][6:0]};
        rdataReg = {_RANDOM[4'h7][31:7], _RANDOM[4'h8], _RANDOM[4'h9][18:0]};
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        _resetState = 1'h1;
        _resetSet = 7'h0;
