...
module SourceA(
  ...
  reg          s1_full;
  reg  [27:0]  s0_task_tag;
  reg  [11:0]  s0_task_set;
  reg  [5:0]   s0_task_off;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s0_task_tag = _RANDOM[4'h0][29:2];
        s0_task_set = {_RANDOM[4'h0][31:30], _RANDOM[4'h1][9:0]};
        s0_task_off = _RANDOM[4'h1][15:10];
        s0_task_opcode = _RANDOM[4'h2][18:16];
        s0_task_param = _RANDOM[4'h2][21:19];
        s0_task_source = _RANDOM[4'h2][25:22];
        s0_task_bufIdx = _RANDOM[4'h2][29:26];
        s0_task_size = {_RANDOM[4'h2][31:30], _RANDOM[4'h3][0]};
        s0_count = _RANDOM[4'h3][8];
        s1_task_tag = {_RANDOM[4'h3][31:10], _RANDOM[4'h4][5:0]};
        s1_task_set = _RANDOM[4'h4][17:6];
        s1_task_off = _RANDOM[4'h4][23:18];
        s1_task_opcode = _RANDOM[4'h5][26:24];
        s1_task_param = _RANDOM[4'h5][29:27];
        s1_task_source = {_RANDOM[4'h5][31:30], _RANDOM[4'h6][1:0]};
        s1_task_size = _RANDOM[4'h6][8:6];
        s1_pb_latch_REG = _RANDOM[4'h6][16];
        s1_pb_latch_r_data =
          {_RANDOM[4'h6][31:17],
           _RANDOM[4'h7],
           _RANDOM[4'h8],
           ...
           _RANDOM[4'hD],
           _RANDOM[4'hE][16:0]};
        s1_pb_latch_r_mask = {_RANDOM[4'hE][31:17], _RANDOM[4'hF][16:0]};
        beatsLeft = _RANDOM[4'hF][18];
        state_0 = _RANDOM[4'hF][19];
        state_1 = _RANDOM[4'hF][20];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        busy = 1'h0;
        s1_full = 1'h0;
  ...
  assign io_a_bits_address =
    (muxState_0 ? {2'h0, s1_task_tag, s1_task_set, s1_task_off} : 48'h0)
    | (muxState_1 ? {2'h0, io_task_bits_tag, io_task_bits_set, 6'h0} : 48'h0);
