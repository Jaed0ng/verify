...
module StoreMisalignBuffer(
  ...
  input         io_req_0_bits_hasException,
  ...
  input         io_req_1_bits_hasException,
  ...
  wire [7:0]       reqSel_oldest_bits_uop_robIdx_value =
    _reqSel_oldestIndex_T
      ...
      : _reqSel_oldest_T_8
          ? io_req_0_bits_uop_robIdx_value
          : io_req_1_bits_uop_robIdx_value;
  wire             reqSel_oldest_bits_hasException =
    _reqSel_oldestIndex_T
      ? (_reqSel_oldest_T_5 ? io_req_1_bits_hasException : io_req_0_bits_hasException)
      : _reqSel_oldest_T_8 ? io_req_0_bits_hasException : io_req_1_bits_hasException;
  wire             reqSel_3_0 =
    _reqSel_oldestIndex_T
      ? reqSel_oldest_differentFlag ^ reqSel_oldest_compare
        | {io_req_0_bits_uop_robIdx_flag,
  ...
  wire             _GEN_1 =
    reqSel_oldest_valid & ~reqSel_oldest_bits_hasException
  ...
  wire             io_vecWriteBack_1_valid_0 =
    req_valid & _io_vecWriteBack_1_valid_T & req_isvec & ~io_storeVecOutValid
    & req_portIndex;
  wire             _GEN_12 = canEnq ? ~reqSel_oldest_bits_hasException : req_valid;
  ...
  wire             lowAddrStore_uop_exceptionVec_0 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_0;
  wire             lowAddrStore_uop_exceptionVec_1 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_1;
  wire             lowAddrStore_uop_exceptionVec_2 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_2;
  wire             lowAddrStore_uop_exceptionVec_4 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_4;
  wire             lowAddrStore_uop_exceptionVec_5 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_5;
  wire             lowAddrStore_uop_exceptionVec_8 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_8;
  wire             lowAddrStore_uop_exceptionVec_9 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_9;
  wire             lowAddrStore_uop_exceptionVec_10 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_10;
  wire             lowAddrStore_uop_exceptionVec_11 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_11;
  wire             lowAddrStore_uop_exceptionVec_12 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_12;
  wire             lowAddrStore_uop_exceptionVec_13 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_13;
  wire             lowAddrStore_uop_exceptionVec_14 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_14;
  wire             lowAddrStore_uop_exceptionVec_16 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_16;
  wire             lowAddrStore_uop_exceptionVec_17 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_17;
  wire             lowAddrStore_uop_exceptionVec_18 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_18;
  wire             lowAddrStore_uop_exceptionVec_19 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_19;
  wire             lowAddrStore_uop_exceptionVec_20 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_20;
  wire             lowAddrStore_uop_exceptionVec_21 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_21;
  wire             lowAddrStore_uop_exceptionVec_22 =
    _GEN_3 & cross16BytesBoundary & req_uop_exceptionVec_22;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      if (flush) begin
        ...
        if (_GEN_31) begin
          if (canEnq)
            req_valid <= ~reqSel_oldest_bits_hasException;
        end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_isForVSnonLeafPTE = _RANDOM[9'h32][13];
        ...
        splitStoreReqs_0_uop_exceptionVec_0 = _RANDOM[9'h3F][30];
        splitStoreReqs_0_uop_exceptionVec_1 = _RANDOM[9'h3F][31];
        splitStoreReqs_0_uop_exceptionVec_2 = _RANDOM[9'h40][0];
        splitStoreReqs_0_uop_exceptionVec_4 = _RANDOM[9'h40][2];
        splitStoreReqs_0_uop_exceptionVec_5 = _RANDOM[9'h40][3];
        splitStoreReqs_0_uop_exceptionVec_8 = _RANDOM[9'h40][6];
        splitStoreReqs_0_uop_exceptionVec_9 = _RANDOM[9'h40][7];
        splitStoreReqs_0_uop_exceptionVec_10 = _RANDOM[9'h40][8];
        splitStoreReqs_0_uop_exceptionVec_11 = _RANDOM[9'h40][9];
        splitStoreReqs_0_uop_exceptionVec_12 = _RANDOM[9'h40][10];
        splitStoreReqs_0_uop_exceptionVec_13 = _RANDOM[9'h40][11];
        splitStoreReqs_0_uop_exceptionVec_14 = _RANDOM[9'h40][12];
        splitStoreReqs_0_uop_exceptionVec_16 = _RANDOM[9'h40][14];
        splitStoreReqs_0_uop_exceptionVec_17 = _RANDOM[9'h40][15];
        splitStoreReqs_0_uop_exceptionVec_18 = _RANDOM[9'h40][16];
        splitStoreReqs_0_uop_exceptionVec_19 = _RANDOM[9'h40][17];
        splitStoreReqs_0_uop_exceptionVec_20 = _RANDOM[9'h40][18];
        splitStoreReqs_0_uop_exceptionVec_21 = _RANDOM[9'h40][19];
        splitStoreReqs_0_uop_exceptionVec_22 = _RANDOM[9'h40][20];
        ...
        splitStoreReqs_0_mask = {_RANDOM[9'h6A][31:18], _RANDOM[9'h6B][1:0]};
        splitStoreReqs_0_is128bit = _RANDOM[9'h74][6];
        splitStoreReqs_1_uop_exceptionVec_0 = _RANDOM[9'h7C][26];
        splitStoreReqs_1_uop_exceptionVec_1 = _RANDOM[9'h7C][27];
        splitStoreReqs_1_uop_exceptionVec_2 = _RANDOM[9'h7C][28];
        splitStoreReqs_1_uop_exceptionVec_4 = _RANDOM[9'h7C][30];
        splitStoreReqs_1_uop_exceptionVec_5 = _RANDOM[9'h7C][31];
        splitStoreReqs_1_uop_exceptionVec_8 = _RANDOM[9'h7D][2];
        splitStoreReqs_1_uop_exceptionVec_9 = _RANDOM[9'h7D][3];
        splitStoreReqs_1_uop_exceptionVec_10 = _RANDOM[9'h7D][4];
        splitStoreReqs_1_uop_exceptionVec_11 = _RANDOM[9'h7D][5];
        splitStoreReqs_1_uop_exceptionVec_12 = _RANDOM[9'h7D][6];
        splitStoreReqs_1_uop_exceptionVec_13 = _RANDOM[9'h7D][7];
        splitStoreReqs_1_uop_exceptionVec_14 = _RANDOM[9'h7D][8];
        splitStoreReqs_1_uop_exceptionVec_16 = _RANDOM[9'h7D][10];
        splitStoreReqs_1_uop_exceptionVec_17 = _RANDOM[9'h7D][11];
        splitStoreReqs_1_uop_exceptionVec_18 = _RANDOM[9'h7D][12];
        splitStoreReqs_1_uop_exceptionVec_19 = _RANDOM[9'h7D][13];
        splitStoreReqs_1_uop_exceptionVec_20 = _RANDOM[9'h7D][14];
        splitStoreReqs_1_uop_exceptionVec_21 = _RANDOM[9'h7D][15];
        splitStoreReqs_1_uop_exceptionVec_22 = _RANDOM[9'h7D][16];
        ...
        splitStoreReqs_1_mask = _RANDOM[9'hA7][29:14];
        splitStoreReqs_1_is128bit = _RANDOM[9'hB1][2];
        splitStoreResp_1_paddr =
          {_RANDOM[9'h11D][31:23], _RANDOM[9'h11E], _RANDOM[9'h11F][6:0]};
