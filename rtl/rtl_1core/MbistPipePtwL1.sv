...
module MbistPipePtwL1(
  ...
  input          mbist_writeen,
  input  [1:0]   mbist_be,
  input  [3:0]   mbist_addr,
  input  [199:0] mbist_indata,
  input          mbist_readen,
  input  [3:0]   mbist_addr_rd,
  output [199:0] mbist_outdata,
  output [3:0]   toSRAM_0_addr,
  output [3:0]   toSRAM_0_addr_rd,
  output [199:0] toSRAM_0_wdata,
  output [1:0]   toSRAM_0_wmask,
  output         toSRAM_0_re,
  output         toSRAM_0_we,
  input  [199:0] toSRAM_0_rdata,
  output         toSRAM_0_ack,
  output         toSRAM_0_selectedOH,
  output [5:0]   toSRAM_0_array,
  output [3:0]   toSRAM_1_addr,
  output [3:0]   toSRAM_1_addr_rd,
  output [199:0] toSRAM_1_wdata,
  output [1:0]   toSRAM_1_wmask,
  output         toSRAM_1_re,
  output         toSRAM_1_we,
  input  [199:0] toSRAM_1_rdata,
  output         toSRAM_1_ack,
  output         toSRAM_1_selectedOH,
  output [5:0]   toSRAM_1_array,
  output [3:0]   toSRAM_2_addr,
  output [3:0]   toSRAM_2_addr_rd,
  output [199:0] toSRAM_2_wdata,
  output [1:0]   toSRAM_2_wmask,
  output         toSRAM_2_re,
  output         toSRAM_2_we,
  input  [199:0] toSRAM_2_rdata,
  output         toSRAM_2_ack,
  output         toSRAM_2_selectedOH,
  output [5:0]   toSRAM_2_array,
  output [3:0]   toSRAM_3_addr,
  output [3:0]   toSRAM_3_addr_rd,
  output [199:0] toSRAM_3_wdata,
  output [1:0]   toSRAM_3_wmask,
  output         toSRAM_3_re,
  output         toSRAM_3_we,
  input  [199:0] toSRAM_3_rdata,
  output         toSRAM_3_ack,
  output         toSRAM_3_selectedOH,
  output [5:0]   toSRAM_3_array
);

  wire [199:0] sramDataOut_3;
  wire [199:0] sramDataOut_2;
  wire [199:0] sramDataOut_1;
  wire [199:0] sramDataOut_0;
  reg  [5:0]   arrayReg;
  reg          reqReg;
  reg          allReg;
  reg          wenReg;
  ...
  reg          renReg;
  reg  [3:0]   addrRdReg;
  wire         selectedVec_0 = arrayReg == 6'h28;
  wire         doSpread = selectedVec_0 | allReg;
  assign sramDataOut_0 = selectedVec_0 ? toSRAM_0_rdata : 200'h0;
  wire         selectedVec_0_1 = arrayReg == 6'h29;
  wire         doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = selectedVec_0_1 ? toSRAM_1_rdata : 200'h0;
  wire         selectedVec_0_2 = arrayReg == 6'h2A;
  wire         doSpread_2 = selectedVec_0_2 | allReg;
  assign sramDataOut_2 = selectedVec_0_2 ? toSRAM_2_rdata : 200'h0;
  wire         selectedVec_0_3 = arrayReg == 6'h2B;
  wire         doSpread_3 = selectedVec_0_3 | allReg;
  assign sramDataOut_3 = selectedVec_0_3 ? toSRAM_3_rdata : 200'h0;
  wire         activated =
    mbist_all | mbist_req
    & (mbist_array == 6'h28 | mbist_array == 6'h29 | mbist_array == 6'h2A
       | mbist_array == 6'h2B);
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        dataInReg =
          {_RANDOM[3'h0][31:15],
           ...
           _RANDOM[3'h5],
           _RANDOM[3'h6][22:0]};
        renReg = _RANDOM[3'h6][23];
        addrRdReg = _RANDOM[3'h6][27:24];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 6'h0;
        reqReg = 1'h0;
  ...
  assign toSRAM_0_addr = doSpread ? addrReg : 4'h0;
  assign toSRAM_0_addr_rd = doSpread ? addrRdReg : 4'h0;
  ...
  assign toSRAM_1_addr = doSpread_1 ? addrReg : 4'h0;
  assign toSRAM_1_addr_rd = doSpread_1 ? addrRdReg : 4'h0;
  ...
  assign toSRAM_2_addr = doSpread_2 ? addrReg : 4'h0;
  assign toSRAM_2_addr_rd = doSpread_2 ? addrRdReg : 4'h0;
  ...
  assign toSRAM_3_addr = doSpread_3 ? addrReg : 4'h0;
  assign toSRAM_3_addr_rd = doSpread_3 ? addrRdReg : 4'h0;
