...
module TemporalPrefetch(
  ...
  input  [1:0]   boreChildrenBd_bore_selectedOH,
  ...
  reg  [9:0]       resetIdx;
  wire             s0_valid =
    resetFinish & io_train_valid & io_train_bits_reqsource != 5'h6;
  reg              s1_valid;
  reg  [32:0]      train_s1_tag;
  reg  [8:0]       train_s1_set;
  reg  [43:0]      train_s1_vaddr;
  wire [33:0]      _GEN = {2'h0, train_s1_tag[32:1]};
  wire             hitVec_1 =
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        train_s1_tag = {_RANDOM[5'h0][31:12], _RANDOM[5'h1][12:0]};
        train_s1_set = _RANDOM[5'h1][21:13];
        train_s1_vaddr = {_RANDOM[5'h1][31:30], _RANDOM[5'h2], _RANDOM[5'h3][9:0]};
        s2_valid = _RANDOM[5'h3][20];
        hit_s2 = _RANDOM[5'h3][21];
        way_s2 = _RANDOM[5'h3][25:22];
        pset_s2 = _RANDOM[5'h4][13:4];
        train_s2_tag = {_RANDOM[5'h4][31:14], _RANDOM[5'h5][14:0]};
        train_s2_set = _RANDOM[5'h5][23:15];
        train_s2_vaddr = {_RANDOM[5'h6], _RANDOM[5'h7][11:0]};
        recorder_idx = _RANDOM[5'h7][28:23];
        recorder_data_0 = {_RANDOM[5'h7][31:29], _RANDOM[5'h8], _RANDOM[5'h9][12:0]};
        recorder_data_1 = {_RANDOM[5'h9][31:13], _RANDOM[5'hA][28:0]};
        recorder_data_2 = {_RANDOM[5'hA][31:29], _RANDOM[5'hB], _RANDOM[5'hC][12:0]};
        write_record = _RANDOM[5'hC][13];
        write_record_trigger_paddr =
          {_RANDOM[5'hD][31:21], _RANDOM[5'hE], _RANDOM[5'hF][4:0]};
        write_record_trigger_way = _RANDOM[5'hF][8:5];
        do_sending = _RANDOM[5'hF][10];
        sending_idx = _RANDOM[5'hF][16:11];
        sending_data_0 = {_RANDOM[5'hF][31:17], _RANDOM[5'h10], _RANDOM[5'h11][0]};
        sending_data_1 = {_RANDOM[5'h11][31:1], _RANDOM[5'h12][16:0]};
        sending_data_2 = {_RANDOM[5'h12][31:17], _RANDOM[5'h13], _RANDOM[5'h14][0]};
        sending_throttle = _RANDOM[5'h14][4:1];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        resetFinish = 1'h0;
        resetIdx = 10'h3FF;
  ...
  assign io_req_bits_tag = _GEN_2[41:9];
