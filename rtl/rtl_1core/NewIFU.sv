...
module NewIFU(
  ...
  wire              _GEN_18 = mmio_state == 4'h9;
  wire              _GEN_19 = mmio_state != 4'hA;
  wire              _GEN_20 = _GEN_7 | _GEN_8 | _GEN_9 | _GEN_18;
  wire              _GEN_21 = _GEN_5 | _GEN_6 | _GEN_20 | _GEN_19;
  wire              _GEN_22 = _GEN_20 | _GEN_19;
  wire              _GEN_23 = _GEN_0 | _GEN_1 | _GEN_2 | _GEN_3 | _GEN_5;
  wire              f3_hasLastHalf =
  ...
  wire [15:0][3:0]  _GEN_24 =
    {{mmio_state},
     ...
     {_GEN_17 ? ((|exception_1) ? 4'h9 : 4'h6) : mmio_state},
        ...
        & (_GEN_23
             ...
             : _GEN_6
                 ? (_GEN_17
                      ...
                      : mmio_resend_isForVSnonLeafPTE)
                 : _GEN_22 & mmio_resend_isForVSnonLeafPTE);
  ...
  wire [11:0]       _GEN_25 = {1'h0, f1_ftq_req_startAddr[10:0]};
  wire [6:0]        _GEN_26 = {2'h0, f1_ftq_req_startAddr[5:1]};
  ...
  always @(posedge clock) begin
    ...
    if (f1_fire) begin
      ...
      f2_pc_lower_result_1 <= 12'(_GEN_25 + 12'h2);
      f2_pc_lower_result_2 <= 12'(_GEN_25 + 12'h4);
      f2_pc_lower_result_3 <= 12'(_GEN_25 + 12'h6);
      f2_pc_lower_result_4 <= 12'(_GEN_25 + 12'h8);
      f2_pc_lower_result_5 <= 12'(_GEN_25 + 12'hA);
      f2_pc_lower_result_6 <= 12'(_GEN_25 + 12'hC);
      f2_pc_lower_result_7 <= 12'(_GEN_25 + 12'hE);
      f2_pc_lower_result_8 <= 12'(_GEN_25 + 12'h10);
      f2_pc_lower_result_9 <= 12'(_GEN_25 + 12'h12);
      f2_pc_lower_result_10 <= 12'(_GEN_25 + 12'h14);
      f2_pc_lower_result_11 <= 12'(_GEN_25 + 12'h16);
      f2_pc_lower_result_12 <= 12'(_GEN_25 + 12'h18);
      f2_pc_lower_result_13 <= 12'(_GEN_25 + 12'h1A);
      f2_pc_lower_result_14 <= 12'(_GEN_25 + 12'h1C);
      f2_pc_lower_result_15 <= 12'(_GEN_25 + 12'h1E);
      ...
      f2_cut_ptr_1 <= 7'(_GEN_26 + 7'h1);
      f2_cut_ptr_2 <= 7'(_GEN_26 + 7'h2);
      f2_cut_ptr_3 <= 7'(_GEN_26 + 7'h3);
      f2_cut_ptr_4 <= 7'(_GEN_26 + 7'h4);
      f2_cut_ptr_5 <= 7'(_GEN_26 + 7'h5);
      f2_cut_ptr_6 <= 7'(_GEN_26 + 7'h6);
      f2_cut_ptr_7 <= 7'(_GEN_26 + 7'h7);
      f2_cut_ptr_8 <= 7'(_GEN_26 + 7'h8);
      f2_cut_ptr_9 <= 7'(_GEN_26 + 7'h9);
      f2_cut_ptr_10 <= 7'(_GEN_26 + 7'hA);
      f2_cut_ptr_11 <= 7'(_GEN_26 + 7'hB);
      f2_cut_ptr_12 <= 7'(_GEN_26 + 7'hC);
      f2_cut_ptr_13 <= 7'(_GEN_26 + 7'hD);
      f2_cut_ptr_14 <= 7'(_GEN_26 + 7'hE);
      f2_cut_ptr_15 <= 7'(_GEN_26 + 7'hF);
      f2_cut_ptr_16 <= 7'(_GEN_26 + 7'h10);
    ...
    if (wb_enable) begin
      ...
      wb_false_lastHalf_r <=
        ~_GEN_30[f3_last_validIdx] & _GEN_29[f3_last_validIdx] & _GEN_28[f3_last_validIdx]
        & ~_GEN_27[f3_last_validIdx] & ~f3_req_is_mmio;
      wb_false_target <= _GEN_31[f3_last_validIdx];
    end
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    logic [31:0] _RANDOM[0:168];
    initial begin
      `ifdef INIT_RANDOM_PROLOG_
        `INIT_RANDOM_PROLOG_
      `endif // INIT_RANDOM_PROLOG_
      `ifdef RANDOMIZE_REG_INIT
        for (logic [7:0] i = 8'h0; i < 8'hA9; i += 8'h1) begin
          _RANDOM[i] = `RANDOM;
        end
        ...
        f1_ftq_req_ftqIdx_value = _RANDOM[8'h8][27:22];
        f1_ftq_req_ftqOffset_valid = _RANDOM[8'h8][28];
        f1_ftq_req_ftqOffset_bits = {_RANDOM[8'h8][31:29], _RANDOM[8'h9][0]};
        f1_doubleLine = _RANDOM[8'hA][11];
        f2_valid = _RANDOM[8'hA][28];
        f2_ftq_req_startAddr = {_RANDOM[8'hA][31:29], _RANDOM[8'hB], _RANDOM[8'hC][14:0]};
        f2_ftq_req_nextlineStart =
          {_RANDOM[8'hC][31:15], _RANDOM[8'hD], _RANDOM[8'hE][0]};
        f2_ftq_req_nextStartAddr = {_RANDOM[8'hE][31:1], _RANDOM[8'hF][18:0]};
        f2_ftq_req_ftqIdx_flag = _RANDOM[8'hF][19];
        f2_ftq_req_ftqIdx_value = _RANDOM[8'hF][25:20];
        f2_ftq_req_ftqOffset_valid = _RANDOM[8'hF][26];
        f2_ftq_req_ftqOffset_bits = _RANDOM[8'hF][30:27];
        f2_doubleLine = _RANDOM[8'h11][9];
        f2_icache_all_resp_reg = _RANDOM[8'h11][26];
        f2_pc_lower_result_0 = {_RANDOM[8'h11][31:27], _RANDOM[8'h12][6:0]};
        f2_pc_lower_result_1 = _RANDOM[8'h12][18:7];
        f2_pc_lower_result_2 = _RANDOM[8'h12][30:19];
        f2_pc_lower_result_3 = {_RANDOM[8'h12][31], _RANDOM[8'h13][10:0]};
        f2_pc_lower_result_4 = _RANDOM[8'h13][22:11];
        f2_pc_lower_result_5 = {_RANDOM[8'h13][31:23], _RANDOM[8'h14][2:0]};
        f2_pc_lower_result_6 = _RANDOM[8'h14][14:3];
        f2_pc_lower_result_7 = _RANDOM[8'h14][26:15];
        f2_pc_lower_result_8 = {_RANDOM[8'h14][31:27], _RANDOM[8'h15][6:0]};
        f2_pc_lower_result_9 = _RANDOM[8'h15][18:7];
        f2_pc_lower_result_10 = _RANDOM[8'h15][30:19];
        f2_pc_lower_result_11 = {_RANDOM[8'h15][31], _RANDOM[8'h16][10:0]};
        f2_pc_lower_result_12 = _RANDOM[8'h16][22:11];
        f2_pc_lower_result_13 = {_RANDOM[8'h16][31:23], _RANDOM[8'h17][2:0]};
        f2_pc_lower_result_14 = _RANDOM[8'h17][14:3];
        f2_pc_lower_result_15 = _RANDOM[8'h17][26:15];
        f2_pc_high = {_RANDOM[8'h17][31:27], _RANDOM[8'h18], _RANDOM[8'h19][1:0]};
        f2_pc_high_plus1 = {_RANDOM[8'h19][31:2], _RANDOM[8'h1A][8:0]};
        f2_cut_ptr_0 = _RANDOM[8'h1A][15:9];
        f2_cut_ptr_1 = _RANDOM[8'h1A][22:16];
        f2_cut_ptr_2 = _RANDOM[8'h1A][29:23];
        f2_cut_ptr_3 = {_RANDOM[8'h1A][31:30], _RANDOM[8'h1B][4:0]};
        f2_cut_ptr_4 = _RANDOM[8'h1B][11:5];
        f2_cut_ptr_5 = _RANDOM[8'h1B][18:12];
        f2_cut_ptr_6 = _RANDOM[8'h1B][25:19];
        f2_cut_ptr_7 = {_RANDOM[8'h1B][31:26], _RANDOM[8'h1C][0]};
        f2_cut_ptr_8 = _RANDOM[8'h1C][7:1];
        f2_cut_ptr_9 = _RANDOM[8'h1C][14:8];
        f2_cut_ptr_10 = _RANDOM[8'h1C][21:15];
        f2_cut_ptr_11 = _RANDOM[8'h1C][28:22];
        f2_cut_ptr_12 = {_RANDOM[8'h1C][31:29], _RANDOM[8'h1D][3:0]};
        f2_cut_ptr_13 = _RANDOM[8'h1D][10:4];
        f2_cut_ptr_14 = _RANDOM[8'h1D][17:11];
        f2_cut_ptr_15 = _RANDOM[8'h1D][24:18];
        f2_cut_ptr_16 = _RANDOM[8'h1D][31:25];
        f2_resend_vaddr = {_RANDOM[8'h1E], _RANDOM[8'h1F][17:0]};
        f3_valid = _RANDOM[8'h1F][18];
        f3_ftq_req_startAddr =
          {_RANDOM[8'h1F][31:19], _RANDOM[8'h20], _RANDOM[8'h21][4:0]};
        f3_ftq_req_nextStartAddr =
          {_RANDOM[8'h22][31:23], _RANDOM[8'h23], _RANDOM[8'h24][8:0]};
        f3_ftq_req_ftqIdx_flag = _RANDOM[8'h24][9];
        f3_ftq_req_ftqIdx_value = _RANDOM[8'h24][15:10];
        f3_ftq_req_ftqOffset_valid = _RANDOM[8'h24][16];
        f3_ftq_req_ftqOffset_bits = _RANDOM[8'h24][20:17];
        f3_doubleLine = _RANDOM[8'h25][31];
        f3_exception_0 = _RANDOM[8'h2E][17:16];
        f3_exception_1 = _RANDOM[8'h2E][19:18];
        f3_pmp_mmio = _RANDOM[8'h2E][20];
        f3_itlb_pbmt = _RANDOM[8'h2E][22:21];
        f3_backendException = _RANDOM[8'h2E][23];
        f3_instr_0 = {_RANDOM[8'h2E][31:24], _RANDOM[8'h2F][23:0]};
        f3_instr_1 = {_RANDOM[8'h2F][31:24], _RANDOM[8'h30][23:0]};
        f3_instr_2 = {_RANDOM[8'h30][31:24], _RANDOM[8'h31][23:0]};
        f3_instr_3 = {_RANDOM[8'h31][31:24], _RANDOM[8'h32][23:0]};
        f3_instr_4 = {_RANDOM[8'h32][31:24], _RANDOM[8'h33][23:0]};
        f3_instr_5 = {_RANDOM[8'h33][31:24], _RANDOM[8'h34][23:0]};
        f3_instr_6 = {_RANDOM[8'h34][31:24], _RANDOM[8'h35][23:0]};
        f3_instr_7 = {_RANDOM[8'h35][31:24], _RANDOM[8'h36][23:0]};
        f3_instr_8 = {_RANDOM[8'h36][31:24], _RANDOM[8'h37][23:0]};
        f3_instr_9 = {_RANDOM[8'h37][31:24], _RANDOM[8'h38][23:0]};
        f3_instr_10 = {_RANDOM[8'h38][31:24], _RANDOM[8'h39][23:0]};
        f3_instr_11 = {_RANDOM[8'h39][31:24], _RANDOM[8'h3A][23:0]};
        f3_instr_12 = {_RANDOM[8'h3A][31:24], _RANDOM[8'h3B][23:0]};
        f3_instr_13 = {_RANDOM[8'h3B][31:24], _RANDOM[8'h3C][23:0]};
        f3_instr_14 = {_RANDOM[8'h3C][31:24], _RANDOM[8'h3D][23:0]};
        f3_instr_15 = {_RANDOM[8'h3D][31:24], _RANDOM[8'h3E][23:0]};
        f3_pd_wire_0_isRVC = _RANDOM[8'h3E][25];
        f3_pd_wire_1_valid = _RANDOM[8'h3E][30];
        f3_pd_wire_1_isRVC = _RANDOM[8'h3E][31];
        f3_pd_wire_2_valid = _RANDOM[8'h3F][4];
        f3_pd_wire_2_isRVC = _RANDOM[8'h3F][5];
        f3_pd_wire_3_valid = _RANDOM[8'h3F][10];
        f3_pd_wire_3_isRVC = _RANDOM[8'h3F][11];
        f3_pd_wire_4_valid = _RANDOM[8'h3F][16];
        f3_pd_wire_4_isRVC = _RANDOM[8'h3F][17];
        f3_pd_wire_5_valid = _RANDOM[8'h3F][22];
        f3_pd_wire_5_isRVC = _RANDOM[8'h3F][23];
        f3_pd_wire_6_valid = _RANDOM[8'h3F][28];
        f3_pd_wire_6_isRVC = _RANDOM[8'h3F][29];
        f3_pd_wire_7_valid = _RANDOM[8'h40][2];
        f3_pd_wire_7_isRVC = _RANDOM[8'h40][3];
        f3_pd_wire_8_valid = _RANDOM[8'h40][8];
        f3_pd_wire_8_isRVC = _RANDOM[8'h40][9];
        f3_pd_wire_9_valid = _RANDOM[8'h40][14];
        f3_pd_wire_9_isRVC = _RANDOM[8'h40][15];
        f3_pd_wire_10_valid = _RANDOM[8'h40][20];
        f3_pd_wire_10_isRVC = _RANDOM[8'h40][21];
        f3_pd_wire_11_valid = _RANDOM[8'h40][26];
        f3_pd_wire_11_isRVC = _RANDOM[8'h40][27];
        f3_pd_wire_12_valid = _RANDOM[8'h41][0];
        f3_pd_wire_12_isRVC = _RANDOM[8'h41][1];
        f3_pd_wire_13_valid = _RANDOM[8'h41][6];
        f3_pd_wire_13_isRVC = _RANDOM[8'h41][7];
        f3_pd_wire_14_valid = _RANDOM[8'h41][12];
        f3_pd_wire_14_isRVC = _RANDOM[8'h41][13];
        f3_pd_wire_15_valid = _RANDOM[8'h41][18];
        f3_pd_wire_15_isRVC = _RANDOM[8'h41][19];
        f3_jump_offset_0 = {_RANDOM[8'h41][31:24], _RANDOM[8'h42], _RANDOM[8'h43][23:0]};
        f3_jump_offset_1 = {_RANDOM[8'h43][31:24], _RANDOM[8'h44], _RANDOM[8'h45][23:0]};
        f3_jump_offset_2 = {_RANDOM[8'h45][31:24], _RANDOM[8'h46], _RANDOM[8'h47][23:0]};
        f3_jump_offset_3 = {_RANDOM[8'h47][31:24], _RANDOM[8'h48], _RANDOM[8'h49][23:0]};
        f3_jump_offset_4 = {_RANDOM[8'h49][31:24], _RANDOM[8'h4A], _RANDOM[8'h4B][23:0]};
        f3_jump_offset_5 = {_RANDOM[8'h4B][31:24], _RANDOM[8'h4C], _RANDOM[8'h4D][23:0]};
        f3_jump_offset_6 = {_RANDOM[8'h4D][31:24], _RANDOM[8'h4E], _RANDOM[8'h4F][23:0]};
        f3_jump_offset_7 = {_RANDOM[8'h4F][31:24], _RANDOM[8'h50], _RANDOM[8'h51][23:0]};
        f3_jump_offset_8 = {_RANDOM[8'h51][31:24], _RANDOM[8'h52], _RANDOM[8'h53][23:0]};
        f3_jump_offset_9 = {_RANDOM[8'h53][31:24], _RANDOM[8'h54], _RANDOM[8'h55][23:0]};
        f3_jump_offset_10 = {_RANDOM[8'h55][31:24], _RANDOM[8'h56], _RANDOM[8'h57][23:0]};
        f3_jump_offset_11 = {_RANDOM[8'h57][31:24], _RANDOM[8'h58], _RANDOM[8'h59][23:0]};
        f3_jump_offset_12 = {_RANDOM[8'h59][31:24], _RANDOM[8'h5A], _RANDOM[8'h5B][23:0]};
        f3_jump_offset_13 = {_RANDOM[8'h5B][31:24], _RANDOM[8'h5C], _RANDOM[8'h5D][23:0]};
        f3_jump_offset_14 = {_RANDOM[8'h5D][31:24], _RANDOM[8'h5E], _RANDOM[8'h5F][23:0]};
        f3_jump_offset_15 = {_RANDOM[8'h5F][31:24], _RANDOM[8'h60], _RANDOM[8'h61][23:0]};
        f3_exception_vec_0 = _RANDOM[8'h61][25:24];
        f3_exception_vec_1 = _RANDOM[8'h61][27:26];
        f3_exception_vec_2 = _RANDOM[8'h61][29:28];
        f3_exception_vec_3 = _RANDOM[8'h61][31:30];
        f3_exception_vec_4 = _RANDOM[8'h62][1:0];
        f3_exception_vec_5 = _RANDOM[8'h62][3:2];
        f3_exception_vec_6 = _RANDOM[8'h62][5:4];
        f3_exception_vec_7 = _RANDOM[8'h62][7:6];
        f3_exception_vec_8 = _RANDOM[8'h62][9:8];
        f3_exception_vec_9 = _RANDOM[8'h62][11:10];
        f3_exception_vec_10 = _RANDOM[8'h62][13:12];
        f3_exception_vec_11 = _RANDOM[8'h62][15:14];
        f3_exception_vec_12 = _RANDOM[8'h62][17:16];
        f3_exception_vec_13 = _RANDOM[8'h62][19:18];
        f3_exception_vec_14 = _RANDOM[8'h62][21:20];
        f3_exception_vec_15 = _RANDOM[8'h62][23:22];
        f3_crossPage_exception_vec_0 = _RANDOM[8'h62][25:24];
        f3_crossPage_exception_vec_1 = _RANDOM[8'h62][27:26];
        f3_crossPage_exception_vec_2 = _RANDOM[8'h62][29:28];
        f3_crossPage_exception_vec_3 = _RANDOM[8'h62][31:30];
        f3_crossPage_exception_vec_4 = _RANDOM[8'h63][1:0];
        f3_crossPage_exception_vec_5 = _RANDOM[8'h63][3:2];
        f3_crossPage_exception_vec_6 = _RANDOM[8'h63][5:4];
        f3_crossPage_exception_vec_7 = _RANDOM[8'h63][7:6];
        f3_crossPage_exception_vec_8 = _RANDOM[8'h63][9:8];
        f3_crossPage_exception_vec_9 = _RANDOM[8'h63][11:10];
        f3_crossPage_exception_vec_10 = _RANDOM[8'h63][13:12];
        f3_crossPage_exception_vec_11 = _RANDOM[8'h63][15:14];
        f3_crossPage_exception_vec_12 = _RANDOM[8'h63][17:16];
        f3_crossPage_exception_vec_13 = _RANDOM[8'h63][19:18];
        f3_crossPage_exception_vec_14 = _RANDOM[8'h63][21:20];
        f3_crossPage_exception_vec_15 = _RANDOM[8'h63][23:22];
        f3_pc_lower_result_0 = {_RANDOM[8'h63][31:24], _RANDOM[8'h64][3:0]};
        f3_pc_lower_result_1 = _RANDOM[8'h64][15:4];
        f3_pc_lower_result_2 = _RANDOM[8'h64][27:16];
        f3_pc_lower_result_3 = {_RANDOM[8'h64][31:28], _RANDOM[8'h65][7:0]};
        f3_pc_lower_result_4 = _RANDOM[8'h65][19:8];
        f3_pc_lower_result_5 = _RANDOM[8'h65][31:20];
        f3_pc_lower_result_6 = _RANDOM[8'h66][11:0];
        f3_pc_lower_result_7 = _RANDOM[8'h66][23:12];
        f3_pc_lower_result_8 = {_RANDOM[8'h66][31:24], _RANDOM[8'h67][3:0]};
        f3_pc_lower_result_9 = _RANDOM[8'h67][15:4];
        f3_pc_lower_result_10 = _RANDOM[8'h67][27:16];
        f3_pc_lower_result_11 = {_RANDOM[8'h67][31:28], _RANDOM[8'h68][7:0]};
        f3_pc_lower_result_12 = _RANDOM[8'h68][19:8];
        f3_pc_lower_result_13 = _RANDOM[8'h68][31:20];
        f3_pc_lower_result_14 = _RANDOM[8'h69][11:0];
        f3_pc_lower_result_15 = _RANDOM[8'h69][23:12];
        f3_pc_high = {_RANDOM[8'h69][31:24], _RANDOM[8'h6A][30:0]};
        f3_pc_high_plus1 = {_RANDOM[8'h6A][31], _RANDOM[8'h6B], _RANDOM[8'h6C][5:0]};
        f3_pc_last_lower_result_plus2 = _RANDOM[8'h6C][17:6];
        f3_pc_last_lower_result_plus4 = _RANDOM[8'h6C][29:18];
        f3_instr_range = {_RANDOM[8'h6C][31:30], _RANDOM[8'h6D][13:0]};
        f3_hasHalfValid_2 = _RANDOM[8'h72][16];
        f3_hasHalfValid_3 = _RANDOM[8'h72][17];
        f3_hasHalfValid_4 = _RANDOM[8'h72][18];
        f3_hasHalfValid_5 = _RANDOM[8'h72][19];
        f3_hasHalfValid_6 = _RANDOM[8'h72][20];
        f3_hasHalfValid_7 = _RANDOM[8'h72][21];
        f3_hasHalfValid_8 = _RANDOM[8'h72][22];
        f3_hasHalfValid_9 = _RANDOM[8'h72][23];
        f3_hasHalfValid_10 = _RANDOM[8'h72][24];
        f3_hasHalfValid_11 = _RANDOM[8'h72][25];
        f3_hasHalfValid_12 = _RANDOM[8'h72][26];
        f3_hasHalfValid_13 = _RANDOM[8'h72][27];
        f3_hasHalfValid_14 = _RANDOM[8'h72][28];
        f3_hasHalfValid_15 = _RANDOM[8'h72][29];
        f3_paddrs_0 = {_RANDOM[8'h72][31:30], _RANDOM[8'h73], _RANDOM[8'h74][13:0]};
        f3_gpaddr = {_RANDOM[8'h75][31:30], _RANDOM[8'h76], _RANDOM[8'h77][21:0]};
        f3_isForVSnonLeafPTE = _RANDOM[8'h77][22];
        f3_resend_vaddr = {_RANDOM[8'h77][31:23], _RANDOM[8'h78], _RANDOM[8'h79][8:0]};
        f3_mmio_data_0 = _RANDOM[8'h79][24:9];
        f3_mmio_data_1 = {_RANDOM[8'h79][31:25], _RANDOM[8'h7A][8:0]};
        mmio_exception = _RANDOM[8'h7A][10:9];
        mmio_is_RVC = _RANDOM[8'h7A][11];
        mmio_has_resend = _RANDOM[8'h7A][12];
        mmio_resend_addr = {_RANDOM[8'h7A][31:13], _RANDOM[8'h7B][28:0]};
        mmio_resend_gpaddr =
          {_RANDOM[8'h7B][31:29], _RANDOM[8'h7C], _RANDOM[8'h7D][20:0]};
        mmio_resend_isForVSnonLeafPTE = _RANDOM[8'h7D][21];
        is_first_instr = _RANDOM[8'h7D][22];
        io_mmioCommitRead_mmioFtqPtr_REG_flag = _RANDOM[8'h7D][23];
        io_mmioCommitRead_mmioFtqPtr_REG_value = _RANDOM[8'h7D][29:24];
        mmio_state = {_RANDOM[8'h7D][31:30], _RANDOM[8'h7E][1:0]};
        f3_mmio_to_commit_next = _RANDOM[8'h7E][2];
        fromFtqRedirectReg_bits_r_ftqIdx_flag = _RANDOM[8'h7E][13];
        fromFtqRedirectReg_bits_r_ftqIdx_value = _RANDOM[8'h7E][19:14];
        fromFtqRedirectReg_bits_r_ftqOffset = _RANDOM[8'h7E][23:20];
        fromFtqRedirectReg_bits_r_level = _RANDOM[8'h7E][24];
        fromFtqRedirectReg_valid_REG = _RANDOM[8'h8F][25];
        mmioF3Flush = _RANDOM[8'h8F][26];
        f3_mmio_use_seq_pc = _RANDOM[8'h8F][27];
        REG = _RANDOM[8'h8F][28];
        f3_lastHalf_valid = _RANDOM[8'h8F][29];
        predChecker_io_in_fire_in_REG = _RANDOM[8'h91][16];
        f3_lastHalf_disable = _RANDOM[8'h91][17];
        mmioFlushWb_valid_REG = _RANDOM[8'h91][19];
        mmio_redirect_REG = _RANDOM[8'h91][20];
        wb_enable_REG = _RANDOM[8'h91][21];
        wb_valid = _RANDOM[8'h91][22];
        wb_ftq_req_ftqIdx_flag = _RANDOM[8'h96][13];
        wb_ftq_req_ftqIdx_value = _RANDOM[8'h96][19:14];
        wb_check_result_stage1_fixedTaken_0 = _RANDOM[8'h98][19];
        wb_check_result_stage1_fixedTaken_1 = _RANDOM[8'h98][20];
        wb_check_result_stage1_fixedTaken_2 = _RANDOM[8'h98][21];
        wb_check_result_stage1_fixedTaken_3 = _RANDOM[8'h98][22];
        wb_check_result_stage1_fixedTaken_4 = _RANDOM[8'h98][23];
        wb_check_result_stage1_fixedTaken_5 = _RANDOM[8'h98][24];
        wb_check_result_stage1_fixedTaken_6 = _RANDOM[8'h98][25];
        wb_check_result_stage1_fixedTaken_7 = _RANDOM[8'h98][26];
        wb_check_result_stage1_fixedTaken_8 = _RANDOM[8'h98][27];
        wb_check_result_stage1_fixedTaken_9 = _RANDOM[8'h98][28];
        wb_check_result_stage1_fixedTaken_10 = _RANDOM[8'h98][29];
        wb_check_result_stage1_fixedTaken_11 = _RANDOM[8'h98][30];
        wb_check_result_stage1_fixedTaken_12 = _RANDOM[8'h98][31];
        wb_check_result_stage1_fixedTaken_13 = _RANDOM[8'h99][0];
        wb_check_result_stage1_fixedTaken_14 = _RANDOM[8'h99][1];
        wb_check_result_stage1_fixedTaken_15 = _RANDOM[8'h99][2];
        wb_instr_range = _RANDOM[8'h99][18:3];
        wb_pc_lower_result_0 = _RANDOM[8'h99][30:19];
        wb_pc_lower_result_1 = {_RANDOM[8'h99][31], _RANDOM[8'h9A][10:0]};
        wb_pc_lower_result_2 = _RANDOM[8'h9A][22:11];
        wb_pc_lower_result_3 = {_RANDOM[8'h9A][31:23], _RANDOM[8'h9B][2:0]};
        wb_pc_lower_result_4 = _RANDOM[8'h9B][14:3];
        wb_pc_lower_result_5 = _RANDOM[8'h9B][26:15];
        wb_pc_lower_result_6 = {_RANDOM[8'h9B][31:27], _RANDOM[8'h9C][6:0]};
        wb_pc_lower_result_7 = _RANDOM[8'h9C][18:7];
        wb_pc_lower_result_8 = _RANDOM[8'h9C][30:19];
        wb_pc_lower_result_9 = {_RANDOM[8'h9C][31], _RANDOM[8'h9D][10:0]};
        wb_pc_lower_result_10 = _RANDOM[8'h9D][22:11];
        wb_pc_lower_result_11 = {_RANDOM[8'h9D][31:23], _RANDOM[8'h9E][2:0]};
        wb_pc_lower_result_12 = _RANDOM[8'h9E][14:3];
        wb_pc_lower_result_13 = _RANDOM[8'h9E][26:15];
        wb_pc_lower_result_14 = {_RANDOM[8'h9E][31:27], _RANDOM[8'h9F][6:0]};
        wb_pc_lower_result_15 = _RANDOM[8'h9F][18:7];
        wb_pc_high = {_RANDOM[8'h9F][31:19], _RANDOM[8'hA0][25:0]};
        wb_pc_high_plus1 = {_RANDOM[8'hA0][31:26], _RANDOM[8'hA1], _RANDOM[8'hA2][0]};
        wb_pd_0_isRVC = _RANDOM[8'hA2][2];
        wb_pd_0_brType = _RANDOM[8'hA2][4:3];
        wb_pd_0_isCall = _RANDOM[8'hA2][5];
        wb_pd_0_isRet = _RANDOM[8'hA2][6];
        wb_pd_1_isRVC = _RANDOM[8'hA2][8];
        wb_pd_1_brType = _RANDOM[8'hA2][10:9];
        wb_pd_1_isCall = _RANDOM[8'hA2][11];
        wb_pd_1_isRet = _RANDOM[8'hA2][12];
        wb_pd_2_isRVC = _RANDOM[8'hA2][14];
        wb_pd_2_brType = _RANDOM[8'hA2][16:15];
        wb_pd_2_isCall = _RANDOM[8'hA2][17];
        wb_pd_2_isRet = _RANDOM[8'hA2][18];
        wb_pd_3_isRVC = _RANDOM[8'hA2][20];
        wb_pd_3_brType = _RANDOM[8'hA2][22:21];
        wb_pd_3_isCall = _RANDOM[8'hA2][23];
        wb_pd_3_isRet = _RANDOM[8'hA2][24];
        wb_pd_4_isRVC = _RANDOM[8'hA2][26];
        wb_pd_4_brType = _RANDOM[8'hA2][28:27];
        wb_pd_4_isCall = _RANDOM[8'hA2][29];
        wb_pd_4_isRet = _RANDOM[8'hA2][30];
        wb_pd_5_isRVC = _RANDOM[8'hA3][0];
        wb_pd_5_brType = _RANDOM[8'hA3][2:1];
        wb_pd_5_isCall = _RANDOM[8'hA3][3];
        wb_pd_5_isRet = _RANDOM[8'hA3][4];
        wb_pd_6_isRVC = _RANDOM[8'hA3][6];
        wb_pd_6_brType = _RANDOM[8'hA3][8:7];
        wb_pd_6_isCall = _RANDOM[8'hA3][9];
        wb_pd_6_isRet = _RANDOM[8'hA3][10];
        wb_pd_7_isRVC = _RANDOM[8'hA3][12];
        wb_pd_7_brType = _RANDOM[8'hA3][14:13];
        wb_pd_7_isCall = _RANDOM[8'hA3][15];
        wb_pd_7_isRet = _RANDOM[8'hA3][16];
        wb_pd_8_isRVC = _RANDOM[8'hA3][18];
        wb_pd_8_brType = _RANDOM[8'hA3][20:19];
        wb_pd_8_isCall = _RANDOM[8'hA3][21];
        wb_pd_8_isRet = _RANDOM[8'hA3][22];
        wb_pd_9_isRVC = _RANDOM[8'hA3][24];
        wb_pd_9_brType = _RANDOM[8'hA3][26:25];
        wb_pd_9_isCall = _RANDOM[8'hA3][27];
        wb_pd_9_isRet = _RANDOM[8'hA3][28];
        wb_pd_10_isRVC = _RANDOM[8'hA3][30];
        wb_pd_10_brType = {_RANDOM[8'hA3][31], _RANDOM[8'hA4][0]};
        wb_pd_10_isCall = _RANDOM[8'hA4][1];
        wb_pd_10_isRet = _RANDOM[8'hA4][2];
        wb_pd_11_isRVC = _RANDOM[8'hA4][4];
        wb_pd_11_brType = _RANDOM[8'hA4][6:5];
        wb_pd_11_isCall = _RANDOM[8'hA4][7];
        wb_pd_11_isRet = _RANDOM[8'hA4][8];
        wb_pd_12_isRVC = _RANDOM[8'hA4][10];
        wb_pd_12_brType = _RANDOM[8'hA4][12:11];
        wb_pd_12_isCall = _RANDOM[8'hA4][13];
        wb_pd_12_isRet = _RANDOM[8'hA4][14];
        wb_pd_13_isRVC = _RANDOM[8'hA4][16];
        wb_pd_13_brType = _RANDOM[8'hA4][18:17];
        wb_pd_13_isCall = _RANDOM[8'hA4][19];
        wb_pd_13_isRet = _RANDOM[8'hA4][20];
        wb_pd_14_isRVC = _RANDOM[8'hA4][22];
        wb_pd_14_brType = _RANDOM[8'hA4][24:23];
        wb_pd_14_isCall = _RANDOM[8'hA4][25];
        wb_pd_14_isRet = _RANDOM[8'hA4][26];
        wb_pd_15_isRVC = _RANDOM[8'hA4][28];
        wb_pd_15_brType = _RANDOM[8'hA4][30:29];
        wb_pd_15_isCall = _RANDOM[8'hA4][31];
        wb_pd_15_isRet = _RANDOM[8'hA5][0];
        wb_instr_valid_0 = _RANDOM[8'hA5][1];
        wb_instr_valid_1 = _RANDOM[8'hA5][2];
        wb_instr_valid_2 = _RANDOM[8'hA5][3];
        wb_instr_valid_3 = _RANDOM[8'hA5][4];
        wb_instr_valid_4 = _RANDOM[8'hA5][5];
        wb_instr_valid_5 = _RANDOM[8'hA5][6];
        wb_instr_valid_6 = _RANDOM[8'hA5][7];
        wb_instr_valid_7 = _RANDOM[8'hA5][8];
        wb_instr_valid_8 = _RANDOM[8'hA5][9];
        wb_instr_valid_9 = _RANDOM[8'hA5][10];
        wb_instr_valid_10 = _RANDOM[8'hA5][11];
        wb_instr_valid_11 = _RANDOM[8'hA5][12];
        wb_instr_valid_12 = _RANDOM[8'hA5][13];
        wb_instr_valid_13 = _RANDOM[8'hA5][14];
        wb_instr_valid_14 = _RANDOM[8'hA5][15];
        wb_instr_valid_15 = _RANDOM[8'hA5][16];
        wb_lastIdx = _RANDOM[8'hA5][20:17];
        wb_false_lastHalf_r = _RANDOM[8'hA5][21];
        wb_false_target = {_RANDOM[8'hA5][31:22], _RANDOM[8'hA6], _RANDOM[8'hA7][7:0]};
        REG_1 = _RANDOM[8'hA7][8];
        REG_2 = _RANDOM[8'hA7][9];
        REG_3 = _RANDOM[8'hA7][10];
        f3_perf_info_only_0_hit = _RANDOM[8'hA7][11];
        f3_perf_info_only_0_miss = _RANDOM[8'hA7][12];
        f3_perf_info_hit_0_hit_1 = _RANDOM[8'hA7][13];
        f3_perf_info_hit_0_miss_1 = _RANDOM[8'hA7][14];
        f3_perf_info_miss_0_hit_1 = _RANDOM[8'hA7][15];
        f3_perf_info_miss_0_miss_1 = _RANDOM[8'hA7][16];
        f3_perf_info_bank_hit_1 = _RANDOM[8'hA7][21];
        f3_perf_info_hit = _RANDOM[8'hA7][22];
        io_perf_0_value_REG = _RANDOM[8'hA7][23];
        io_perf_0_value_REG_1 = _RANDOM[8'hA7][24];
        io_perf_1_value_REG = _RANDOM[8'hA7][25];
        io_perf_1_value_REG_1 = _RANDOM[8'hA7][26];
        io_perf_2_value_REG = _RANDOM[8'hA7][27];
        io_perf_2_value_REG_1 = _RANDOM[8'hA7][28];
        io_perf_3_value_REG = _RANDOM[8'hA7][29];
        io_perf_3_value_REG_1 = _RANDOM[8'hA7][30];
        io_perf_4_value_REG = _RANDOM[8'hA7][31];
        io_perf_4_value_REG_1 = _RANDOM[8'hA8][0];
        io_perf_5_value_REG = _RANDOM[8'hA8][1];
        io_perf_5_value_REG_1 = _RANDOM[8'hA8][2];
        io_perf_6_value_REG = _RANDOM[8'hA8][3];
        io_perf_6_value_REG_1 = _RANDOM[8'hA8][4];
        io_perf_7_value_REG = _RANDOM[8'hA8][5];
        io_perf_7_value_REG_1 = _RANDOM[8'hA8][6];
        io_perf_8_value_REG = _RANDOM[8'hA8][7];
        io_perf_8_value_REG_1 = _RANDOM[8'hA8][8];
        io_perf_9_value_REG = _RANDOM[8'hA8][9];
        io_perf_9_value_REG_1 = _RANDOM[8'hA8][10];
        io_perf_10_value_REG = _RANDOM[8'hA8][11];
        io_perf_10_value_REG_1 = _RANDOM[8'hA8][12];
        io_perf_11_value_REG = _RANDOM[8'hA8][13];
        io_perf_11_value_REG_1 = _RANDOM[8'hA8][14];
        io_perf_12_value_REG = _RANDOM[8'hA8][15];
        io_perf_12_value_REG_1 = _RANDOM[8'hA8][16];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        f1_valid = 1'h0;
        f2_valid = 1'h0;
