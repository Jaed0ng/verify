...
module MbistPipePtwL0(
  ...
  assign sramDataOut_0 = selectedVec_0 ? toSRAM_0_rdata : 228'h0;
  wire         selectedVec_0_1 = arrayReg == 6'h2D;
  wire         doSpread_1 = selectedVec_0_1 | allReg;
  assign sramDataOut_1 = selectedVec_0_1 ? toSRAM_1_rdata : 228'h0;
  wire         selectedVec_0_2 = arrayReg == 6'h2E;
  wire         doSpread_2 = selectedVec_0_2 | allReg;
  assign sramDataOut_2 = selectedVec_0_2 ? toSRAM_2_rdata : 228'h0;
  wire         selectedVec_0_3 = arrayReg == 6'h2F;
  wire         doSpread_3 = selectedVec_0_3 | allReg;
  assign sramDataOut_3 = selectedVec_0_3 ? toSRAM_3_rdata : 228'h0;
  wire         selectedVec_0_4 = arrayReg == 6'h30;
  wire         doSpread_4 = selectedVec_0_4 | allReg;
  assign sramDataOut_4 = selectedVec_0_4 ? toSRAM_4_rdata : 228'h0;
  wire         selectedVec_0_5 = arrayReg == 6'h31;
  wire         doSpread_5 = selectedVec_0_5 | allReg;
  assign sramDataOut_5 = selectedVec_0_5 ? toSRAM_5_rdata : 228'h0;
  wire         selectedVec_0_6 = arrayReg == 6'h32;
  wire         doSpread_6 = selectedVec_0_6 | allReg;
  assign sramDataOut_6 = selectedVec_0_6 ? toSRAM_6_rdata : 228'h0;
  wire         selectedVec_0_7 = arrayReg == 6'h33;
  wire         doSpread_7 = selectedVec_0_7 | allReg;
  assign sramDataOut_7 = selectedVec_0_7 ? toSRAM_7_rdata : 228'h0;
  wire         activated =
    mbist_all | mbist_req
    & (mbist_array == 6'h2C | mbist_array == 6'h2D | mbist_array == 6'h2E
       | mbist_array == 6'h2F | mbist_array == 6'h30 | mbist_array == 6'h31
       | mbist_array == 6'h32 | mbist_array == 6'h33);
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beReg = _RANDOM[3'h0][10:9];
        addrReg = _RANDOM[3'h0][16:11];
        dataInReg =
          {_RANDOM[3'h0][31:17],
           _RANDOM[3'h1],
           _RANDOM[3'h2],
           ...
           _RANDOM[3'h6],
           _RANDOM[3'h7][20:0]};
        renReg = _RANDOM[3'h7][21];
        addrRdReg = _RANDOM[3'h7][27:22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        arrayReg = 6'h0;
        reqReg = 1'h0;
  ...
  assign toSRAM_2_addr = doSpread_2 ? addrReg : 6'h0;
  assign toSRAM_2_addr_rd = doSpread_2 ? addrRdReg : 6'h0;
  ...
  assign toSRAM_3_addr = doSpread_3 ? addrReg : 6'h0;
  assign toSRAM_3_addr_rd = doSpread_3 ? addrRdReg : 6'h0;
  ...
  assign toSRAM_4_addr = doSpread_4 ? addrReg : 6'h0;
  assign toSRAM_4_addr_rd = doSpread_4 ? addrRdReg : 6'h0;
  ...
  assign toSRAM_5_addr = doSpread_5 ? addrReg : 6'h0;
  assign toSRAM_5_addr_rd = doSpread_5 ? addrRdReg : 6'h0;
  ...
  assign toSRAM_6_addr = doSpread_6 ? addrReg : 6'h0;
  assign toSRAM_6_addr_rd = doSpread_6 ? addrRdReg : 6'h0;
  ...
  assign toSRAM_7_addr = doSpread_7 ? addrReg : 6'h0;
  assign toSRAM_7_addr_rd = doSpread_7 ? addrRdReg : 6'h0;
