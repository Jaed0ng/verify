...
module Queue1_MSHRRequest(
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        ram = {_RANDOM[2'h0][31:1], _RANDOM[2'h1], _RANDOM[2'h2], _RANDOM[2'h3][23:0]};
        full = _RANDOM[2'h0][0];
      `endif // RANDOMIZE_REG_INIT
      if (reset)
        full = 1'h0;
  ...
  assign io_deq_bits_set = ram[34:23];
  assign io_deq_bits_tag = ram[62:35];
  assign io_deq_bits_off = ram[68:63];
  assign io_deq_bits_mask = ram[100:69];
  assign io_deq_bits_bufIdx = ram[104:101];
  assign io_deq_bits_needHint = ram[105];
  assign io_deq_bits_isPrefetch = ram[106];
  assign io_deq_bits_isBop = ram[107];
  assign io_deq_bits_preferCache = ram[108];
  assign io_deq_bits_dirty = ram[109];
  assign io_deq_bits_fromProbeHelper = ram[111];
  assign io_deq_bits_fromCmoHelper = ram[112];
  assign io_deq_bits_needProbeAckData = ram[113];
  assign io_deq_bits_reqSource = ram[118:114];
endmodule
