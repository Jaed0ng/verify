  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        indexed_set = _RANDOM[/*Zero width*/ 1'b0][17:6];
        indexed_way = _RANDOM[/*Zero width*/ 1'b0][21:18];
        io_bs_waddr_bits_beat_r = _RANDOM[/*Zero width*/ 1'b0][22];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        r_counter = 1'h0;
        first_resp = 1'h1;
