...
module UncacheEntry_2(
  ...
  wire [47:0]     _GEN_4 =
    _GEN_3[47:0] | (req_paddr[2:0] == 3'h2 ? uncacheData[63:16] : 48'h0);
  wire [39:0]     _GEN_5 =
    _GEN_4[39:0] | (req_paddr[2:0] == 3'h3 ? uncacheData[63:24] : 40'h0);
  wire [31:0]     _GEN_6 =
    _GEN_5[31:0] | (req_paddr[2:0] == 3'h4 ? uncacheData[63:32] : 32'h0);
  wire [23:0]     _GEN_7 =
    _GEN_6[23:0] | (req_paddr[2:0] == 3'h5 ? uncacheData[63:40] : 24'h0);
  wire [15:0]     _GEN_8 =
    _GEN_7[15:0] | (req_paddr[2:0] == 3'h6 ? uncacheData[63:48] : 16'h0);
  wire [7:0]      _rdataPartialLoad_T_58 =
    _GEN_8[7:0] | ((&(req_paddr[2:0])) ? uncacheData[63:56] : 8'h0);
  wire [63:0]     rdataSel =
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      uncacheState <= _GEN_9[uncacheState];
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_paddr = {_RANDOM[7'h2A][31:1], _RANDOM[7'h2B][16:0]};
        req_gpaddr = {_RANDOM[7'h2B][31:17], _RANDOM[7'h2C], _RANDOM[7'h2D][16:0]};
        req_mask = {_RANDOM[7'h2D][31:17], _RANDOM[7'h2E][0]};
        req_nc = _RANDOM[7'h32][7];
        req_mmio = _RANDOM[7'h32][8];
        req_memBackTypeMM = _RANDOM[7'h32][9];
        req_atomic = _RANDOM[7'h32][10];
        req_isHyper = _RANDOM[7'h32][12];
        req_isForVSnonLeafPTE = _RANDOM[7'h32][13];
        req_isvec = _RANDOM[7'h37][3];
        req_is128bit = _RANDOM[7'h37][5];
        req_vecActive = _RANDOM[7'h3B][24];
        req_schedIndex = _RANDOM[7'h3C][21:15];
        slaveAccept = _RANDOM[7'h50][14];
        slaveId = _RANDOM[7'h50][16:15];
        uncacheState = _RANDOM[7'h50][18:17];
        uncacheData = {_RANDOM[7'h50][31:19], _RANDOM[7'h51], _RANDOM[7'h52][18:0]};
        nderr = _RANDOM[7'h52][19];
        needFlushReg = _RANDOM[7'h52][20];
        pendingld_last_REG = _RANDOM[7'h52][21];
        pendingPtr_next_r_flag = _RANDOM[7'h52][22];
        pendingPtr_next_r_value = _RANDOM[7'h52][30:23];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        req_valid = 1'h0;
        slaveAccept = 1'h0;
    ...
    {65'h0,
     (req_uop_fuOpType == 9'h0
       ...
       | (req_uop_fuOpType == 9'h1
            ? {{48{_GEN_8[15]}}, _GEN_8[15:8], _rdataPartialLoad_T_58}
            : 64'h0)
       | (req_uop_fuOpType == 9'h2
            ? {req_uop_fpWen ? 32'hFFFFFFFF : {32{_GEN_6[31]}},
               _GEN_6[31:24],
               _GEN_7[23:16],
               _GEN_8[15:8],
               _rdataPartialLoad_T_58}
       ...
       | (req_uop_fuOpType == 9'h5
            ? {48'h0, _GEN_8[15:8], _rdataPartialLoad_T_58}
            : 64'h0)
       | (req_uop_fuOpType == 9'h6
            ? {32'h0, _GEN_6[31:24], _GEN_7[23:16], _GEN_8[15:8], _rdataPartialLoad_T_58}
            : 64'h0)
