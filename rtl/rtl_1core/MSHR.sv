...
module MSHR(
  ...
  reg  [2:0]       dirResult_meta_prefetchSrc;
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin
      ...
      dirResult_meta_prefetchSrc <= 3'h0;
  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_set = _RANDOM[5'h2][22:14];
        req_tag = {_RANDOM[5'h2][31:23], _RANDOM[5'h3][21:0]};
        ...
        dirResult_hit = _RANDOM[5'hA][29];
        dirResult_tag = {_RANDOM[5'hA][31:30], _RANDOM[5'hB][28:0]};
        dirResult_set = {_RANDOM[5'hB][31:29], _RANDOM[5'hC][5:0]};
        dirResult_way = _RANDOM[5'hC][8:6];
        dirResult_meta_dirty = _RANDOM[5'hC][9];
        dirResult_meta_state = _RANDOM[5'hC][11:10];
        dirResult_meta_clients = _RANDOM[5'hC][12];
        dirResult_meta_alias = _RANDOM[5'hC][14:13];
        dirResult_meta_prefetch = _RANDOM[5'hC][15];
        dirResult_meta_prefetchSrc = _RANDOM[5'hC][18:16];
        dirResult_meta_accessed = _RANDOM[5'hC][19];
        dirResult_meta_tagErr = _RANDOM[5'hC][20];
        dirResult_meta_dataErr = _RANDOM[5'hC][21];
        state_s_acquire = _RANDOM[5'hD][3];
        state_s_rprobe = _RANDOM[5'hD][4];
        state_s_pprobe = _RANDOM[5'hD][5];
        state_s_release = _RANDOM[5'hD][6];
        state_s_probeack = _RANDOM[5'hD][7];
        state_s_refill = _RANDOM[5'hD][8];
        state_s_retry = _RANDOM[5'hD][9];
        state_s_cmoresp = _RANDOM[5'hD][10];
        state_s_cmometaw = _RANDOM[5'hD][11];
        state_w_rprobeackfirst = _RANDOM[5'hD][12];
        state_w_rprobeacklast = _RANDOM[5'hD][13];
        state_w_pprobeackfirst = _RANDOM[5'hD][14];
        state_w_pprobeacklast = _RANDOM[5'hD][15];
        state_w_grantfirst = _RANDOM[5'hD][16];
        state_w_grantlast = _RANDOM[5'hD][17];
        state_w_grant = _RANDOM[5'hD][18];
        state_w_releaseack = _RANDOM[5'hD][19];
        state_w_replResp = _RANDOM[5'hD][20];
        mergeA = _RANDOM[5'hD][21];
        mp_grant_task_merge_task_r_off = _RANDOM[5'hF][9:4];
        mp_grant_task_merge_task_r_alias = _RANDOM[5'hF][11:10];
        mp_grant_task_merge_task_r_vaddr = {_RANDOM[5'hF][31:12], _RANDOM[5'h10][23:0]};
        mp_grant_task_merge_task_r_isKeyword = _RANDOM[5'h10][24];
        mp_grant_task_merge_task_r_opcode = _RANDOM[5'h10][28:25];
        mp_grant_task_merge_task_r_param = _RANDOM[5'h10][31:29];
        mp_grant_task_merge_task_r_sourceId = _RANDOM[5'h11][9:3];
        io_msInfo_bits_blockRefill_REG = _RANDOM[5'h16][11];
        io_msInfo_bits_blockRefill_REG_1 = _RANDOM[5'h16][12];
        io_msInfo_bits_blockRefill_REG_2 = _RANDOM[5'h16][13];
      `endif // RANDOMIZE_REG_INIT
      if (reset) begin
        gotT = 1'h0;
        gotDirty = 1'h0;
