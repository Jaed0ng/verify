...
module TLXbar_4(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source[5:4] == 2'h2;
  wire        requestDOI_0_2 = auto_out_d_bits_source[5:4] == 2'h1;
  wire        requestDOI_0_3 = auto_out_d_bits_source[5:4] == 2'h0;
  reg         beatsLeft;
  ...
  assign auto_in_3_d_bits_source = auto_out_d_bits_source[3:0];
  ...
  assign auto_in_3_e_ready = beatsLeft_2 ? state_2_3 : readys_readys_2[3];
  ...
  assign auto_in_2_d_bits_source = auto_out_d_bits_source[3:0];
  ...
  assign auto_in_2_e_ready = beatsLeft_2 ? state_2_2 : readys_readys_2[2];
  ...
  assign auto_in_1_e_ready = beatsLeft_2 ? state_2_1 : readys_readys_2[1];
  ...
  assign auto_in_0_d_valid = auto_out_d_valid & (&(auto_out_d_bits_source[5:4]));
  ...
  assign auto_in_0_e_ready = beatsLeft_2 ? state_2_0 : readys_readys_2[0];
  ...
  assign auto_out_a_bits_source =
    (muxState_0 ? {2'h3, auto_in_0_a_bits_source} : 6'h0)
    | (muxState_1 ? {2'h2, auto_in_1_a_bits_source} : 6'h0)
    | (muxState_2 ? {2'h1, auto_in_2_a_bits_source} : 6'h0)
    | (muxState_3 ? {2'h0, auto_in_3_a_bits_source} : 6'h0);
  ...
  assign auto_out_c_bits_source =
    (muxState_1_0 ? {2'h3, auto_in_0_c_bits_source} : 6'h0)
    | (muxState_1_1 ? {2'h2, auto_in_1_c_bits_source} : 6'h0)
    | (muxState_1_2 ? {2'h1, auto_in_2_c_bits_source} : 6'h0)
    | (muxState_1_3 ? {2'h0, auto_in_3_c_bits_source} : 6'h0);
  ...
  assign auto_out_d_ready =
    (&(auto_out_d_bits_source[5:4])) & auto_in_0_d_ready | requestDOI_0_1
  ...
  assign auto_out_e_bits_sink =
    ((beatsLeft_2 ? state_2_0 : winner_2_0) ? auto_in_0_e_bits_sink : 3'h0)
    | ((beatsLeft_2 ? state_2_1 : winner_2_1) ? auto_in_1_e_bits_sink : 3'h0)
    | ((beatsLeft_2 ? state_2_2 : winner_2_2) ? auto_in_2_e_bits_sink : 3'h0)
    | ((beatsLeft_2 ? state_2_3 : winner_2_3) ? auto_in_3_e_bits_sink : 3'h0);
endmodule
