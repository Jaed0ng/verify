...
module TLXbar_9(
  ...
  assign auto_out_a_bits_user_reqSource =
    ...
    | (muxState_3 ? auto_in_3_a_bits_user_reqSource : 5'h0);
  ...
  assign auto_out_c_bits_user_reqSource =
    (muxState_1_0 ? auto_in_0_c_bits_user_reqSource : 5'h0)
    | (muxState_1_1 ? auto_in_1_c_bits_user_reqSource : 5'h0)
    | (muxState_1_2 ? auto_in_2_c_bits_user_reqSource : 5'h0)
    | (muxState_1_3 ? auto_in_3_c_bits_user_reqSource : 5'h0);
  ...
  assign auto_out_e_bits_sink =
    ((beatsLeft_2 ? state_2_0 : winner_2_0) ? auto_in_0_e_bits_sink : 6'h0)
    | ((beatsLeft_2 ? state_2_1 : winner_2_1) ? auto_in_1_e_bits_sink : 6'h0)
    | ((beatsLeft_2 ? state_2_2 : winner_2_2) ? auto_in_2_e_bits_sink : 6'h0)
    | ((beatsLeft_2 ? state_2_3 : winner_2_3) ? auto_in_3_e_bits_sink : 6'h0);
endmodule
