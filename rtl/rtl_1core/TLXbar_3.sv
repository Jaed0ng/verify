...
module TLXbar_3(
  ...
  wire        requestDOI_0_1 = auto_out_d_bits_source[7:3] == 5'h10;
  reg         beatsLeft;
  ...
  assign auto_in_0_d_valid = auto_out_d_valid & ~(auto_out_d_bits_source[7]);
  assign auto_in_0_d_bits_opcode = auto_out_d_bits_opcode;
  assign auto_in_0_d_bits_param = auto_out_d_bits_param;
  assign auto_in_0_d_bits_size = auto_out_d_bits_size;
  assign auto_in_0_d_bits_source = auto_out_d_bits_source[6:0];
  ...
  assign auto_out_a_bits_source =
    (muxState_0 ? {1'h0, auto_in_0_a_bits_source} : 8'h0)
    | (muxState_1 ? {5'h10, auto_in_1_a_bits_source} : 8'h0);
  ...
  assign auto_out_d_ready =
    ~(auto_out_d_bits_source[7]) & auto_in_0_d_ready | requestDOI_0_1 & auto_in_1_d_ready;
endmodule
